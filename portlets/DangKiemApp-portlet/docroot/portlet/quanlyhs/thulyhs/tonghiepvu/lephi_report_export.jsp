...
<%
	...
	renderBackURL.setParameter("jspPage", "/portlet/quanlyhs/thulyhs/tonghiepvu/listDebitNote.jsp");
...
%>
			...
			// Ghi actionlog
			String noidungthaotac = "Mở xem file Phiếu thanh toán " + debitNote.getDebitNoteNumber() + " thời điểm " + DateUtils.dateToString("dd/MM/yyyy HH:mm", new Date()) + "<br>" + urlFileDowLoad; 
