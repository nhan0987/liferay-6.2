...
%>
	...
	urlSuaChungChi.setParameter(ActionRequest.ACTION_NAME, "suachungchichoduyetlanN");
	...
	//Ghi actionlog
	String noidungthaotac = "Mở xem nội dung Sửa chứng chỉ chờ duyệt thời điểm " + DateUtils.dateToString("dd/MM/yyyy HH:mm", new Date()) + " theo hoSoThuTucId " + hoSoThuTucId; 
	String tenmanhinhdaidien = "Sửa chứng chỉ chờ duyệt";
	String importername = "";
