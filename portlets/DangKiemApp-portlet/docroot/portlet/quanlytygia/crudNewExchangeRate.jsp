...
<%
	...
	// Ghi actionlog
	String noidungthaotac = "Vào chức năng Tạo mới tỉ giá thời điểm "+ DateUtils.dateToString("dd/MM/yyyy HH:mm", new Date()); 
	String tenmanhinhdaidien = "Màn hình Tạo mới tỉ giá";
	if (isNewExchange.equalsIgnoreCase("false")) {
		noidungthaotac = "Vào chức năng Chỉnh sửa tỉ giá thời điểm "+ DateUtils.dateToString("dd/MM/yyyy HH:mm", new Date());
		tenmanhinhdaidien = "Màn hình Chỉnh sửa tỉ giá";
	}
	String importername = "";
