...
<%
	...
	viewURL.setParameter("jspPage", "/portlet/quanlyruiro/viewdanhgianhansugiantiep.jsp");
	...
	// Ghi actionlog
	String noidungthaotac = "Mở xem Danh sách Nhân viên - Khối gián tiếp thời điểm " + DateUtils.dateToString("dd/MM/yyyy HH:mm", new Date()); 
	String tenmanhinhdaidien = "Danh sách nhân viên - Khối gián tiếp";
	String importername = "";
	...
	<div class="col-md-12" id="main">
		...
		<br>
			...
			<table class="wd-table table">
				<caption style = "font-size: 20px">Danh sách Nhân viên - Khối gián tiếp</caption>
				<thead>
					<tr>
						<th>STT</th>
