...
%>
		...
		<div class="" style="background: #ffffff;padding-top: 1%;color: #777;text-align: left;font-size: 16px;padding-left: 10px;"><%=isNewIssueTracking.equalsIgnoreCase("true") ? "TẠO MỚI PHIẾU GHI NHẬN LỖI" : isNewIssueTracking.equalsIgnoreCase("false") ? "PHIẾU GHI NHẬN LỖI - KHẮC PHỤC - PHÒNG NGỪA" : StringPool.BLANK %></div>
		<div class="col-xs-12 col-sm-12 col-md-12" style="background: #ffffff;" id="cot2"><br>
			
				<aui:form action="<%=urlAddNewIssueTracking%>" name="myForm" id="myForm" method="POST" enctype="multipart/form-data">

		<%
		if( isNewIssueTracking.equalsIgnoreCase("")) {
			%>
				<%
		} else if (isNewIssueTracking.equalsIgnoreCase("true") || isNewIssueTracking.equalsIgnoreCase("false")) {
			%>
			...
			<div class="row">
				...
				<div class="col-xs-10 col-sm-10 col-md-10" style="height: 30px">
					<div class="row">
						...
						<div class="col-xs-6 col-sm-6 col-md-6 col-md-right" style="margin-left: 40px;">
							<label class="textlabel" style="margin-top: -5px;">Ghi chú: Thông tin có dấu (<span style="color: red;">*</span>) bắt buộc nhập.</label>
						</div>
...
<%if (1==1) {
	...
	<div class="row">
				<div class="col-xs-6 col-sm-6 col-md-6" style="margin-left: 40px;">	
					...
					<textarea class="textAreaAutosize" rows="20" cols="40" style="width: 100%; height: 400px" id="motaNoiDungLoi" name="motaNoiDungLoi"><%=StringPool.BLANK%></textarea>
				</div>
				<div class="col-xs-4 col-sm-4 col-md-4 col-md-left">					
					<div class="row">
					...
					<textarea class="textAreaAutosize" rows="20" cols="40" style="width: 125%; height: 210px" id="motaNoiDungLoi" name="motaNoiDungLoi"><%=StringPool.BLANK%></textarea>
					</div>
	...
	<div class="row">
				<div class="col-xs-6 col-sm-6 col-md-6" style="margin-left: 40px;">	
					...
					<div class="row">
						<div class="col-xs-3 col-sm-3 col-md-3">											
							<label class="textlabel" style="margin-top: -5px;     height: 10px;"><i>Thực hiện:&nbsp;</i></label><br>							
						</div>
						<div class="col-xs-3 col-sm-3 col-md-3">											
							<label class="textlabel" style="margin-top: -5px;     height: 10px;"><i>Kiểm tra:&nbsp;</i></label><br>							
						</div>
						<div class="col-xs-3 col-sm-3 col-md-3">											
							<label class="textlabel" style="margin-top: -5px;     height: 10px;"><i>Duyệt:&nbsp;</i></label><br>							
						</div>
					</div>
					<div class="row">
						<div class="col-xs-3 col-sm-3 col-md-3">											
							<label class="textlabel" style="margin-top: -5px;     height: 10px;">Ngày&nbsp;</label><br>							
						</div>
						<div class="col-xs-3 col-sm-3 col-md-3">											
							<label class="textlabel" style="margin-top: -5px;     height: 10px;">Ngày&nbsp;</label><br>							
						</div>
...
<br><br><br>
		...
		<%
		if (isNewIssueTracking.equalsIgnoreCase("true") || isNewIssueTracking.equalsIgnoreCase("false")) {
			%>
			</div>
			<%
		}
