...
<%
	String specificationgroupcode = DanhMucKey.A1_CODE;
	...
	viewURL.setParameter("jspPage", "/portlet/quanlyruiro/viewdanhgiadoanhnghiep.jsp");
	...
	SearchContainer<AssessmentofImporter> searchContainer = new SearchContainer<AssessmentofImporter>(renderRequest, 
			null, null, SearchContainer.DEFAULT_CUR_PARAM, 15, viewURL, null, "");
	
	List<AssessmentofImporter> list = AssessmentofImporterLocalServiceUtil.findDanhSachDanhGiaDoanhNghiep(importercode, importername,
		searchContainer.getStart(), searchContainer.getEnd());
	int total = AssessmentofImporterLocalServiceUtil.countDanhSachDanhGiaDoanhNghiep(importercode, importername);
	
	searchContainer.setTotal(total);
	searchContainer.setResults(list);
	
	// Ghi actionlog
	String noidungthaotac = "Mở xem Danh sách Đánh giá rủi ro doanh nghiệp thời điểm " + DateUtils.dateToString("dd/MM/yyyy HH:mm", new Date()); 
	String tenmanhinhdaidien = "Danh sách Đánh giá rủi ro doanh nghiệp";
	String importername = "";
	...
	<div class="col-md-12" id="main">
		...
		<div class="CollapsiblePanelContent" style="display: block;">
			...
			<table class="wd-table table">
				<caption style = "font-size: 20px">Danh sách Đánh giá doanh nghiệp</caption>
				<thead>
					<tr>
						<th>STT</th>
						<th>Doanh nghiệp</th>
				...
				<%
				int index = 1;
				for (AssessmentofImporter item : list) {
					%>
					<tr>
						...
						<td class="text-center">
							...
							editURL.setParameter("jspPage", "/portlet/quanlyruiro/edit_assessment_specification.jsp");
							...
							addURL.setParameter("jspPage", "/portlet/quanlyruiro/edit_assessment_specification.jsp");
							...
							deleteURL.setParameter(ActionRequest.ACTION_NAME, "deleteDanhGiaDoanhNghiep");
							%>
