...
import vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIXECOGIOILocalService;
...
/**
 * Provides the base implementation for the t h o n g s o c h u n g c h i x e c o g i o i local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.THONGSOCHUNGCHIXECOGIOILocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class THONGSOCHUNGCHIXECOGIOILocalServiceBaseImpl
	extends BaseLocalServiceImpl implements THONGSOCHUNGCHIXECOGIOILocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIXECOGIOILocalServiceUtil} to access the t h o n g s o c h u n g c h i x e c o g i o i local service.
	 */
	...
	@Override
	public THONGSOCHUNGCHIXECOGIOI addTHONGSOCHUNGCHIXECOGIOI(
		THONGSOCHUNGCHIXECOGIOI thongsochungchixecogioi)
		throws SystemException {
		thongsochungchixecogioi.setNew(true);

		return thongsochungchixecogioiPersistence.update(thongsochungchixecogioi);
	}
	 ...
	 */
	@Override
	public THONGSOCHUNGCHIXECOGIOI createTHONGSOCHUNGCHIXECOGIOI(long id) {
		return thongsochungchixecogioiPersistence.create(id);
	}
	...
	@Override
	public THONGSOCHUNGCHIXECOGIOI deleteTHONGSOCHUNGCHIXECOGIOI(long id)
		throws PortalException, SystemException {
		return thongsochungchixecogioiPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public THONGSOCHUNGCHIXECOGIOI deleteTHONGSOCHUNGCHIXECOGIOI(
		THONGSOCHUNGCHIXECOGIOI thongsochungchixecogioi)
		throws SystemException {
		return thongsochungchixecogioiPersistence.remove(thongsochungchixecogioi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(THONGSOCHUNGCHIXECOGIOI.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return thongsochungchixecogioiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return thongsochungchixecogioiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public THONGSOCHUNGCHIXECOGIOI fetchTHONGSOCHUNGCHIXECOGIOI(long id)
		throws SystemException {
		return thongsochungchixecogioiPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public THONGSOCHUNGCHIXECOGIOI getTHONGSOCHUNGCHIXECOGIOI(long id)
		throws PortalException, SystemException {
		return thongsochungchixecogioiPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return thongsochungchixecogioiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<THONGSOCHUNGCHIXECOGIOI> getTHONGSOCHUNGCHIXECOGIOIs(
		int start, int end) throws SystemException {
		return thongsochungchixecogioiPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTHONGSOCHUNGCHIXECOGIOIsCount() throws SystemException {
		return thongsochungchixecogioiPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public THONGSOCHUNGCHIXECOGIOI updateTHONGSOCHUNGCHIXECOGIOI(
		THONGSOCHUNGCHIXECOGIOI thongsochungchixecogioi)
		throws SystemException {
		return thongsochungchixecogioiPersistence.update(thongsochungchixecogioi);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.THONGSOCHUNGCHIXECOGIOI",
			thongsochungchixecogioiLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = thongsochungchixecogioiPersistence.getDataSource();
	...
	private THONGSOCHUNGCHIXECOGIOILocalServiceClpInvoker _clpInvoker = new THONGSOCHUNGCHIXECOGIOILocalServiceClpInvoker();
}