 ...
 * @generated
 */
public class PaymentStatusLocalServiceClp implements PaymentStatusLocalService {
	public PaymentStatusLocalServiceClp(
	...
	public vn.dtt.gt.dk.dao.nghiepvu.model.PaymentStatus addPaymentStatus(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(paymentStatus) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.gt.dk.dao.nghiepvu.model.PaymentStatus)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.PaymentStatus> getPaymentStatuses(
		...
		return (java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.PaymentStatus>)ClpSerializer.translateOutput(returnObj);
	}
