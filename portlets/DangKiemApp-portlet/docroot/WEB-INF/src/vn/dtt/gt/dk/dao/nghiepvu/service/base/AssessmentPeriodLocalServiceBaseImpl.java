...
import vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentPeriodLocalService;
...
/**
 * Provides the base implementation for the assessment period local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.AssessmentPeriodLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class AssessmentPeriodLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssessmentPeriodLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentPeriodLocalServiceUtil} to access the assessment period local service.
	 */
	...
	@Override
	public AssessmentPeriod addAssessmentPeriod(
		AssessmentPeriod assessmentPeriod) throws SystemException {
		assessmentPeriod.setNew(true);

		return assessmentPeriodPersistence.update(assessmentPeriod);
	}
	 ...
	 */
	@Override
	public AssessmentPeriod createAssessmentPeriod(long id) {
		return assessmentPeriodPersistence.create(id);
	}
	...
	@Override
	public AssessmentPeriod deleteAssessmentPeriod(long id)
		throws PortalException, SystemException {
		return assessmentPeriodPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AssessmentPeriod deleteAssessmentPeriod(
		AssessmentPeriod assessmentPeriod) throws SystemException {
		return assessmentPeriodPersistence.remove(assessmentPeriod);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AssessmentPeriod.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return assessmentPeriodPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessmentPeriodPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AssessmentPeriod fetchAssessmentPeriod(long id)
		throws SystemException {
		return assessmentPeriodPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public AssessmentPeriod getAssessmentPeriod(long id)
		throws PortalException, SystemException {
		return assessmentPeriodPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assessmentPeriodPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AssessmentPeriod> getAssessmentPeriods(int start, int end)
		throws SystemException {
		return assessmentPeriodPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAssessmentPeriodsCount() throws SystemException {
		return assessmentPeriodPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AssessmentPeriod updateAssessmentPeriod(
		AssessmentPeriod assessmentPeriod) throws SystemException {
		return assessmentPeriodPersistence.update(assessmentPeriod);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.AssessmentPeriod",
			assessmentPeriodLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assessmentPeriodPersistence.getDataSource();
	...
	private AssessmentPeriodLocalServiceClpInvoker _clpInvoker = new AssessmentPeriodLocalServiceClpInvoker();
}