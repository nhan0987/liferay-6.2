...
import vn.dtt.gt.dk.dao.nghiepvu.service.ControlReportLocalService;
...
/**
 * Provides the base implementation for the control report local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.ControlReportLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.ControlReportLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.ControlReportLocalServiceUtil
 * @generated
 */
public abstract class ControlReportLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ControlReportLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.ControlReportLocalServiceUtil} to access the control report local service.
	 */
	...
	@Override
	public ControlReport addControlReport(ControlReport controlReport)
		throws SystemException {
		controlReport.setNew(true);

		return controlReportPersistence.update(controlReport);
	}
	 ...
	 */
	@Override
	public ControlReport createControlReport(long id) {
		return controlReportPersistence.create(id);
	}
	...
	@Override
	public ControlReport deleteControlReport(long id)
		throws PortalException, SystemException {
		return controlReportPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ControlReport deleteControlReport(ControlReport controlReport)
		throws SystemException {
		return controlReportPersistence.remove(controlReport);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ControlReport.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return controlReportPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return controlReportPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ControlReport fetchControlReport(long id) throws SystemException {
		return controlReportPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public ControlReport getControlReport(long id)
		throws PortalException, SystemException {
		return controlReportPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return controlReportPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ControlReport> getControlReports(int start, int end)
		throws SystemException {
		return controlReportPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getControlReportsCount() throws SystemException {
		return controlReportPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ControlReport updateControlReport(ControlReport controlReport)
		throws SystemException {
		return controlReportPersistence.update(controlReport);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.ControlReport",
			controlReportLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.gt.dk.dao.nghiepvu.model.ControlReport");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = controlReportPersistence.getDataSource();
	...
	private ControlReportLocalServiceClpInvoker _clpInvoker = new ControlReportLocalServiceClpInvoker();
}