...
public class VehicleGroupPersistenceImpl extends BasePersistenceImpl<VehicleGroup>
	...
	protected VehicleGroup toUnwrappedModel(VehicleGroup vehicleGroup) {
		...
		vehicleGroupImpl.setControlreportNo(vehicleGroup.getControlreportNo());
		...
		vehicleGroupImpl.setControlreportId(vehicleGroup.getControlreportId());
	...
	private static Set<String> _badColumnNames = SetUtil.fromArray(new String[] {
				...
				"controlreportId", "specificationVersion", "hoSoThuTucId",
				"attachedFile", "SynchDate"
			});
