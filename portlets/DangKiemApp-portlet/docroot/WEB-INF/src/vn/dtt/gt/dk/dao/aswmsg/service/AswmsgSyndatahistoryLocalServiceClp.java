 ...
 * @generated
 */
public class AswmsgSyndatahistoryLocalServiceClp
	implements AswmsgSyndatahistoryLocalService {
	public AswmsgSyndatahistoryLocalServiceClp(
	...
	public vn.dtt.gt.dk.dao.aswmsg.model.AswmsgSyndatahistory addAswmsgSyndatahistory(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(aswmsgSyndatahistory)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.gt.dk.dao.aswmsg.model.AswmsgSyndatahistory)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.aswmsg.model.AswmsgSyndatahistory> getAswmsgSyndatahistories(
		...
		return (java.util.List<vn.dtt.gt.dk.dao.aswmsg.model.AswmsgSyndatahistory>)ClpSerializer.translateOutput(returnObj);
	}
