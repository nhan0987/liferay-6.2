...
import vn.dtt.gt.dk.dao.nghiepvu.service.VehicleSpecificationLocalService;
...
/**
 * Provides the base implementation for the vehicle specification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.VehicleSpecificationLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class VehicleSpecificationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VehicleSpecificationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.VehicleSpecificationLocalServiceUtil} to access the vehicle specification local service.
	 */
	...
	@Override
	public VehicleSpecification addVehicleSpecification(
		VehicleSpecification vehicleSpecification) throws SystemException {
		vehicleSpecification.setNew(true);

		return vehicleSpecificationPersistence.update(vehicleSpecification);
	}
	 ...
	 */
	@Override
	public VehicleSpecification createVehicleSpecification(long id) {
		return vehicleSpecificationPersistence.create(id);
	}
	...
	@Override
	public VehicleSpecification deleteVehicleSpecification(long id)
		throws PortalException, SystemException {
		return vehicleSpecificationPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VehicleSpecification deleteVehicleSpecification(
		VehicleSpecification vehicleSpecification) throws SystemException {
		return vehicleSpecificationPersistence.remove(vehicleSpecification);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VehicleSpecification.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vehicleSpecificationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vehicleSpecificationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VehicleSpecification fetchVehicleSpecification(long id)
		throws SystemException {
		return vehicleSpecificationPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VehicleSpecification getVehicleSpecification(long id)
		throws PortalException, SystemException {
		return vehicleSpecificationPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vehicleSpecificationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VehicleSpecification> getVehicleSpecifications(int start,
		int end) throws SystemException {
		return vehicleSpecificationPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVehicleSpecificationsCount() throws SystemException {
		return vehicleSpecificationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VehicleSpecification updateVehicleSpecification(
		VehicleSpecification vehicleSpecification) throws SystemException {
		return vehicleSpecificationPersistence.update(vehicleSpecification);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.VehicleSpecification",
			vehicleSpecificationLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vehicleSpecificationPersistence.getDataSource();
	...
	private VehicleSpecificationLocalServiceClpInvoker _clpInvoker = new VehicleSpecificationLocalServiceClpInvoker();
}