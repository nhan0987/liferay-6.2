...
import vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentofImporterLocalService;
...
/**
 * Provides the base implementation for the assessmentof importer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.AssessmentofImporterLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class AssessmentofImporterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssessmentofImporterLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentofImporterLocalServiceUtil} to access the assessmentof importer local service.
	 */
	...
	@Override
	public AssessmentofImporter addAssessmentofImporter(
		AssessmentofImporter assessmentofImporter) throws SystemException {
		assessmentofImporter.setNew(true);

		return assessmentofImporterPersistence.update(assessmentofImporter);
	}
	 ...
	 */
	@Override
	public AssessmentofImporter createAssessmentofImporter(long id) {
		return assessmentofImporterPersistence.create(id);
	}
	...
	@Override
	public AssessmentofImporter deleteAssessmentofImporter(long id)
		throws PortalException, SystemException {
		return assessmentofImporterPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AssessmentofImporter deleteAssessmentofImporter(
		AssessmentofImporter assessmentofImporter) throws SystemException {
		return assessmentofImporterPersistence.remove(assessmentofImporter);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AssessmentofImporter.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return assessmentofImporterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessmentofImporterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AssessmentofImporter fetchAssessmentofImporter(long id)
		throws SystemException {
		return assessmentofImporterPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public AssessmentofImporter getAssessmentofImporter(long id)
		throws PortalException, SystemException {
		return assessmentofImporterPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assessmentofImporterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AssessmentofImporter> getAssessmentofImporters(int start,
		int end) throws SystemException {
		return assessmentofImporterPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAssessmentofImportersCount() throws SystemException {
		return assessmentofImporterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AssessmentofImporter updateAssessmentofImporter(
		AssessmentofImporter assessmentofImporter) throws SystemException {
		return assessmentofImporterPersistence.update(assessmentofImporter);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.AssessmentofImporter",
			assessmentofImporterLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assessmentofImporterPersistence.getDataSource();
	...
	private AssessmentofImporterLocalServiceClpInvoker _clpInvoker = new AssessmentofImporterLocalServiceClpInvoker();
}