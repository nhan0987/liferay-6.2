 ...
 * @generated
 */
public class MotCuaNotificationLocalServiceClp
	implements MotCuaNotificationLocalService {
	public MotCuaNotificationLocalServiceClp(
	...
	public vn.dtt.gt.dk.dao.motcua.model.MotCuaNotification addMotCuaNotification(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(motCuaNotification)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.gt.dk.dao.motcua.model.MotCuaNotification)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.motcua.model.MotCuaNotification> getMotCuaNotifications(
		...
		return (java.util.List<vn.dtt.gt.dk.dao.motcua.model.MotCuaNotification>)ClpSerializer.translateOutput(returnObj);
	}
