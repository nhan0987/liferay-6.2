...
import vn.dtt.gt.dk.dao.nghiepvu.service.NewExchangeRateLocalService;
...
/**
 * Provides the base implementation for the new exchange rate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.NewExchangeRateLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class NewExchangeRateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NewExchangeRateLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.NewExchangeRateLocalServiceUtil} to access the new exchange rate local service.
	 */
	...
	@Override
	public NewExchangeRate addNewExchangeRate(NewExchangeRate newExchangeRate)
		throws SystemException {
		newExchangeRate.setNew(true);

		return newExchangeRatePersistence.update(newExchangeRate);
	}
	 ...
	 */
	@Override
	public NewExchangeRate createNewExchangeRate(long id) {
		return newExchangeRatePersistence.create(id);
	}
	...
	@Override
	public NewExchangeRate deleteNewExchangeRate(long id)
		throws PortalException, SystemException {
		return newExchangeRatePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public NewExchangeRate deleteNewExchangeRate(
		NewExchangeRate newExchangeRate) throws SystemException {
		return newExchangeRatePersistence.remove(newExchangeRate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(NewExchangeRate.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return newExchangeRatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return newExchangeRatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public NewExchangeRate fetchNewExchangeRate(long id)
		throws SystemException {
		return newExchangeRatePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public NewExchangeRate getNewExchangeRate(long id)
		throws PortalException, SystemException {
		return newExchangeRatePersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return newExchangeRatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<NewExchangeRate> getNewExchangeRates(int start, int end)
		throws SystemException {
		return newExchangeRatePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getNewExchangeRatesCount() throws SystemException {
		return newExchangeRatePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public NewExchangeRate updateNewExchangeRate(
		NewExchangeRate newExchangeRate) throws SystemException {
		return newExchangeRatePersistence.update(newExchangeRate);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.NewExchangeRate",
			newExchangeRateLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = newExchangeRatePersistence.getDataSource();
	...
	private NewExchangeRateLocalServiceClpInvoker _clpInvoker = new NewExchangeRateLocalServiceClpInvoker();
}