...
import vn.dtt.gt.dk.dao.motcua.model.MotCuaNotificationSoap;
...
public class MotCuaNotificationModelImpl extends BaseModelImpl<MotCuaNotification>
	 ...
	 */
	public static MotCuaNotification toModel(MotCuaNotificationSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		MotCuaNotification model = new MotCuaNotificationImpl();
		...
		model.setRequestTime(soapModel.getRequestTime());
		model.setRequestSender(soapModel.getRequestSender());
	 ...
	 */
	public static List<MotCuaNotification> toModels(
		MotCuaNotificationSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<MotCuaNotification> models = new ArrayList<MotCuaNotification>(soapModels.length);

		for (MotCuaNotificationSoap soapModel : soapModels) {
