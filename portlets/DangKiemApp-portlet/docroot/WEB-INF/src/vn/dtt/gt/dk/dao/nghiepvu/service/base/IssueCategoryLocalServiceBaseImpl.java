...
import vn.dtt.gt.dk.dao.nghiepvu.service.IssueCategoryLocalService;
...
/**
 * Provides the base implementation for the issue category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.IssueCategoryLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.IssueCategoryLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.IssueCategoryLocalServiceUtil
 * @generated
 */
public abstract class IssueCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements IssueCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.IssueCategoryLocalServiceUtil} to access the issue category local service.
	 */
	...
	public IssueCategory addIssueCategory(IssueCategory issueCategory)
		...
		return issueCategoryPersistence.update(issueCategory);
	}
	 ...
	 */
	@Override
	public IssueCategory createIssueCategory(long id) {
		return issueCategoryPersistence.create(id);
	}
	...
	@Override
	public IssueCategory deleteIssueCategory(long id)
		throws PortalException, SystemException {
		return issueCategoryPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public IssueCategory deleteIssueCategory(IssueCategory issueCategory)
		throws SystemException {
		return issueCategoryPersistence.remove(issueCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(IssueCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return issueCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return issueCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public IssueCategory fetchIssueCategory(long id) throws SystemException {
		return issueCategoryPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public IssueCategory getIssueCategory(long id)
		throws PortalException, SystemException {
		return issueCategoryPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return issueCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<IssueCategory> getIssueCategories(int start, int end)
		throws SystemException {
		return issueCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getIssueCategoriesCount() throws SystemException {
		return issueCategoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IssueCategory updateIssueCategory(IssueCategory issueCategory)
		throws SystemException {
		return issueCategoryPersistence.update(issueCategory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.IssueCategory",
			issueCategoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.gt.dk.dao.nghiepvu.model.IssueCategory");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = issueCategoryPersistence.getDataSource();
	...
	private IssueCategoryLocalServiceClpInvoker _clpInvoker = new IssueCategoryLocalServiceClpInvoker();
}