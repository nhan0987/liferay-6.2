 ...
 * @generated
 */
public class AswmsgSyndatahistorySoap implements Serializable {
	public static AswmsgSyndatahistorySoap toSoapModel(
		AswmsgSyndatahistory model) {
		AswmsgSyndatahistorySoap soapModel = new AswmsgSyndatahistorySoap();
	...
	public static AswmsgSyndatahistorySoap[] toSoapModels(
		AswmsgSyndatahistory[] models) {
		AswmsgSyndatahistorySoap[] soapModels = new AswmsgSyndatahistorySoap[models.length];
	...
	public static AswmsgSyndatahistorySoap[][] toSoapModels(
		AswmsgSyndatahistory[][] models) {
		AswmsgSyndatahistorySoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new AswmsgSyndatahistorySoap[models.length][models[0].length];
		}
		else {
			soapModels = new AswmsgSyndatahistorySoap[0][0];
		}
	...
	public static AswmsgSyndatahistorySoap[] toSoapModels(
		List<AswmsgSyndatahistory> models) {
		List<AswmsgSyndatahistorySoap> soapModels = new ArrayList<AswmsgSyndatahistorySoap>(models.size());

		for (AswmsgSyndatahistory model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new AswmsgSyndatahistorySoap[soapModels.size()]);
	}

	public AswmsgSyndatahistorySoap() {
	}
