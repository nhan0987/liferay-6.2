...
public class CertificateRecordLocalServiceImpl extends CertificateRecordLocalServiceBaseImpl {
	 ...
	 * vn.dtt.gt.dk.dao.nghiepvu.service.CertificateRecordLocalServiceUtil} to
	 * access the certificate record local service.
	 */

	// public vn.dtt.gt.dk.dao.nghiepvu.model.CertificateRecord
	// findByVehicleRecordId(
	// long vehicleRecordId){
	// try{
	// return
	// certificateRecordPersistence.findByVehicleRecordId(vehicleRecordId);
	//
	// }catch (Exception e) {
	// _log.error(e);
	// }
...
//			_log.error(e);
	...
	public List<CertificateRecord> findCertificateRecord(String schema, 
		...
		return certificateRecordFinder.findCertificateRecord(schema, soChungChi, organizationId, thuTucHanhChinhId, doiTuong, maSoHoSo, ngayNopFrom, ngayNopTo, tenDoanhNghiep, year, start, end);
	}

	public int countCertificateRecord(String schema, String soChungChi, long organizationId, String thuTucHanhChinhId, String doiTuong, String maSoHoSo, String ngayNopFrom,
			String ngayNopTo, String tenDoanhNghiep, int year) {
		return certificateRecordFinder.countCertificateRecord(schema, soChungChi, organizationId, thuTucHanhChinhId, doiTuong, maSoHoSo, ngayNopFrom, ngayNopTo, tenDoanhNghiep, year);
	}
