...
public class TthcBieuMauHoSoWrapper implements TthcBieuMauHoSo,
	...
	*/
	...
	/**
	* Returns the synch date of this tthc bieu mau ho so.
	*
	* @return the synch date of this tthc bieu mau ho so
	*/
	@Override
	public java.util.Date getSynchDate() {
		return _tthcBieuMauHoSo.getSynchDate();
	}

	/**
	* Sets the synch date of this tthc bieu mau ho so.
	*
	* @param SynchDate the synch date of this tthc bieu mau ho so
	*/
	@Override
	public void setSynchDate(java.util.Date SynchDate) {
		_tthcBieuMauHoSo.setSynchDate(SynchDate);
	}
