 ...
 * @generated
 */
public class AssessmentSpecificationConfigServiceClpInvoker {
	public AssessmentSpecificationConfigServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName470.equals(name) &&
			...
			return AssessmentSpecificationConfigServiceUtil.getBeanIdentifier();
		}

		if (_methodName471.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes471, parameterTypes)) {
			AssessmentSpecificationConfigServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
