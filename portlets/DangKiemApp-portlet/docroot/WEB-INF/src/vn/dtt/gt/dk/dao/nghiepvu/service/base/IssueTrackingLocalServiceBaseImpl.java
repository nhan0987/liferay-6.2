...
import vn.dtt.gt.dk.dao.nghiepvu.service.IssueTrackingLocalService;
...
/**
 * Provides the base implementation for the issue tracking local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.IssueTrackingLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.IssueTrackingLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.IssueTrackingLocalServiceUtil
 * @generated
 */
public abstract class IssueTrackingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements IssueTrackingLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.IssueTrackingLocalServiceUtil} to access the issue tracking local service.
	 */
	...
	@Override
	public IssueTracking addIssueTracking(IssueTracking issueTracking)
		throws SystemException {
		issueTracking.setNew(true);

		return issueTrackingPersistence.update(issueTracking);
	}
	 ...
	 */
	@Override
	public IssueTracking createIssueTracking(long id) {
		return issueTrackingPersistence.create(id);
	}
	...
	@Override
	public IssueTracking deleteIssueTracking(long id)
		throws PortalException, SystemException {
		return issueTrackingPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public IssueTracking deleteIssueTracking(IssueTracking issueTracking)
		throws SystemException {
		return issueTrackingPersistence.remove(issueTracking);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(IssueTracking.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return issueTrackingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return issueTrackingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public IssueTracking fetchIssueTracking(long id) throws SystemException {
		return issueTrackingPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public IssueTracking getIssueTracking(long id)
		throws PortalException, SystemException {
		return issueTrackingPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return issueTrackingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<IssueTracking> getIssueTrackings(int start, int end)
		throws SystemException {
		return issueTrackingPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getIssueTrackingsCount() throws SystemException {
		return issueTrackingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IssueTracking updateIssueTracking(IssueTracking issueTracking)
		throws SystemException {
		return issueTrackingPersistence.update(issueTracking);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.IssueTracking",
			issueTrackingLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = issueTrackingPersistence.getDataSource();
	...
	private IssueTrackingLocalServiceClpInvoker _clpInvoker = new IssueTrackingLocalServiceClpInvoker();
}