...
public class SafetyTestReportPersistenceImpl extends BasePersistenceImpl<SafetyTestReport>
	...
	protected SafetyTestReport toUnwrappedModel(
		...
		safetyTestReportImpl.setRegisteredInspectionId(safetyTestReport.getRegisteredInspectionId());
		safetyTestReportImpl.setInspectionrecordId(safetyTestReport.getInspectionrecordId());
		safetyTestReportImpl.setHosothutucId(safetyTestReport.getHosothutucId());
		safetyTestReportImpl.setSafetestRequirementId(safetyTestReport.getSafetestRequirementId());
		safetyTestReportImpl.setCorporationId(safetyTestReport.getCorporationId());
		safetyTestReportImpl.setRequirementNumber(safetyTestReport.getRequirementNumber());
		...
		safetyTestReportImpl.setPhieuxulyphuId(safetyTestReport.getPhieuxulyphuId());
	...
	private static Set<String> _badColumnNames = SetUtil.fromArray(new String[] {
				...
				"safetestRequirementId", "corporationId", "requirementNumber",
				"reportNumber", "confirmedResult", "attachedFile",
				"phieuxulyphuId", "signName", "signTitle", "signPlace",
				"signDate"
			});
