 ...
 * @generated
 */
public class PaymentStatusServiceClpInvoker {
	public PaymentStatusServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName470.equals(name) &&
			...
			return PaymentStatusServiceUtil.getBeanIdentifier();
		}

		if (_methodName471.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes471, parameterTypes)) {
			PaymentStatusServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
