...
import vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIDONGCOLocalService;
...
/**
 * Provides the base implementation for the t h o n g s o c h u n g c h i d o n g c o local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.THONGSOCHUNGCHIDONGCOLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class THONGSOCHUNGCHIDONGCOLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements THONGSOCHUNGCHIDONGCOLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIDONGCOLocalServiceUtil} to access the t h o n g s o c h u n g c h i d o n g c o local service.
	 */
	...
	@Override
	public THONGSOCHUNGCHIDONGCO addTHONGSOCHUNGCHIDONGCO(
		THONGSOCHUNGCHIDONGCO thongsochungchidongco) throws SystemException {
		thongsochungchidongco.setNew(true);

		return thongsochungchidongcoPersistence.update(thongsochungchidongco);
	}
	 ...
	 */
	@Override
	public THONGSOCHUNGCHIDONGCO createTHONGSOCHUNGCHIDONGCO(long id) {
		return thongsochungchidongcoPersistence.create(id);
	}
	...
	@Override
	public THONGSOCHUNGCHIDONGCO deleteTHONGSOCHUNGCHIDONGCO(long id)
		throws PortalException, SystemException {
		return thongsochungchidongcoPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public THONGSOCHUNGCHIDONGCO deleteTHONGSOCHUNGCHIDONGCO(
		THONGSOCHUNGCHIDONGCO thongsochungchidongco) throws SystemException {
		return thongsochungchidongcoPersistence.remove(thongsochungchidongco);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(THONGSOCHUNGCHIDONGCO.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return thongsochungchidongcoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return thongsochungchidongcoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public THONGSOCHUNGCHIDONGCO fetchTHONGSOCHUNGCHIDONGCO(long id)
		throws SystemException {
		return thongsochungchidongcoPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public THONGSOCHUNGCHIDONGCO getTHONGSOCHUNGCHIDONGCO(long id)
		throws PortalException, SystemException {
		return thongsochungchidongcoPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return thongsochungchidongcoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<THONGSOCHUNGCHIDONGCO> getTHONGSOCHUNGCHIDONGCOs(int start,
		int end) throws SystemException {
		return thongsochungchidongcoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTHONGSOCHUNGCHIDONGCOsCount() throws SystemException {
		return thongsochungchidongcoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public THONGSOCHUNGCHIDONGCO updateTHONGSOCHUNGCHIDONGCO(
		THONGSOCHUNGCHIDONGCO thongsochungchidongco) throws SystemException {
		return thongsochungchidongcoPersistence.update(thongsochungchidongco);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.THONGSOCHUNGCHIDONGCO",
			thongsochungchidongcoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = thongsochungchidongcoPersistence.getDataSource();
	...
	private THONGSOCHUNGCHIDONGCOLocalServiceClpInvoker _clpInvoker = new THONGSOCHUNGCHIDONGCOLocalServiceClpInvoker();
}