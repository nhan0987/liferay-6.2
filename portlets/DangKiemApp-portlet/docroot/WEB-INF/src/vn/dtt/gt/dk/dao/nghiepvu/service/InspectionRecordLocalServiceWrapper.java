...
public class InspectionRecordLocalServiceWrapper
	...
	*/
	...
	public boolean deleteInspectionRecordAttached(long inspectionId) {
		return _inspectionRecordLocalService.deleteInspectionRecordAttached(inspectionId);
	}
	...
	public int countMaSoBienBanKiemTra(long hosothutucid,
		...
		return _inspectionRecordLocalService.countMaSoBienBanKiemTra(hosothutucid,
			dangkySoBienBanKiemTra);
	}
