...
public class TthcHoSoThuTucLocalServiceWrapper
	...
	*/
	...
	public java.util.List<vn.dtt.gt.dk.dao.common.model.TthcHoSoThuTuc> findDanhSachHoSo(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _tthcHoSoThuTucLocalService.findDanhSachHoSo(organizationId,
	...
	public int countDanhSachHoSo(long organizationId, long phanNhomHoSoId,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _tthcHoSoThuTucLocalService.countDanhSachHoSo(organizationId,
			phanNhomHoSoId, thuTucHanhChinhId, maSoHoSo, ngayNopFrom,
	...
	public java.util.List<vn.dtt.gt.dk.dao.common.model.TthcHoSoThuTuc> findDanhSachHoSoAndDoiTuongAndMaSoBienNhan(
		...
		java.lang.String tenDoanhNghiep, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _tthcHoSoThuTucLocalService.findDanhSachHoSoAndDoiTuongAndMaSoBienNhan(doiTuong,
	...
	public int countDanhSachHoSoAndDoiTuongAndMaSoBienNhan(
		...
		java.lang.String tenDoanhNghiep)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _tthcHoSoThuTucLocalService.countDanhSachHoSoAndDoiTuongAndMaSoBienNhan(doiTuong,
			maSoBienNhan, organizationId, phanNhomHoSoId, thuTucHanhChinhId,
	...
	public int countHoSoThuTucByPhanNhomHoSoAndToChucQuanLy(
		...
		return _tthcHoSoThuTucLocalService.countHoSoThuTucByPhanNhomHoSoAndToChucQuanLy(phannhomhosoid,
			tochucquanly);
	}

	@Override
	public int countHoSoThuTucByTinNhanh(long phannhomhosoid) {
		return _tthcHoSoThuTucLocalService.countHoSoThuTucByTinNhanh(phannhomhosoid);
	}

	@Override
	public vn.dtt.gt.dk.dao.common.model.TthcHoSoThuTuc fetchByMaSoHoSo(
		java.lang.String maSoHoSo) {
		return _tthcHoSoThuTucLocalService.fetchByMaSoHoSo(maSoHoSo);
	}

	@Override
	public vn.dtt.gt.dk.dao.common.model.TthcHoSoThuTuc findByPhieuXuLyPhuId(
		long phieuXuLyPhuId) {
		return _tthcHoSoThuTucLocalService.findByPhieuXuLyPhuId(phieuXuLyPhuId);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.common.model.TthcHoSoThuTuc> searchTraCuuThongTinHoSo(
		...
		int end) {
		return _tthcHoSoThuTucLocalService.searchTraCuuThongTinHoSo(loaiThuTuc,
			soDangKiKiemTra, ngayCapDangKiFrom, ngayCapDangKiTo,
			organizationId, thuTucHanhChinhId, maSoHoSo, ngayNopFrom,
			ngayNopTo, nguoiNhapKhau, start, end);
	}
	...
	public int countSearchTraCuuThongTinHoSo(java.lang.String loaiThuTuc,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _tthcHoSoThuTucLocalService.countSearchTraCuuThongTinHoSo(loaiThuTuc,
			soDangKiKiemTra, ngayCapDangKiFrom, ngayCapDangKiTo,
			organizationId, thuTucHanhChinhId, maSoHoSo, ngayNopFrom,
			ngayNopTo, nguoiNhapKhau);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.common.model.TthcHoSoThuTuc> findByDebitNoteId(
		long idDebitNote)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _tthcHoSoThuTucLocalService.findByDebitNoteId(idDebitNote);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.common.model.TthcHoSoThuTuc> findByThamsoDongboMTgateway(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _tthcHoSoThuTucLocalService.findByThamsoDongboMTgateway(lastHosothutucId);
	}
