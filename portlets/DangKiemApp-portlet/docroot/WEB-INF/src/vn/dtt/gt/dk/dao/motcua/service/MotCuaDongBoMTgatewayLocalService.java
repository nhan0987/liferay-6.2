...
/**
 * Provides the local service interface for MotCuaDongBoMTgateway. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see MotCuaDongBoMTgatewayLocalServiceUtil
...
public interface MotCuaDongBoMTgatewayLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MotCuaDongBoMTgatewayLocalServiceUtil} to access the mot cua dong bo m tgateway local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.motcua.service.impl.MotCuaDongBoMTgatewayLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
