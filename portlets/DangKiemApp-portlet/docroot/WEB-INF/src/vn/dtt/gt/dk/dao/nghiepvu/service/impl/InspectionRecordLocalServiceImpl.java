...
//			_log.error(e);
	...
	public List<InspectionRecord> findByPhieuXuLyPhuIdAndCorporationId(long idPhieuXuLyPhu, String idCorporation) {
		return inspectionRecordFinder.findByPhieuXuLyPhuIdAndCorporationId(idPhieuXuLyPhu, idCorporation);
	}
	public List<InspectionRecord> findByPhieuXuLyPhuIdAndCorporationIdAndMarkUp(long idPhieuXuLyPhu, String idCorporation, int markupSafeTest, int markupEmissionTest, int markupControl) {
		return inspectionRecordFinder.findByPhieuXuLyPhuIdAndCorporationIdAndMarkUp(idPhieuXuLyPhu, idCorporation, markupSafeTest, markupEmissionTest, markupControl);
	}
	 ...
	 public boolean deleteInspectionCommonstatus(long inspectionId) {
		 return inspectionRecordFinder.deleteInspectionCommonstatus(inspectionId);
	 }
	 
	 public boolean deleteInspectionRecordAttached(long inspectionId) {
		 return inspectionRecordFinder.deleteInspectionRecordAttached(inspectionId);
	 }
	 
	 public List<InspectionRecord> findByBienBanLuuTam(long confirmedInspectionId) {
		return inspectionRecordFinder.findByBienBanLuuTam(confirmedInspectionId);
	 }
	 ...
	 public int countMaSoBienBanKiemTra(long hosothutucid, String dangkySoBienBanKiemTra ) {
			return inspectionRecordFinder.countMaSoBienBanKiemTra(hosothutucid, dangkySoBienBanKiemTra);
		 }
