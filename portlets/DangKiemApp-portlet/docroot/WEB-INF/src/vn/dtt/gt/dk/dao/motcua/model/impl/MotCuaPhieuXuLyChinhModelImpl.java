...
import vn.dtt.gt.dk.dao.motcua.model.MotCuaPhieuXuLyChinhSoap;
...
public class MotCuaPhieuXuLyChinhModelImpl extends BaseModelImpl<MotCuaPhieuXuLyChinh>
	 ...
	 */
	public static MotCuaPhieuXuLyChinh toModel(
		MotCuaPhieuXuLyChinhSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		MotCuaPhieuXuLyChinh model = new MotCuaPhieuXuLyChinhImpl();
	 ...
	 */
	public static List<MotCuaPhieuXuLyChinh> toModels(
		MotCuaPhieuXuLyChinhSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<MotCuaPhieuXuLyChinh> models = new ArrayList<MotCuaPhieuXuLyChinh>(soapModels.length);

		for (MotCuaPhieuXuLyChinhSoap soapModel : soapModels) {
