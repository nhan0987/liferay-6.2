 ...
 * @generated
 */
public class CopReportServiceClpInvoker {
	public CopReportServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName470.equals(name) &&
			...
			return CopReportServiceUtil.getBeanIdentifier();
		}

		if (_methodName471.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes471, parameterTypes)) {
			CopReportServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
