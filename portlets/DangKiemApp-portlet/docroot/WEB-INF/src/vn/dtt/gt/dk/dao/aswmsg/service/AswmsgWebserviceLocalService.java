...
/**
 * Provides the local service interface for AswmsgWebservice. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see AswmsgWebserviceLocalServiceUtil
...
public interface AswmsgWebserviceLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AswmsgWebserviceLocalServiceUtil} to access the aswmsg webservice local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.aswmsg.service.impl.AswmsgWebserviceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
