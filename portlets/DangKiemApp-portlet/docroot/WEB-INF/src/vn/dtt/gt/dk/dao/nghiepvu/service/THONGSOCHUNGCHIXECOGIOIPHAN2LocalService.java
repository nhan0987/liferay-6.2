...
/**
 * Provides the local service interface for THONGSOCHUNGCHIXECOGIOIPHAN2. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see THONGSOCHUNGCHIXECOGIOIPHAN2LocalServiceUtil
...
public interface THONGSOCHUNGCHIXECOGIOIPHAN2LocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link THONGSOCHUNGCHIXECOGIOIPHAN2LocalServiceUtil} to access the t h o n g s o c h u n g c h i x e c o g i o i p h a n2 local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.THONGSOCHUNGCHIXECOGIOIPHAN2LocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
