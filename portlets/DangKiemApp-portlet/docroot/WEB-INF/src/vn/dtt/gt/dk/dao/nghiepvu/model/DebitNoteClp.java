	...
	public void setCorporationId(String corporationId) {
		...
		if (_debitNoteRemoteModel != null) {
			try {
				...
				method.invoke(_debitNoteRemoteModel, corporationId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setFinancialAccountant(String financialAccountant) {
		...
		if (_debitNoteRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setFinancialAccountant",
						String.class);

				method.invoke(_debitNoteRemoteModel, financialAccountant);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTotalPayment(double totalPayment) {
		...
		if (_debitNoteRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setTotalPayment", double.class);
