...
import vn.dtt.gt.dk.dao.nghiepvu.model.PaymentStatusSoap;
...
public class PaymentStatusModelImpl extends BaseModelImpl<PaymentStatus>
	 ...
	 */
	public static PaymentStatus toModel(PaymentStatusSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		PaymentStatus model = new PaymentStatusImpl();
		...
		model.setInspectionFee(soapModel.getInspectionFee());
		model.setOtherCosts(soapModel.getOtherCosts());
		model.setTotalCostsAndFee(soapModel.getTotalCostsAndFee());
		model.setTax(soapModel.getTax());
		model.setCharges(soapModel.getCharges());
		model.setTotalRealDebit(soapModel.getTotalRealDebit());
		model.setTotalDebit(soapModel.getTotalDebit());
		model.setTotalCredit(soapModel.getTotalCredit());
	 ...
	 */
	public static List<PaymentStatus> toModels(PaymentStatusSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<PaymentStatus> models = new ArrayList<PaymentStatus>(soapModels.length);

		for (PaymentStatusSoap soapModel : soapModels) {
