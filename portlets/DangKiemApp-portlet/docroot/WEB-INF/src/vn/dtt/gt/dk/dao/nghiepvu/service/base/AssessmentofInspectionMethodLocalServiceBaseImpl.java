...
import vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentofInspectionMethodLocalService;
...
/**
 * Provides the base implementation for the assessmentof inspection method local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.AssessmentofInspectionMethodLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class AssessmentofInspectionMethodLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AssessmentofInspectionMethodLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentofInspectionMethodLocalServiceUtil} to access the assessmentof inspection method local service.
	 */
	...
	@Override
	public AssessmentofInspectionMethod addAssessmentofInspectionMethod(
		AssessmentofInspectionMethod assessmentofInspectionMethod)
		throws SystemException {
		assessmentofInspectionMethod.setNew(true);

		return assessmentofInspectionMethodPersistence.update(assessmentofInspectionMethod);
	}
	 ...
	 */
	@Override
	public AssessmentofInspectionMethod createAssessmentofInspectionMethod(
		long id) {
		return assessmentofInspectionMethodPersistence.create(id);
	}
	...
	@Override
	public AssessmentofInspectionMethod deleteAssessmentofInspectionMethod(
		long id) throws PortalException, SystemException {
		return assessmentofInspectionMethodPersistence.remove(id);
	}
	...
	public AssessmentofInspectionMethod deleteAssessmentofInspectionMethod(
		AssessmentofInspectionMethod assessmentofInspectionMethod)
		throws SystemException {
		return assessmentofInspectionMethodPersistence.remove(assessmentofInspectionMethod);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AssessmentofInspectionMethod.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessmentofInspectionMethodPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessmentofInspectionMethodPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AssessmentofInspectionMethod fetchAssessmentofInspectionMethod(
		long id) throws SystemException {
		return assessmentofInspectionMethodPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public AssessmentofInspectionMethod getAssessmentofInspectionMethod(long id)
		throws PortalException, SystemException {
		return assessmentofInspectionMethodPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assessmentofInspectionMethodPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AssessmentofInspectionMethod> getAssessmentofInspectionMethods(
		int start, int end) throws SystemException {
		return assessmentofInspectionMethodPersistence.findAll(start, end);
	}
	...
	public int getAssessmentofInspectionMethodsCount()
		throws SystemException {
		return assessmentofInspectionMethodPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AssessmentofInspectionMethod updateAssessmentofInspectionMethod(
		AssessmentofInspectionMethod assessmentofInspectionMethod)
		throws SystemException {
		return assessmentofInspectionMethodPersistence.update(assessmentofInspectionMethod);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.AssessmentofInspectionMethod",
			assessmentofInspectionMethodLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assessmentofInspectionMethodPersistence.getDataSource();
	...
	private AssessmentofInspectionMethodLocalServiceClpInvoker _clpInvoker = new AssessmentofInspectionMethodLocalServiceClpInvoker();
}