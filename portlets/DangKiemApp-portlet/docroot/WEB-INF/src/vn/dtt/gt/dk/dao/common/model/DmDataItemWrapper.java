...
public class DmDataItemWrapper implements DmDataItem, ModelWrapper<DmDataItem> {
	...
	*/
	...
	/**
	* Returns the synch date of this dm data item.
	*
	* @return the synch date of this dm data item
	*/
	@Override
	public java.util.Date getSynchDate() {
		return _dmDataItem.getSynchDate();
	}

	/**
	* Sets the synch date of this dm data item.
	*
	* @param SynchDate the synch date of this dm data item
	*/
	@Override
	public void setSynchDate(java.util.Date SynchDate) {
		_dmDataItem.setSynchDate(SynchDate);
	}
