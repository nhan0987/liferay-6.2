...
/**
 * Provides the local service interface for PhieuXuLyPhuHoSoThuTuc. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see PhieuXuLyPhuHoSoThuTucLocalServiceUtil
...
public interface PhieuXuLyPhuHoSoThuTucLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PhieuXuLyPhuHoSoThuTucLocalServiceUtil} to access the phieu xu ly phu ho so thu tuc local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.motcua.service.impl.PhieuXuLyPhuHoSoThuTucLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
