 ...
 * @generated
 */
public class NewExchangeRateLocalServiceClp
	implements NewExchangeRateLocalService {
	public NewExchangeRateLocalServiceClp(
	...
	public vn.dtt.gt.dk.dao.nghiepvu.model.NewExchangeRate addNewExchangeRate(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(newExchangeRate) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.gt.dk.dao.nghiepvu.model.NewExchangeRate)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.NewExchangeRate> getNewExchangeRates(
		...
		return (java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.NewExchangeRate>)ClpSerializer.translateOutput(returnObj);
	}
