...
public class VehicleGroupInitialPersistenceImpl extends BasePersistenceImpl<VehicleGroupInitial>
	...
	protected VehicleGroupInitial toUnwrappedModel(
		...
		vehicleGroupInitialImpl.setControlreportNo(vehicleGroupInitial.getControlreportNo());
		...
		vehicleGroupInitialImpl.setControlreportId(vehicleGroupInitial.getControlreportId());
		...
		vehicleGroupInitialImpl.setSynchDate(vehicleGroupInitial.getSynchDate());
	...
	private static Set<String> _badColumnNames = SetUtil.fromArray(new String[] {
				...
				"emissiontestreportNo", "copreportNo", "controlreportNo",
				"vehicleType", "engineType", "tradeMark", "markAsVehicle",
				"commercialName", "modelCode", "productionPlant",
				"addressOfProductionPlant", "emissionStandard",
				"safetyTestReportId", "emissionTestReportId", "copReportId",
				"controlreportId", "specificationVersion", "attachedFile",
				"SynchDate"
			});
