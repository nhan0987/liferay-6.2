...
public class ControlReportWrapper implements ControlReport,
	...
	*/
	...
	/**
	* Returns the phieuxulyphu ID of this control report.
	*
	* @return the phieuxulyphu ID of this control report
	*/
	@Override
	public long getPhieuxulyphuId() {
		return _controlReport.getPhieuxulyphuId();
	}

	/**
	* Sets the phieuxulyphu ID of this control report.
	*
	* @param phieuxulyphuId the phieuxulyphu ID of this control report
	*/
	@Override
	public void setPhieuxulyphuId(long phieuxulyphuId) {
		_controlReport.setPhieuxulyphuId(phieuxulyphuId);
	}
