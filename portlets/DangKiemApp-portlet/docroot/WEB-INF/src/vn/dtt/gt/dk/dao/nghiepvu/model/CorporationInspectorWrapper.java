...
public class CorporationInspectorWrapper implements CorporationInspector,
	...
	*/
	...
	/**
	* Returns the search vehicle of this corporation inspector.
	*
	* @return the search vehicle of this corporation inspector
	*/
	@Override
	public int getSearchVehicle() {
		return _corporationInspector.getSearchVehicle();
	}

	/**
	* Sets the search vehicle of this corporation inspector.
	*
	* @param searchVehicle the search vehicle of this corporation inspector
	*/
	@Override
	public void setSearchVehicle(int searchVehicle) {
		_corporationInspector.setSearchVehicle(searchVehicle);
	}
