...
/**
 * Provides the local service interface for InspectionRecordSpec. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see InspectionRecordSpecLocalServiceUtil
...
public interface InspectionRecordSpecLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link InspectionRecordSpecLocalServiceUtil} to access the inspection record spec local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.InspectionRecordSpecLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
