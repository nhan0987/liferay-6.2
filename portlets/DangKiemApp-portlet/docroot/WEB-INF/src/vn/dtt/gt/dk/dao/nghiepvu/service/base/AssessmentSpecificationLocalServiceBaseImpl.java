...
import vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentSpecificationLocalService;
...
/**
 * Provides the base implementation for the assessment specification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.AssessmentSpecificationLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.AssessmentSpecificationLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentSpecificationLocalServiceUtil
 * @generated
 */
public abstract class AssessmentSpecificationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssessmentSpecificationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentSpecificationLocalServiceUtil} to access the assessment specification local service.
	 */
	...
	@Override
	public AssessmentSpecification addAssessmentSpecification(
		AssessmentSpecification assessmentSpecification)
		throws SystemException {
		assessmentSpecification.setNew(true);

		return assessmentSpecificationPersistence.update(assessmentSpecification);
	}
	 ...
	 */
	@Override
	public AssessmentSpecification createAssessmentSpecification(long id) {
		return assessmentSpecificationPersistence.create(id);
	}
	...
	@Override
	public AssessmentSpecification deleteAssessmentSpecification(long id)
		throws PortalException, SystemException {
		return assessmentSpecificationPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AssessmentSpecification deleteAssessmentSpecification(
		AssessmentSpecification assessmentSpecification)
		throws SystemException {
		return assessmentSpecificationPersistence.remove(assessmentSpecification);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AssessmentSpecification.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessmentSpecificationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessmentSpecificationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AssessmentSpecification fetchAssessmentSpecification(long id)
		throws SystemException {
		return assessmentSpecificationPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public AssessmentSpecification getAssessmentSpecification(long id)
		throws PortalException, SystemException {
		return assessmentSpecificationPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assessmentSpecificationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AssessmentSpecification> getAssessmentSpecifications(
		int start, int end) throws SystemException {
		return assessmentSpecificationPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAssessmentSpecificationsCount() throws SystemException {
		return assessmentSpecificationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AssessmentSpecification updateAssessmentSpecification(
		AssessmentSpecification assessmentSpecification)
		throws SystemException {
		return assessmentSpecificationPersistence.update(assessmentSpecification);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.AssessmentSpecification",
			assessmentSpecificationLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assessmentSpecificationPersistence.getDataSource();
	...
	private AssessmentSpecificationLocalServiceClpInvoker _clpInvoker = new AssessmentSpecificationLocalServiceClpInvoker();
}