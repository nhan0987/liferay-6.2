...
/**
 * This class is used by SOAP remote services, specifically {@link vn.dtt.gt.dk.dao.nghiepvu.service.http.AssessmentofImporterControlServiceSoap}.
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.http.AssessmentofImporterControlServiceSoap
 * @generated
 */
public class AssessmentofImporterControlSoap implements Serializable {
	public static AssessmentofImporterControlSoap toSoapModel(
		AssessmentofImporterControl model) {
		AssessmentofImporterControlSoap soapModel = new AssessmentofImporterControlSoap();
		...
		soapModel.setImportercodereference(model.getImportercodereference());
	...
	public static AssessmentofImporterControlSoap[] toSoapModels(
		AssessmentofImporterControl[] models) {
		AssessmentofImporterControlSoap[] soapModels = new AssessmentofImporterControlSoap[models.length];
	...
	public static AssessmentofImporterControlSoap[][] toSoapModels(
		AssessmentofImporterControl[][] models) {
		AssessmentofImporterControlSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new AssessmentofImporterControlSoap[models.length][models[0].length];
		}
		else {
			soapModels = new AssessmentofImporterControlSoap[0][0];
		}
	...
	public static AssessmentofImporterControlSoap[] toSoapModels(
		List<AssessmentofImporterControl> models) {
		List<AssessmentofImporterControlSoap> soapModels = new ArrayList<AssessmentofImporterControlSoap>(models.size());

		for (AssessmentofImporterControl model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new AssessmentofImporterControlSoap[soapModels.size()]);
	}

	public AssessmentofImporterControlSoap() {
	}
