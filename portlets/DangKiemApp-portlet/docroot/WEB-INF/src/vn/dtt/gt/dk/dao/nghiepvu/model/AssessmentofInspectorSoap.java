...
/**
 * This class is used by SOAP remote services, specifically {@link vn.dtt.gt.dk.dao.nghiepvu.service.http.AssessmentofInspectorServiceSoap}.
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.http.AssessmentofInspectorServiceSoap
 * @generated
 */
public class AssessmentofInspectorSoap implements Serializable {
	public static AssessmentofInspectorSoap toSoapModel(
		AssessmentofInspector model) {
		AssessmentofInspectorSoap soapModel = new AssessmentofInspectorSoap();

		soapModel.setId(model.getId());
		soapModel.setInspectorcontactcode(model.getInspectorcontactcode());
		soapModel.setInspectorname(model.getInspectorname());
		soapModel.setInspectorposition(model.getInspectorposition());
	...
	public static AssessmentofInspectorSoap[] toSoapModels(
		AssessmentofInspector[] models) {
		AssessmentofInspectorSoap[] soapModels = new AssessmentofInspectorSoap[models.length];
	...
	public static AssessmentofInspectorSoap[][] toSoapModels(
		AssessmentofInspector[][] models) {
		AssessmentofInspectorSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new AssessmentofInspectorSoap[models.length][models[0].length];
		}
		else {
			soapModels = new AssessmentofInspectorSoap[0][0];
		}
	...
	public static AssessmentofInspectorSoap[] toSoapModels(
		List<AssessmentofInspector> models) {
		List<AssessmentofInspectorSoap> soapModels = new ArrayList<AssessmentofInspectorSoap>(models.size());

		for (AssessmentofInspector model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new AssessmentofInspectorSoap[soapModels.size()]);
	}

	public AssessmentofInspectorSoap() {
	}
