...
import vn.dtt.gt.dk.dao.nghiepvu.service.CertificateRecordLocalService;
...
/**
 * Provides the base implementation for the certificate record local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.CertificateRecordLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class CertificateRecordLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CertificateRecordLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.CertificateRecordLocalServiceUtil} to access the certificate record local service.
	 */
	...
	@Override
	public CertificateRecord addCertificateRecord(
		CertificateRecord certificateRecord) throws SystemException {
		certificateRecord.setNew(true);

		return certificateRecordPersistence.update(certificateRecord);
	}
	 ...
	 */
	@Override
	public CertificateRecord createCertificateRecord(long id) {
		return certificateRecordPersistence.create(id);
	}
	...
	@Override
	public CertificateRecord deleteCertificateRecord(long id)
		throws PortalException, SystemException {
		return certificateRecordPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CertificateRecord deleteCertificateRecord(
		CertificateRecord certificateRecord) throws SystemException {
		return certificateRecordPersistence.remove(certificateRecord);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CertificateRecord.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return certificateRecordPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return certificateRecordPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CertificateRecord fetchCertificateRecord(long id)
		throws SystemException {
		return certificateRecordPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public CertificateRecord getCertificateRecord(long id)
		throws PortalException, SystemException {
		return certificateRecordPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return certificateRecordPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CertificateRecord> getCertificateRecords(int start, int end)
		throws SystemException {
		return certificateRecordPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCertificateRecordsCount() throws SystemException {
		return certificateRecordPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CertificateRecord updateCertificateRecord(
		CertificateRecord certificateRecord) throws SystemException {
		return certificateRecordPersistence.update(certificateRecord);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.CertificateRecord",
			certificateRecordLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = certificateRecordPersistence.getDataSource();
	...
	private CertificateRecordLocalServiceClpInvoker _clpInvoker = new CertificateRecordLocalServiceClpInvoker();
}