...
import vn.dtt.gt.dk.dao.nghiepvu.service.CorporationViewLocalService;
...
/**
 * Provides the base implementation for the corporation view local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.CorporationViewLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class CorporationViewLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CorporationViewLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.CorporationViewLocalServiceUtil} to access the corporation view local service.
	 */
	...
	@Override
	public CorporationView addCorporationView(CorporationView corporationView)
		throws SystemException {
		corporationView.setNew(true);

		return corporationViewPersistence.update(corporationView);
	}
	 ...
	 */
	@Override
	public CorporationView createCorporationView(long id) {
		return corporationViewPersistence.create(id);
	}
	...
	@Override
	public CorporationView deleteCorporationView(long id)
		throws PortalException, SystemException {
		return corporationViewPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CorporationView deleteCorporationView(
		CorporationView corporationView) throws SystemException {
		return corporationViewPersistence.remove(corporationView);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CorporationView.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return corporationViewPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return corporationViewPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CorporationView fetchCorporationView(long id)
		throws SystemException {
		return corporationViewPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public CorporationView getCorporationView(long id)
		throws PortalException, SystemException {
		return corporationViewPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return corporationViewPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CorporationView> getCorporationViews(int start, int end)
		throws SystemException {
		return corporationViewPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCorporationViewsCount() throws SystemException {
		return corporationViewPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CorporationView updateCorporationView(
		CorporationView corporationView) throws SystemException {
		return corporationViewPersistence.update(corporationView);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.CorporationView",
			corporationViewLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = corporationViewPersistence.getDataSource();
	...
	private CorporationViewLocalServiceClpInvoker _clpInvoker = new CorporationViewLocalServiceClpInvoker();
}