...
import vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIXEDAPDIENLocalService;
...
/**
 * Provides the base implementation for the t h o n g s o c h u n g c h i x e d a p d i e n local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.THONGSOCHUNGCHIXEDAPDIENLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.THONGSOCHUNGCHIXEDAPDIENLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIXEDAPDIENLocalServiceUtil
 * @generated
 */
public abstract class THONGSOCHUNGCHIXEDAPDIENLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements THONGSOCHUNGCHIXEDAPDIENLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIXEDAPDIENLocalServiceUtil} to access the t h o n g s o c h u n g c h i x e d a p d i e n local service.
	 */
	...
	@Override
	public THONGSOCHUNGCHIXEDAPDIEN addTHONGSOCHUNGCHIXEDAPDIEN(
		THONGSOCHUNGCHIXEDAPDIEN thongsochungchixedapdien)
		throws SystemException {
		thongsochungchixedapdien.setNew(true);

		return thongsochungchixedapdienPersistence.update(thongsochungchixedapdien);
	}
	 ...
	 */
	@Override
	public THONGSOCHUNGCHIXEDAPDIEN createTHONGSOCHUNGCHIXEDAPDIEN(long id) {
		return thongsochungchixedapdienPersistence.create(id);
	}
	...
	@Override
	public THONGSOCHUNGCHIXEDAPDIEN deleteTHONGSOCHUNGCHIXEDAPDIEN(long id)
		throws PortalException, SystemException {
		return thongsochungchixedapdienPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public THONGSOCHUNGCHIXEDAPDIEN deleteTHONGSOCHUNGCHIXEDAPDIEN(
		THONGSOCHUNGCHIXEDAPDIEN thongsochungchixedapdien)
		throws SystemException {
		return thongsochungchixedapdienPersistence.remove(thongsochungchixedapdien);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(THONGSOCHUNGCHIXEDAPDIEN.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return thongsochungchixedapdienPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return thongsochungchixedapdienPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public THONGSOCHUNGCHIXEDAPDIEN fetchTHONGSOCHUNGCHIXEDAPDIEN(long id)
		throws SystemException {
		return thongsochungchixedapdienPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public THONGSOCHUNGCHIXEDAPDIEN getTHONGSOCHUNGCHIXEDAPDIEN(long id)
		throws PortalException, SystemException {
		return thongsochungchixedapdienPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return thongsochungchixedapdienPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<THONGSOCHUNGCHIXEDAPDIEN> getTHONGSOCHUNGCHIXEDAPDIENs(
		int start, int end) throws SystemException {
		return thongsochungchixedapdienPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTHONGSOCHUNGCHIXEDAPDIENsCount() throws SystemException {
		return thongsochungchixedapdienPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public THONGSOCHUNGCHIXEDAPDIEN updateTHONGSOCHUNGCHIXEDAPDIEN(
		THONGSOCHUNGCHIXEDAPDIEN thongsochungchixedapdien)
		throws SystemException {
		return thongsochungchixedapdienPersistence.update(thongsochungchixedapdien);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.THONGSOCHUNGCHIXEDAPDIEN",
			thongsochungchixedapdienLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.gt.dk.dao.nghiepvu.model.THONGSOCHUNGCHIXEDAPDIEN");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = thongsochungchixedapdienPersistence.getDataSource();
	...
	private THONGSOCHUNGCHIXEDAPDIENLocalServiceClpInvoker _clpInvoker = new THONGSOCHUNGCHIXEDAPDIENLocalServiceClpInvoker();
}