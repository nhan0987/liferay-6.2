...
import vn.dtt.gt.dk.dao.nghiepvu.service.ControlRequestLocalService;
...
/**
 * Provides the base implementation for the control request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.ControlRequestLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.ControlRequestLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.ControlRequestLocalServiceUtil
 * @generated
 */
public abstract class ControlRequestLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ControlRequestLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.ControlRequestLocalServiceUtil} to access the control request local service.
	 */
	...
	@Override
	public ControlRequest addControlRequest(ControlRequest controlRequest)
		throws SystemException {
		controlRequest.setNew(true);

		return controlRequestPersistence.update(controlRequest);
	}
	 ...
	 */
	@Override
	public ControlRequest createControlRequest(long id) {
		return controlRequestPersistence.create(id);
	}
	...
	@Override
	public ControlRequest deleteControlRequest(long id)
		throws PortalException, SystemException {
		return controlRequestPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ControlRequest deleteControlRequest(ControlRequest controlRequest)
		throws SystemException {
		return controlRequestPersistence.remove(controlRequest);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ControlRequest.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return controlRequestPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return controlRequestPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ControlRequest fetchControlRequest(long id)
		throws SystemException {
		return controlRequestPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public ControlRequest getControlRequest(long id)
		throws PortalException, SystemException {
		return controlRequestPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return controlRequestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ControlRequest> getControlRequests(int start, int end)
		throws SystemException {
		return controlRequestPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getControlRequestsCount() throws SystemException {
		return controlRequestPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ControlRequest updateControlRequest(ControlRequest controlRequest)
		throws SystemException {
		return controlRequestPersistence.update(controlRequest);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.ControlRequest",
			controlRequestLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = controlRequestPersistence.getDataSource();
	...
	private ControlRequestLocalServiceClpInvoker _clpInvoker = new ControlRequestLocalServiceClpInvoker();
}