...
public class VehicleGroupModelImpl extends BaseModelImpl<VehicleGroup>
	...
	public Object clone() {
		...
		vehicleGroupImpl.setControlreportNo(getControlreportNo());
		...
		vehicleGroupImpl.setControlreportId(getControlreportId());
	...
	public CacheModel<VehicleGroup> toCacheModel() {
		...
		vehicleGroupCacheModel.controlreportNo = getControlreportNo();

		String controlreportNo = vehicleGroupCacheModel.controlreportNo;

		if ((controlreportNo != null) && (controlreportNo.length() == 0)) {
			vehicleGroupCacheModel.controlreportNo = null;
		}
		...
		vehicleGroupCacheModel.controlreportId = getControlreportId();
