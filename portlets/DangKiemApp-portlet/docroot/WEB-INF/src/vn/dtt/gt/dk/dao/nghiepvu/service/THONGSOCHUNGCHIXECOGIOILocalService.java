...
/**
 * Provides the local service interface for THONGSOCHUNGCHIXECOGIOI. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see THONGSOCHUNGCHIXECOGIOILocalServiceUtil
...
public interface THONGSOCHUNGCHIXECOGIOILocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link THONGSOCHUNGCHIXECOGIOILocalServiceUtil} to access the t h o n g s o c h u n g c h i x e c o g i o i local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.THONGSOCHUNGCHIXECOGIOILocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
