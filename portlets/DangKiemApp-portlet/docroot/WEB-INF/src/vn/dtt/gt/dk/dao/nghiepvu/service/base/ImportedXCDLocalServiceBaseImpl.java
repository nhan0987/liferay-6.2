...
import vn.dtt.gt.dk.dao.nghiepvu.service.ImportedXCDLocalService;
...
/**
 * Provides the base implementation for the imported x c d local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.ImportedXCDLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class ImportedXCDLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ImportedXCDLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.ImportedXCDLocalServiceUtil} to access the imported x c d local service.
	 */
	...
	@Override
	public ImportedXCD addImportedXCD(ImportedXCD importedXCD)
		throws SystemException {
		importedXCD.setNew(true);

		return importedXCDPersistence.update(importedXCD);
	}
	 ...
	 */
	@Override
	public ImportedXCD createImportedXCD(long id) {
		return importedXCDPersistence.create(id);
	}
	...
	@Override
	public ImportedXCD deleteImportedXCD(long id)
		throws PortalException, SystemException {
		return importedXCDPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ImportedXCD deleteImportedXCD(ImportedXCD importedXCD)
		throws SystemException {
		return importedXCDPersistence.remove(importedXCD);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ImportedXCD.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return importedXCDPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return importedXCDPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return importedXCDPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ImportedXCD fetchImportedXCD(long id) throws SystemException {
		return importedXCDPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public ImportedXCD getImportedXCD(long id)
		throws PortalException, SystemException {
		return importedXCDPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return importedXCDPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ImportedXCD> getImportedXCDs(int start, int end)
		throws SystemException {
		return importedXCDPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getImportedXCDsCount() throws SystemException {
		return importedXCDPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ImportedXCD updateImportedXCD(ImportedXCD importedXCD)
		throws SystemException {
		return importedXCDPersistence.update(importedXCD);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.ImportedXCD",
			importedXCDLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = importedXCDPersistence.getDataSource();
	...
	private ImportedXCDLocalServiceClpInvoker _clpInvoker = new ImportedXCDLocalServiceClpInvoker();
}