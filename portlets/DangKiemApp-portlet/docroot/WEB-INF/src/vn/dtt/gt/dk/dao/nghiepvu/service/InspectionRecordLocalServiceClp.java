 ...
 * @generated
 */
public class InspectionRecordLocalServiceClp
	implements InspectionRecordLocalService {
	public InspectionRecordLocalServiceClp(
		...
		_methodName19 = "findByRegisteredInspectionId";

		_methodParameterTypes19 = new String[] { "long" };

		_methodName20 = "findByPhieuXuLyPhuId";
		...
		_methodName22 = "findByPhieuXuLyPhuIdAndCorporationId";

		_methodParameterTypes22 = new String[] { "long", "java.lang.String" };

		_methodName23 = "findByPhieuXuLyPhuIdAndCorporationIdAndMarkUp";

		_methodParameterTypes23 = new String[] {
				"long", "java.lang.String", "int", "int", "int"
			};

		_methodName24 = "deleteInspectionRecordSpec";

		_methodParameterTypes24 = new String[] { "long" };

		_methodName25 = "deleteInspectionCommonstatus";

		_methodParameterTypes25 = new String[] { "long" };

		_methodName26 = "deleteInspectionRecordAttached";

		_methodParameterTypes26 = new String[] { "long" };

		_methodName27 = "findByBienBanLuuTam";

		_methodParameterTypes27 = new String[] { "long" };

		_methodName28 = "findByAttachedFileID";

		_methodParameterTypes28 = new String[] { "long" };

		_methodName29 = "countMaSoBienBanKiemTra";
	...
	public vn.dtt.gt.dk.dao.nghiepvu.model.InspectionRecord addInspectionRecord(
		...
		return (vn.dtt.gt.dk.dao.nghiepvu.model.InspectionRecord)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.InspectionRecord> getInspectionRecords(
		...
		return (java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.InspectionRecord>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.InspectionRecord> findByRegisteredInspectionId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					new Object[] { registeredInspectionId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public vn.dtt.gt.dk.dao.nghiepvu.model.InspectionRecord findByPhieuXuLyPhuId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					_methodParameterTypes20, new Object[] { phieuXuLyPhuId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.InspectionRecord> findByPhieuXuLyPhuIdAndCorporationId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName22,
					...
					ClpSerializer.translateInput(idCorporation)
					});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public boolean deleteInspectionRecordSpec(long inspectionId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName24,
					_methodParameterTypes24, new Object[] { inspectionId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public boolean deleteInspectionCommonstatus(long inspectionId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName25,
					_methodParameterTypes25, new Object[] { inspectionId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public boolean deleteInspectionRecordAttached(long inspectionId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName26,
					_methodParameterTypes26, new Object[] { inspectionId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.InspectionRecord> findByAttachedFileID(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName28,
					_methodParameterTypes28, new Object[] { idAttachedFile });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public int countMaSoBienBanKiemTra(long hosothutucid,
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName29,
					...
					ClpSerializer.translateInput(dangkySoBienBanKiemTra)
					});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
