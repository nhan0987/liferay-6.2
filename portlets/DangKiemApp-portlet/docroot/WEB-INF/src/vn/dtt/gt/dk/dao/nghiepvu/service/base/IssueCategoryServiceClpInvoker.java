 ...
 * @generated
 */
public class IssueCategoryServiceClpInvoker {
	public IssueCategoryServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName470.equals(name) &&
			...
			return IssueCategoryServiceUtil.getBeanIdentifier();
		}

		if (_methodName471.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes471, parameterTypes)) {
			IssueCategoryServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
