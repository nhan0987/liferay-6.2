...
/**
 * This class is used by SOAP remote services, specifically {@link vn.dtt.gt.dk.dao.nghiepvu.service.http.AssessmentofImporterServiceSoap}.
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.http.AssessmentofImporterServiceSoap
 * @generated
 */
public class AssessmentofImporterSoap implements Serializable {
	public static AssessmentofImporterSoap toSoapModel(
		AssessmentofImporter model) {
		AssessmentofImporterSoap soapModel = new AssessmentofImporterSoap();
	...
	public static AssessmentofImporterSoap[] toSoapModels(
		AssessmentofImporter[] models) {
		AssessmentofImporterSoap[] soapModels = new AssessmentofImporterSoap[models.length];
	...
	public static AssessmentofImporterSoap[][] toSoapModels(
		AssessmentofImporter[][] models) {
		AssessmentofImporterSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new AssessmentofImporterSoap[models.length][models[0].length];
		}
		else {
			soapModels = new AssessmentofImporterSoap[0][0];
		}
	...
	public static AssessmentofImporterSoap[] toSoapModels(
		List<AssessmentofImporter> models) {
		List<AssessmentofImporterSoap> soapModels = new ArrayList<AssessmentofImporterSoap>(models.size());

		for (AssessmentofImporter model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new AssessmentofImporterSoap[soapModels.size()]);
	}

	public AssessmentofImporterSoap() {
	}
