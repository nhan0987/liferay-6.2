...
import vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIDONGCOService;
...
/**
 * Provides the base implementation for the t h o n g s o c h u n g c h i d o n g c o remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.THONGSOCHUNGCHIDONGCOServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.THONGSOCHUNGCHIDONGCOServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIDONGCOServiceUtil
 * @generated
 */
public abstract class THONGSOCHUNGCHIDONGCOServiceBaseImpl
	extends BaseServiceImpl implements THONGSOCHUNGCHIDONGCOService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIDONGCOServiceUtil} to access the t h o n g s o c h u n g c h i d o n g c o remote service.
	 */
	...
	private THONGSOCHUNGCHIDONGCOServiceClpInvoker _clpInvoker = new THONGSOCHUNGCHIDONGCOServiceClpInvoker();
}