 ...
 * @generated
 */
public class ViewTrungSoKhungDongCoServiceClpInvoker {
	public ViewTrungSoKhungDongCoServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName470.equals(name) &&
			...
			return ViewTrungSoKhungDongCoServiceUtil.getBeanIdentifier();
		}

		if (_methodName471.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes471, parameterTypes)) {
			ViewTrungSoKhungDongCoServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
