...
public class THONGSOCHUNGCHIXEBONBANHFinderImpl extends BasePersistenceImpl<THONGSOCHUNGCHIXEBONBANH> implements THONGSOCHUNGCHIXEBONBANHFinder {
	
	private Log _log = LogFactoryUtil.getLog(THONGSOCHUNGCHIXEBONBANHFinderImpl.class);
	public static final String FIND_THONGSOCHUNGCHIXEBONBANH = THONGSOCHUNGCHIXEBONBANHFinder.class.getName() + ".findByCertificateRecordAndHosothutucId";
	...
	public List<THONGSOCHUNGCHIXEBONBANH> findByCertificateRecordAndHosothutucId(long hosothutucid) {
		...
		try {
			...
			String sql = CustomSQLUtil.get(FIND_THONGSOCHUNGCHIXEBONBANH);
			...
			q.addEntity("THONGSOCHUNGCHIXEBONBANH", THONGSOCHUNGCHIXEBONBANHImpl.class);
			...
			return (List<THONGSOCHUNGCHIXEBONBANH>) QueryUtil.list(q, getDialect(), QueryUtil.ALL_POS, QueryUtil.ALL_POS);
		...
		return new ArrayList<THONGSOCHUNGCHIXEBONBANH>();
	}	
...
public List<THONGSOCHUNGCHIXEBONBANH> findByVehicleGroupInitialAndHosothutucId(long hosothutucid) {
	...
	public boolean deleteXBBVehicleCertificateSpecWithHosothutucId(long hosothutucId) {
		Session session = null;
		...
		try {
			...
			query.append("Delete from dkvn_nghiepvu.thongsochungchi_xebonbanh where hosothutucid =  " + hosothutucId);
								
//			log.info("=========deleteXBBVehicleCertificateSpecWithHosothutucId===" + query.toString());
