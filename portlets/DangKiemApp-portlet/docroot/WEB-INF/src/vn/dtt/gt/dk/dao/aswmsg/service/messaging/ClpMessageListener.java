...
package vn.dtt.gt.dk.dao.aswmsg.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			AswmsgMessageLogLocalServiceUtil.clearService();

			AswmsgMessageQueueLocalServiceUtil.clearService();

			AswmsgSyndatahistoryLocalServiceUtil.clearService();

			AswmsgValidationLogLocalServiceUtil.clearService();

			AswmsgWebserviceLocalServiceUtil.clearService();
