 ...
 * @generated
 */
public class ControlRequirementServiceClpInvoker {
	public ControlRequirementServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName470.equals(name) &&
			...
			return ControlRequirementServiceUtil.getBeanIdentifier();
		}

		if (_methodName471.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes471, parameterTypes)) {
			ControlRequirementServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
