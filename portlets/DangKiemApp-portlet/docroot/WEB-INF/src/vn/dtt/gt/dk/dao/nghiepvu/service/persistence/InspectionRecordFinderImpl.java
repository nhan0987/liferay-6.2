	...
	public List<InspectionRecord> findByPhieuXuLyPhuIdAndCorporationIdAndMarkUp(long idPhieuXuLyPhu, String idCorporation, int markupSafeTest, int markupEmissionTest, int markupControl) {
	  ...
	  public boolean deleteInspectionRecordSpec(long inspectionId) {
			...
			try {
				...
				_log.info("=========deleteInspectionRecordSpec===" + query.toString());
	  ...
	  public boolean deleteInspectionCommonstatus(long inspectionId) {
			...
			try {
				...
				_log.info("=========deleteInspectionCommonstatus===" + query.toString());
	  ...
	  public boolean deleteInspectionRecordAttached(long inspectionId) {
			...
			try {
				...
				query.append("Delete from  vr_inspectionrecord_attach where inspectionrecordid = "+inspectionId);

				_log.info("=========deleteInspectionRecordAttached===" + query.toString());
		...
		public int countMaSoBienBanKiemTra(long hosothutucid, String dangkySoBienBanKiemTra ) {
			...
			try {
				...
				query.append("SELECT count(*) as total FROM dkvn_nghiepvu.vr_inspectionrecord WHERE hosothutucid = ? and inspectionrecordno = ? ");
				_log.debug("=========count countMaSoBienBanKiemTra===" + query.toString() );
				...
				qPos.add(dangkySoBienBanKiemTra);
