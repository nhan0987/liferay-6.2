 ...
 * @generated
 */
public class AssessmentofInspectionMethodServiceClpInvoker {
	public AssessmentofInspectionMethodServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName470.equals(name) &&
			...
			return AssessmentofInspectionMethodServiceUtil.getBeanIdentifier();
		}

		if (_methodName471.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes471, parameterTypes)) {
			AssessmentofInspectionMethodServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
