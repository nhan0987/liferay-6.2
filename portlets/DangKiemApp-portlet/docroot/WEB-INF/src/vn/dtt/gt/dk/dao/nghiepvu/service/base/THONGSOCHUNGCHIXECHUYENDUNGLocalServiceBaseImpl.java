...
import vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIXECHUYENDUNGLocalService;
...
/**
 * Provides the base implementation for the t h o n g s o c h u n g c h i x e c h u y e n d u n g local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.THONGSOCHUNGCHIXECHUYENDUNGLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.THONGSOCHUNGCHIXECHUYENDUNGLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIXECHUYENDUNGLocalServiceUtil
 * @generated
 */
public abstract class THONGSOCHUNGCHIXECHUYENDUNGLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements THONGSOCHUNGCHIXECHUYENDUNGLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIXECHUYENDUNGLocalServiceUtil} to access the t h o n g s o c h u n g c h i x e c h u y e n d u n g local service.
	 */
	...
	@Override
	public THONGSOCHUNGCHIXECHUYENDUNG addTHONGSOCHUNGCHIXECHUYENDUNG(
		THONGSOCHUNGCHIXECHUYENDUNG thongsochungchixechuyendung)
		throws SystemException {
		thongsochungchixechuyendung.setNew(true);

		return thongsochungchixechuyendungPersistence.update(thongsochungchixechuyendung);
	}
	 ...
	 */
	@Override
	public THONGSOCHUNGCHIXECHUYENDUNG createTHONGSOCHUNGCHIXECHUYENDUNG(
		long id) {
		return thongsochungchixechuyendungPersistence.create(id);
	}
	...
	@Override
	public THONGSOCHUNGCHIXECHUYENDUNG deleteTHONGSOCHUNGCHIXECHUYENDUNG(
		long id) throws PortalException, SystemException {
		return thongsochungchixechuyendungPersistence.remove(id);
	}
	...
	public THONGSOCHUNGCHIXECHUYENDUNG deleteTHONGSOCHUNGCHIXECHUYENDUNG(
		THONGSOCHUNGCHIXECHUYENDUNG thongsochungchixechuyendung)
		throws SystemException {
		return thongsochungchixechuyendungPersistence.remove(thongsochungchixechuyendung);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(THONGSOCHUNGCHIXECHUYENDUNG.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return thongsochungchixechuyendungPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return thongsochungchixechuyendungPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public THONGSOCHUNGCHIXECHUYENDUNG fetchTHONGSOCHUNGCHIXECHUYENDUNG(long id)
		throws SystemException {
		return thongsochungchixechuyendungPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public THONGSOCHUNGCHIXECHUYENDUNG getTHONGSOCHUNGCHIXECHUYENDUNG(long id)
		throws PortalException, SystemException {
		return thongsochungchixechuyendungPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return thongsochungchixechuyendungPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<THONGSOCHUNGCHIXECHUYENDUNG> getTHONGSOCHUNGCHIXECHUYENDUNGs(
		int start, int end) throws SystemException {
		return thongsochungchixechuyendungPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTHONGSOCHUNGCHIXECHUYENDUNGsCount() throws SystemException {
		return thongsochungchixechuyendungPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public THONGSOCHUNGCHIXECHUYENDUNG updateTHONGSOCHUNGCHIXECHUYENDUNG(
		THONGSOCHUNGCHIXECHUYENDUNG thongsochungchixechuyendung)
		throws SystemException {
		return thongsochungchixechuyendungPersistence.update(thongsochungchixechuyendung);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.THONGSOCHUNGCHIXECHUYENDUNG",
			thongsochungchixechuyendungLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = thongsochungchixechuyendungPersistence.getDataSource();
	...
	private THONGSOCHUNGCHIXECHUYENDUNGLocalServiceClpInvoker _clpInvoker = new THONGSOCHUNGCHIXECHUYENDUNGLocalServiceClpInvoker();
}