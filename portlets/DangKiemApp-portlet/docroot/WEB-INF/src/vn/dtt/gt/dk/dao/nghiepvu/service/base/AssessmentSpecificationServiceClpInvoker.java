 ...
 * @generated
 */
public class AssessmentSpecificationServiceClpInvoker {
	public AssessmentSpecificationServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName470.equals(name) &&
			...
			return AssessmentSpecificationServiceUtil.getBeanIdentifier();
		}

		if (_methodName471.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes471, parameterTypes)) {
			AssessmentSpecificationServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
