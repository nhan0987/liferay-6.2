 ...
 * @generated
 */
public class AssessmentofImporterControlServiceClpInvoker {
	public AssessmentofImporterControlServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName470.equals(name) &&
			...
			return AssessmentofImporterControlServiceUtil.getBeanIdentifier();
		}

		if (_methodName471.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes471, parameterTypes)) {
			AssessmentofImporterControlServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
