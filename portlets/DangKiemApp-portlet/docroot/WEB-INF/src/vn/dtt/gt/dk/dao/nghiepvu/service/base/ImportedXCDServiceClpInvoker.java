 ...
 * @generated
 */
public class ImportedXCDServiceClpInvoker {
	public ImportedXCDServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName470.equals(name) &&
			...
			return ImportedXCDServiceUtil.getBeanIdentifier();
		}

		if (_methodName471.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes471, parameterTypes)) {
			ImportedXCDServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
