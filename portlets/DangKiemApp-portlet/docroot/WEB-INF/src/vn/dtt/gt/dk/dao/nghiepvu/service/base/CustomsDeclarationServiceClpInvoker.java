 ...
 * @generated
 */
public class CustomsDeclarationServiceClpInvoker {
	public CustomsDeclarationServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName470.equals(name) &&
			...
			return CustomsDeclarationServiceUtil.getBeanIdentifier();
		}

		if (_methodName471.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes471, parameterTypes)) {
			CustomsDeclarationServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
