...
import vn.dtt.gt.dk.dao.nghiepvu.service.VehicleCertificateLocalService;
...
/**
 * Provides the base implementation for the vehicle certificate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.VehicleCertificateLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class VehicleCertificateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VehicleCertificateLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.VehicleCertificateLocalServiceUtil} to access the vehicle certificate local service.
	 */
	...
	@Override
	public VehicleCertificate addVehicleCertificate(
		VehicleCertificate vehicleCertificate) throws SystemException {
		vehicleCertificate.setNew(true);

		return vehicleCertificatePersistence.update(vehicleCertificate);
	}
	 ...
	 */
	@Override
	public VehicleCertificate createVehicleCertificate(long id) {
		return vehicleCertificatePersistence.create(id);
	}
	...
	@Override
	public VehicleCertificate deleteVehicleCertificate(long id)
		throws PortalException, SystemException {
		return vehicleCertificatePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VehicleCertificate deleteVehicleCertificate(
		VehicleCertificate vehicleCertificate) throws SystemException {
		return vehicleCertificatePersistence.remove(vehicleCertificate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VehicleCertificate.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vehicleCertificatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vehicleCertificatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VehicleCertificate fetchVehicleCertificate(long id)
		throws SystemException {
		return vehicleCertificatePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VehicleCertificate getVehicleCertificate(long id)
		throws PortalException, SystemException {
		return vehicleCertificatePersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vehicleCertificatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VehicleCertificate> getVehicleCertificates(int start, int end)
		throws SystemException {
		return vehicleCertificatePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVehicleCertificatesCount() throws SystemException {
		return vehicleCertificatePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VehicleCertificate updateVehicleCertificate(
		VehicleCertificate vehicleCertificate) throws SystemException {
		return vehicleCertificatePersistence.update(vehicleCertificate);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.VehicleCertificate",
			vehicleCertificateLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vehicleCertificatePersistence.getDataSource();
	...
	private VehicleCertificateLocalServiceClpInvoker _clpInvoker = new VehicleCertificateLocalServiceClpInvoker();
}