	...
	public void setControlreportNo(String controlreportNo) {
		...
		if (_vehicleGroupRemoteModel != null) {
			try {
				...
				method.invoke(_vehicleGroupRemoteModel, controlreportNo);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setControlreportId(long controlreportId) {
		...
		if (_vehicleGroupRemoteModel != null) {
			try {
				...
				method.invoke(_vehicleGroupRemoteModel, controlreportId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setSynchDate(Date SynchDate) {
		...
		if (_vehicleGroupRemoteModel != null) {
			try {
				...
				method.invoke(_vehicleGroupRemoteModel, SynchDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
