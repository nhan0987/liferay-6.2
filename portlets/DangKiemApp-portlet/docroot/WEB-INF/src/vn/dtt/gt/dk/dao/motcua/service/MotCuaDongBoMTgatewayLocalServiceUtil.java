...
/**
 * Provides the local service utility for MotCuaDongBoMTgateway. This utility wraps
 * {@link vn.dtt.gt.dk.dao.motcua.service.impl.MotCuaDongBoMTgatewayLocalServiceImpl} and is the
 ...
 * @see vn.dtt.gt.dk.dao.motcua.service.impl.MotCuaDongBoMTgatewayLocalServiceImpl
 * @generated
 */
public class MotCuaDongBoMTgatewayLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.dtt.gt.dk.dao.motcua.service.impl.MotCuaDongBoMTgatewayLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.dtt.gt.dk.dao.motcua.model.MotCuaDongBoMTgateway addMotCuaDongBoMTgateway(
		vn.dtt.gt.dk.dao.motcua.model.MotCuaDongBoMTgateway motCuaDongBoMTgateway)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addMotCuaDongBoMTgateway(motCuaDongBoMTgateway);
	}
	...
	*/
	public static vn.dtt.gt.dk.dao.motcua.model.MotCuaDongBoMTgateway createMotCuaDongBoMTgateway(
		long id) {
		return getService().createMotCuaDongBoMTgateway(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.motcua.model.MotCuaDongBoMTgateway deleteMotCuaDongBoMTgateway(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteMotCuaDongBoMTgateway(id);
	}
	...
	*/
	public static vn.dtt.gt.dk.dao.motcua.model.MotCuaDongBoMTgateway deleteMotCuaDongBoMTgateway(
		vn.dtt.gt.dk.dao.motcua.model.MotCuaDongBoMTgateway motCuaDongBoMTgateway)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteMotCuaDongBoMTgateway(motCuaDongBoMTgateway);
	}
	...
	*/
	...
	public static vn.dtt.gt.dk.dao.motcua.model.MotCuaDongBoMTgateway fetchMotCuaDongBoMTgateway(
		long id) throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchMotCuaDongBoMTgateway(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.motcua.model.MotCuaDongBoMTgateway getMotCuaDongBoMTgateway(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getMotCuaDongBoMTgateway(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.gt.dk.dao.motcua.model.MotCuaDongBoMTgateway> getMotCuaDongBoMTgatewaies(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getMotCuaDongBoMTgatewaies(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getMotCuaDongBoMTgatewaiesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getMotCuaDongBoMTgatewaiesCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.motcua.model.MotCuaDongBoMTgateway updateMotCuaDongBoMTgateway(
		vn.dtt.gt.dk.dao.motcua.model.MotCuaDongBoMTgateway motCuaDongBoMTgateway)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateMotCuaDongBoMTgateway(motCuaDongBoMTgateway);
	}
	...
	*/
	...
	public static java.util.List<vn.dtt.gt.dk.dao.motcua.model.MotCuaDongBoMTgateway> findHoSoByPhieuXuLyChinh(
		...
		return getService()
				   .findHoSoByPhieuXuLyChinh(phieuXuLyChinhId, start, end);
	}

	public static int countByPhieuXuLyChinh(long phieuXuLyChinhId) {
		return getService().countByPhieuXuLyChinh(phieuXuLyChinhId);
	}
	...
	public static vn.dtt.gt.dk.dao.motcua.model.MotCuaDongBoMTgateway findLatestHosoDongboByHosothutucId(
		...
		return getService().findLatestHosoDongboByHosothutucId(phieuXuLyChinhId);
	}
	...
	public static MotCuaDongBoMTgatewayLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					MotCuaDongBoMTgatewayLocalService.class.getName());

			if (invokableLocalService instanceof MotCuaDongBoMTgatewayLocalService) {
				_service = (MotCuaDongBoMTgatewayLocalService)invokableLocalService;
			}
			else {
				_service = new MotCuaDongBoMTgatewayLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(MotCuaDongBoMTgatewayLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(MotCuaDongBoMTgatewayLocalService service) {
	}

	private static MotCuaDongBoMTgatewayLocalService _service;
}