...
import vn.dtt.gt.dk.dao.aswmsg.service.AswmsgMessageLogService;
...
/**
 * Provides the base implementation for the aswmsg message log remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.aswmsg.service.impl.AswmsgMessageLogServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class AswmsgMessageLogServiceBaseImpl extends BaseServiceImpl
	implements AswmsgMessageLogService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.aswmsg.service.AswmsgMessageLogServiceUtil} to access the aswmsg message log remote service.
	 */
	...
	private AswmsgMessageLogServiceClpInvoker _clpInvoker = new AswmsgMessageLogServiceClpInvoker();
}