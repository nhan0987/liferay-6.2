...
import vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentofProductLocalService;
...
/**
 * Provides the base implementation for the assessmentof product local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.AssessmentofProductLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class AssessmentofProductLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssessmentofProductLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentofProductLocalServiceUtil} to access the assessmentof product local service.
	 */
	...
	@Override
	public AssessmentofProduct addAssessmentofProduct(
		AssessmentofProduct assessmentofProduct) throws SystemException {
		assessmentofProduct.setNew(true);

		return assessmentofProductPersistence.update(assessmentofProduct);
	}
	 ...
	 */
	@Override
	public AssessmentofProduct createAssessmentofProduct(long id) {
		return assessmentofProductPersistence.create(id);
	}
	...
	@Override
	public AssessmentofProduct deleteAssessmentofProduct(long id)
		throws PortalException, SystemException {
		return assessmentofProductPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AssessmentofProduct deleteAssessmentofProduct(
		AssessmentofProduct assessmentofProduct) throws SystemException {
		return assessmentofProductPersistence.remove(assessmentofProduct);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AssessmentofProduct.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return assessmentofProductPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessmentofProductPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AssessmentofProduct fetchAssessmentofProduct(long id)
		throws SystemException {
		return assessmentofProductPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public AssessmentofProduct getAssessmentofProduct(long id)
		throws PortalException, SystemException {
		return assessmentofProductPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assessmentofProductPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AssessmentofProduct> getAssessmentofProducts(int start, int end)
		throws SystemException {
		return assessmentofProductPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAssessmentofProductsCount() throws SystemException {
		return assessmentofProductPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AssessmentofProduct updateAssessmentofProduct(
		AssessmentofProduct assessmentofProduct) throws SystemException {
		return assessmentofProductPersistence.update(assessmentofProduct);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.AssessmentofProduct",
			assessmentofProductLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assessmentofProductPersistence.getDataSource();
	...
	private AssessmentofProductLocalServiceClpInvoker _clpInvoker = new AssessmentofProductLocalServiceClpInvoker();
}