...
public class CorporationInspectorLocalServiceWrapper
	...
	*/
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector> findByCorporationId(
		...
		return _corporationInspectorLocalService.findByCorporationId(corporationId);
	}

	@Override
	public int countByCorporationId(java.lang.String corporationId) {
		return _corporationInspectorLocalService.countByCorporationId(corporationId);
	}
	...
	public vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector fetchByInspectorId(
		long inspectorid) {
		return _corporationInspectorLocalService.fetchByInspectorId(inspectorid);
	}

	@Override
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector> findByTeamId(
		long teamId) {
		return _corporationInspectorLocalService.findByTeamId(teamId);
	}

	@Override
	public java.util.List<java.lang.Long> findUserLiferayNotHaveCorporationInspector(
		java.lang.String schemaLifeay) {
		return _corporationInspectorLocalService.findUserLiferayNotHaveCorporationInspector(schemaLifeay);
	}

	@Override
	public vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector findByInspectorId(
		long inspectorid) {
		return _corporationInspectorLocalService.findByInspectorId(inspectorid);
	}

	@Override
	public boolean deleteDangKiemVien(long corporationInspectorId) {
		return _corporationInspectorLocalService.deleteDangKiemVien(corporationInspectorId);
	}

	@Override
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector> findDanhSachDangKiemVien(
		int start, int end) {
		return _corporationInspectorLocalService.findDanhSachDangKiemVien(start,
			end);
	}

	@Override
	public int countDanhSachDangKiemVien() {
		return _corporationInspectorLocalService.countDanhSachDangKiemVien();
	}

	@Override
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector> findDanhSachDangKiemVienByTeam(
		long userId) {
		return _corporationInspectorLocalService.findDanhSachDangKiemVienByTeam(userId);
	}
