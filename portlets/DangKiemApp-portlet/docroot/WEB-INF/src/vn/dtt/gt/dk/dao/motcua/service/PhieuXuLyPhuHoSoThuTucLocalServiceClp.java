 ...
 * @generated
 */
public class PhieuXuLyPhuHoSoThuTucLocalServiceClp
	implements PhieuXuLyPhuHoSoThuTucLocalService {
	public PhieuXuLyPhuHoSoThuTucLocalServiceClp(
	...
	public vn.dtt.gt.dk.dao.motcua.model.PhieuXuLyPhuHoSoThuTuc addPhieuXuLyPhuHoSoThuTuc(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(phieuXuLyPhuHoSoThuTuc)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.gt.dk.dao.motcua.model.PhieuXuLyPhuHoSoThuTuc)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.motcua.model.PhieuXuLyPhuHoSoThuTuc> getPhieuXuLyPhuHoSoThuTucs(
		...
		return (java.util.List<vn.dtt.gt.dk.dao.motcua.model.PhieuXuLyPhuHoSoThuTuc>)ClpSerializer.translateOutput(returnObj);
	}
