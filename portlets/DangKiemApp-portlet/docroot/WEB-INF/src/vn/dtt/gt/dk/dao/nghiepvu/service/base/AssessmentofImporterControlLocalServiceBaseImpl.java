...
import vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentofImporterControlLocalService;
...
/**
 * Provides the base implementation for the assessmentof importer control local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.AssessmentofImporterControlLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.AssessmentofImporterControlLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentofImporterControlLocalServiceUtil
 * @generated
 */
public abstract class AssessmentofImporterControlLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AssessmentofImporterControlLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentofImporterControlLocalServiceUtil} to access the assessmentof importer control local service.
	 */
	...
	@Override
	public AssessmentofImporterControl addAssessmentofImporterControl(
		AssessmentofImporterControl assessmentofImporterControl)
		throws SystemException {
		assessmentofImporterControl.setNew(true);

		return assessmentofImporterControlPersistence.update(assessmentofImporterControl);
	}
	 ...
	 */
	@Override
	public AssessmentofImporterControl createAssessmentofImporterControl(
		long id) {
		return assessmentofImporterControlPersistence.create(id);
	}
	...
	@Override
	public AssessmentofImporterControl deleteAssessmentofImporterControl(
		long id) throws PortalException, SystemException {
		return assessmentofImporterControlPersistence.remove(id);
	}
	...
	public AssessmentofImporterControl deleteAssessmentofImporterControl(
		AssessmentofImporterControl assessmentofImporterControl)
		throws SystemException {
		return assessmentofImporterControlPersistence.remove(assessmentofImporterControl);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AssessmentofImporterControl.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessmentofImporterControlPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessmentofImporterControlPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AssessmentofImporterControl fetchAssessmentofImporterControl(long id)
		throws SystemException {
		return assessmentofImporterControlPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public AssessmentofImporterControl getAssessmentofImporterControl(long id)
		throws PortalException, SystemException {
		return assessmentofImporterControlPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assessmentofImporterControlPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AssessmentofImporterControl> getAssessmentofImporterControls(
		int start, int end) throws SystemException {
		return assessmentofImporterControlPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAssessmentofImporterControlsCount() throws SystemException {
		return assessmentofImporterControlPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AssessmentofImporterControl updateAssessmentofImporterControl(
		AssessmentofImporterControl assessmentofImporterControl)
		throws SystemException {
		return assessmentofImporterControlPersistence.update(assessmentofImporterControl);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.AssessmentofImporterControl",
			assessmentofImporterControlLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assessmentofImporterControlPersistence.getDataSource();
	...
	private AssessmentofImporterControlLocalServiceClpInvoker _clpInvoker = new AssessmentofImporterControlLocalServiceClpInvoker();
}