...
import vn.dtt.gt.dk.dao.motcua.model.PhanCongDonViKiemTraModel;
import vn.dtt.gt.dk.dao.motcua.model.PhanCongDonViKiemTraSoap;
...
/**
 * The base model implementation for the PhanCongDonViKiemTra service. Represents a row in the &quot;view_phancongdonvikiemtra&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link vn.dtt.gt.dk.dao.motcua.model.PhanCongDonViKiemTraModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link PhanCongDonViKiemTraImpl}.
 * </p>
 *
 * @author win_64
 * @see PhanCongDonViKiemTraImpl
 * @see vn.dtt.gt.dk.dao.motcua.model.PhanCongDonViKiemTra
 * @see vn.dtt.gt.dk.dao.motcua.model.PhanCongDonViKiemTraModel
 * @generated
 */
@JSON(strict = true)
public class PhanCongDonViKiemTraModelImpl extends BaseModelImpl<PhanCongDonViKiemTra>
	implements PhanCongDonViKiemTraModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a phan cong don vi kiem tra model instance should use the {@link vn.dtt.gt.dk.dao.motcua.model.PhanCongDonViKiemTra} interface instead.
	 */
	public static final String TABLE_NAME = "view_phancongdonvikiemtra";
	...
	public static final String TABLE_SQL_CREATE = "create table view_phancongdonvikiemtra (id LONG not null primary key,phieuxulychinhid LONG,trichyeunoidung VARCHAR(75) null,ghichu VARCHAR(75) null,trangthaihientaiid LONG,noidunghosoid LONG,chiemquyenxuly LONG,ngaytaophieu DATE null,nguoitaophieu LONG,nhomphieuxuly VARCHAR(75) null,phannhomhosoid LONG,confirmedinspectionId LONG,masohoso VARCHAR(75) null,mabiennhan VARCHAR(75) null,thutuchanhchinhid LONG,tenchuhoso VARCHAR(75) null,ngayguihoso DATE null,tendonvitiepnhan VARCHAR(75) null,attachedfile LONG,inspectiondistrictcode VARCHAR(75) null,inspectionprovincecode VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table view_phancongdonvikiemtra";
	public static final String ORDER_BY_JPQL = " ORDER BY phanCongDonViKiemTra.id ASC";
	public static final String ORDER_BY_SQL = " ORDER BY view_phancongdonvikiemtra.id ASC";
	public static final String DATA_SOURCE = "tthcDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.vn.dtt.gt.dk.dao.motcua.model.PhanCongDonViKiemTra"),
			false);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.vn.dtt.gt.dk.dao.motcua.model.PhanCongDonViKiemTra"),
			false);
	 ...
	 */
	public static PhanCongDonViKiemTra toModel(
		PhanCongDonViKiemTraSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		PhanCongDonViKiemTra model = new PhanCongDonViKiemTraImpl();
	 ...
	 */
	public static List<PhanCongDonViKiemTra> toModels(
		PhanCongDonViKiemTraSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<PhanCongDonViKiemTra> models = new ArrayList<PhanCongDonViKiemTra>(soapModels.length);

		for (PhanCongDonViKiemTraSoap soapModel : soapModels) {
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.vn.dtt.gt.dk.dao.motcua.model.PhanCongDonViKiemTra"));

	public PhanCongDonViKiemTraModelImpl() {
	}
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(0,
			PhanCongDonViKiemTra.class.getName(), getPrimaryKey());
	}
	...
	public PhanCongDonViKiemTra toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (PhanCongDonViKiemTra)ProxyUtil.newProxyInstance(_classLoader,
	...
	public Object clone() {
		...
		phanCongDonViKiemTraImpl.setId(getId());
		phanCongDonViKiemTraImpl.setPhieuXuLyChinhId(getPhieuXuLyChinhId());
		phanCongDonViKiemTraImpl.setTrichYeuNoiDung(getTrichYeuNoiDung());
		phanCongDonViKiemTraImpl.setGhiChu(getGhiChu());
		phanCongDonViKiemTraImpl.setTrangThaiHienTaiId(getTrangThaiHienTaiId());
		phanCongDonViKiemTraImpl.setNoiDungHoSoId(getNoiDungHoSoId());
		phanCongDonViKiemTraImpl.setChiemQuyenXuLy(getChiemQuyenXuLy());
		phanCongDonViKiemTraImpl.setNgayTaoPhieu(getNgayTaoPhieu());
		phanCongDonViKiemTraImpl.setNguoiTaoPhieu(getNguoiTaoPhieu());
		phanCongDonViKiemTraImpl.setNhomPhieuXuLy(getNhomPhieuXuLy());
		phanCongDonViKiemTraImpl.setPhanNhomHoSoId(getPhanNhomHoSoId());
		phanCongDonViKiemTraImpl.setConfirmedinspectionId(getConfirmedinspectionId());
		phanCongDonViKiemTraImpl.setMaSoHoSo(getMaSoHoSo());
		phanCongDonViKiemTraImpl.setMaBienNhan(getMaBienNhan());
		phanCongDonViKiemTraImpl.setThuTucHanhChinhId(getThuTucHanhChinhId());
		phanCongDonViKiemTraImpl.setTenChuHoSo(getTenChuHoSo());
		phanCongDonViKiemTraImpl.setNgayGuiHoSo(getNgayGuiHoSo());
		phanCongDonViKiemTraImpl.setTenDonViTiepNhan(getTenDonViTiepNhan());
		phanCongDonViKiemTraImpl.setAttachedFile(getAttachedFile());
		phanCongDonViKiemTraImpl.setInspectionDistrictCode(getInspectionDistrictCode());
		phanCongDonViKiemTraImpl.setInspectionProvincecode(getInspectionProvincecode());
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PhanCongDonViKiemTra)) {
			return false;
		}

		PhanCongDonViKiemTra phanCongDonViKiemTra = (PhanCongDonViKiemTra)obj;
	...
	public CacheModel<PhanCongDonViKiemTra> toCacheModel() {
		PhanCongDonViKiemTraCacheModel phanCongDonViKiemTraCacheModel = new PhanCongDonViKiemTraCacheModel();

		phanCongDonViKiemTraCacheModel.id = getId();

		phanCongDonViKiemTraCacheModel.phieuXuLyChinhId = getPhieuXuLyChinhId();

		phanCongDonViKiemTraCacheModel.trichYeuNoiDung = getTrichYeuNoiDung();

		String trichYeuNoiDung = phanCongDonViKiemTraCacheModel.trichYeuNoiDung;

		if ((trichYeuNoiDung != null) && (trichYeuNoiDung.length() == 0)) {
			phanCongDonViKiemTraCacheModel.trichYeuNoiDung = null;
		}

		phanCongDonViKiemTraCacheModel.ghiChu = getGhiChu();

		String ghiChu = phanCongDonViKiemTraCacheModel.ghiChu;

		if ((ghiChu != null) && (ghiChu.length() == 0)) {
			phanCongDonViKiemTraCacheModel.ghiChu = null;
		}

		phanCongDonViKiemTraCacheModel.trangThaiHienTaiId = getTrangThaiHienTaiId();

		phanCongDonViKiemTraCacheModel.noiDungHoSoId = getNoiDungHoSoId();

		phanCongDonViKiemTraCacheModel.chiemQuyenXuLy = getChiemQuyenXuLy();

		Date ngayTaoPhieu = getNgayTaoPhieu();

		if (ngayTaoPhieu != null) {
			phanCongDonViKiemTraCacheModel.ngayTaoPhieu = ngayTaoPhieu.getTime();
		}
		else {
			phanCongDonViKiemTraCacheModel.ngayTaoPhieu = Long.MIN_VALUE;
		}

		phanCongDonViKiemTraCacheModel.nguoiTaoPhieu = getNguoiTaoPhieu();

		phanCongDonViKiemTraCacheModel.nhomPhieuXuLy = getNhomPhieuXuLy();

		String nhomPhieuXuLy = phanCongDonViKiemTraCacheModel.nhomPhieuXuLy;

		if ((nhomPhieuXuLy != null) && (nhomPhieuXuLy.length() == 0)) {
			phanCongDonViKiemTraCacheModel.nhomPhieuXuLy = null;
		}

		phanCongDonViKiemTraCacheModel.phanNhomHoSoId = getPhanNhomHoSoId();

		phanCongDonViKiemTraCacheModel.confirmedinspectionId = getConfirmedinspectionId();

		phanCongDonViKiemTraCacheModel.maSoHoSo = getMaSoHoSo();

		String maSoHoSo = phanCongDonViKiemTraCacheModel.maSoHoSo;

		if ((maSoHoSo != null) && (maSoHoSo.length() == 0)) {
			phanCongDonViKiemTraCacheModel.maSoHoSo = null;
		}

		phanCongDonViKiemTraCacheModel.maBienNhan = getMaBienNhan();

		String maBienNhan = phanCongDonViKiemTraCacheModel.maBienNhan;

		if ((maBienNhan != null) && (maBienNhan.length() == 0)) {
			phanCongDonViKiemTraCacheModel.maBienNhan = null;
		}

		phanCongDonViKiemTraCacheModel.thuTucHanhChinhId = getThuTucHanhChinhId();

		phanCongDonViKiemTraCacheModel.tenChuHoSo = getTenChuHoSo();

		String tenChuHoSo = phanCongDonViKiemTraCacheModel.tenChuHoSo;

		if ((tenChuHoSo != null) && (tenChuHoSo.length() == 0)) {
			phanCongDonViKiemTraCacheModel.tenChuHoSo = null;
		}

		Date ngayGuiHoSo = getNgayGuiHoSo();

		if (ngayGuiHoSo != null) {
			phanCongDonViKiemTraCacheModel.ngayGuiHoSo = ngayGuiHoSo.getTime();
		}
		else {
			phanCongDonViKiemTraCacheModel.ngayGuiHoSo = Long.MIN_VALUE;
		}

		phanCongDonViKiemTraCacheModel.tenDonViTiepNhan = getTenDonViTiepNhan();

		String tenDonViTiepNhan = phanCongDonViKiemTraCacheModel.tenDonViTiepNhan;

		if ((tenDonViTiepNhan != null) && (tenDonViTiepNhan.length() == 0)) {
			phanCongDonViKiemTraCacheModel.tenDonViTiepNhan = null;
		}

		phanCongDonViKiemTraCacheModel.attachedFile = getAttachedFile();

		phanCongDonViKiemTraCacheModel.inspectionDistrictCode = getInspectionDistrictCode();

		String inspectionDistrictCode = phanCongDonViKiemTraCacheModel.inspectionDistrictCode;

		if ((inspectionDistrictCode != null) &&
				(inspectionDistrictCode.length() == 0)) {
			phanCongDonViKiemTraCacheModel.inspectionDistrictCode = null;
		}

		phanCongDonViKiemTraCacheModel.inspectionProvincecode = getInspectionProvincecode();

		String inspectionProvincecode = phanCongDonViKiemTraCacheModel.inspectionProvincecode;

		if ((inspectionProvincecode != null) &&
				(inspectionProvincecode.length() == 0)) {
			phanCongDonViKiemTraCacheModel.inspectionProvincecode = null;
		}

		return phanCongDonViKiemTraCacheModel;
	}
	...
	private static ClassLoader _classLoader = PhanCongDonViKiemTra.class.getClassLoader();
	private static Class<?>[] _escapedModelInterfaces = new Class[] {
			PhanCongDonViKiemTra.class
		};
	private long _id;
	...
	private PhanCongDonViKiemTra _escapedModel;
}