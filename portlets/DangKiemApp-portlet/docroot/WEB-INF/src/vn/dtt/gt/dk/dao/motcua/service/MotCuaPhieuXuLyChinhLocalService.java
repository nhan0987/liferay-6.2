...
/**
 * Provides the local service interface for MotCuaPhieuXuLyChinh. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see MotCuaPhieuXuLyChinhLocalServiceUtil
...
public interface MotCuaPhieuXuLyChinhLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MotCuaPhieuXuLyChinhLocalServiceUtil} to access the mot cua phieu xu ly chinh local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.motcua.service.impl.MotCuaPhieuXuLyChinhLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
