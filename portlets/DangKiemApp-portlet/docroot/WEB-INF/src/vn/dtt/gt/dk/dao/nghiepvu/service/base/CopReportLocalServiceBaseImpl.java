...
import vn.dtt.gt.dk.dao.nghiepvu.service.CopReportLocalService;
...
/**
 * Provides the base implementation for the cop report local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.CopReportLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.CopReportLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.CopReportLocalServiceUtil
 * @generated
 */
public abstract class CopReportLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements CopReportLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.CopReportLocalServiceUtil} to access the cop report local service.
	 */
	...
	@Override
	public CopReport addCopReport(CopReport copReport)
		throws SystemException {
		copReport.setNew(true);

		return copReportPersistence.update(copReport);
	}
	 ...
	 */
	@Override
	public CopReport createCopReport(long id) {
		return copReportPersistence.create(id);
	}
	...
	@Override
	public CopReport deleteCopReport(long id)
		throws PortalException, SystemException {
		return copReportPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CopReport deleteCopReport(CopReport copReport)
		throws SystemException {
		return copReportPersistence.remove(copReport);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CopReport.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return copReportPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return copReportPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return copReportPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CopReport fetchCopReport(long id) throws SystemException {
		return copReportPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public CopReport getCopReport(long id)
		throws PortalException, SystemException {
		return copReportPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return copReportPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CopReport> getCopReports(int start, int end)
		throws SystemException {
		return copReportPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCopReportsCount() throws SystemException {
		return copReportPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CopReport updateCopReport(CopReport copReport)
		throws SystemException {
		return copReportPersistence.update(copReport);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.CopReport",
			copReportLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.gt.dk.dao.nghiepvu.model.CopReport");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = copReportPersistence.getDataSource();
	...
	private CopReportLocalServiceClpInvoker _clpInvoker = new CopReportLocalServiceClpInvoker();
}