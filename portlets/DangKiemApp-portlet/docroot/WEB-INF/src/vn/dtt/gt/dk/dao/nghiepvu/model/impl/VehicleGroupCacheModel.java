...
public class VehicleGroupCacheModel implements CacheModel<VehicleGroup>,
	...
	public VehicleGroup toEntityModel() {
		...
		if (controlreportNo == null) {
			vehicleGroupImpl.setControlreportNo(StringPool.BLANK);
		}
		else {
			vehicleGroupImpl.setControlreportNo(controlreportNo);
		}
		...
		vehicleGroupImpl.setControlreportId(controlreportId);
		...
		if (SynchDate == Long.MIN_VALUE) {
			vehicleGroupImpl.setSynchDate(null);
		}
		else {
			vehicleGroupImpl.setSynchDate(new Date(SynchDate));
		}
