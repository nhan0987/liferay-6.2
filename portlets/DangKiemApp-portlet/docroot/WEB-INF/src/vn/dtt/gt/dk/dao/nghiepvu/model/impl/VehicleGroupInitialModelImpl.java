...
public class VehicleGroupInitialModelImpl extends BaseModelImpl<VehicleGroupInitial>
	...
	public static VehicleGroupInitial toModel(VehicleGroupInitialSoap soapModel) {
		...
		model.setControlreportId(soapModel.getControlreportId());
	...
	public Object clone() {
		...
		vehicleGroupInitialImpl.setControlreportNo(getControlreportNo());
		...
		vehicleGroupInitialImpl.setControlreportId(getControlreportId());
	...
	public CacheModel<VehicleGroupInitial> toCacheModel() {
		...
		vehicleGroupInitialCacheModel.controlreportNo = getControlreportNo();

		String controlreportNo = vehicleGroupInitialCacheModel.controlreportNo;

		if ((controlreportNo != null) && (controlreportNo.length() == 0)) {
			vehicleGroupInitialCacheModel.controlreportNo = null;
		}
		...
		vehicleGroupInitialCacheModel.controlreportId = getControlreportId();
