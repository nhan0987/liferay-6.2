...
/**
 * Provides the local service interface for TimKiemHoSo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see TimKiemHoSoLocalServiceUtil
...
public interface TimKiemHoSoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TimKiemHoSoLocalServiceUtil} to access the tim kiem ho so local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.common.service.impl.TimKiemHoSoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
