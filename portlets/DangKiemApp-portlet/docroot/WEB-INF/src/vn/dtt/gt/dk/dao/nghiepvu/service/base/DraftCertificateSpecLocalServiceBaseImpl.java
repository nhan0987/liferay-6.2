...
import vn.dtt.gt.dk.dao.nghiepvu.service.DraftCertificateSpecLocalService;
...
/**
 * Provides the base implementation for the draft certificate spec local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.DraftCertificateSpecLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.DraftCertificateSpecLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.DraftCertificateSpecLocalServiceUtil
 * @generated
 */
public abstract class DraftCertificateSpecLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DraftCertificateSpecLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.DraftCertificateSpecLocalServiceUtil} to access the draft certificate spec local service.
	 */
	...
	@Override
	public DraftCertificateSpec addDraftCertificateSpec(
		DraftCertificateSpec draftCertificateSpec) throws SystemException {
		draftCertificateSpec.setNew(true);

		return draftCertificateSpecPersistence.update(draftCertificateSpec);
	}
	 ...
	 */
	@Override
	public DraftCertificateSpec createDraftCertificateSpec(long id) {
		return draftCertificateSpecPersistence.create(id);
	}
	...
	@Override
	public DraftCertificateSpec deleteDraftCertificateSpec(long id)
		throws PortalException, SystemException {
		return draftCertificateSpecPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DraftCertificateSpec deleteDraftCertificateSpec(
		DraftCertificateSpec draftCertificateSpec) throws SystemException {
		return draftCertificateSpecPersistence.remove(draftCertificateSpec);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DraftCertificateSpec.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return draftCertificateSpecPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return draftCertificateSpecPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DraftCertificateSpec fetchDraftCertificateSpec(long id)
		throws SystemException {
		return draftCertificateSpecPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DraftCertificateSpec getDraftCertificateSpec(long id)
		throws PortalException, SystemException {
		return draftCertificateSpecPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return draftCertificateSpecPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DraftCertificateSpec> getDraftCertificateSpecs(int start,
		int end) throws SystemException {
		return draftCertificateSpecPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDraftCertificateSpecsCount() throws SystemException {
		return draftCertificateSpecPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DraftCertificateSpec updateDraftCertificateSpec(
		DraftCertificateSpec draftCertificateSpec) throws SystemException {
		return draftCertificateSpecPersistence.update(draftCertificateSpec);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.DraftCertificateSpec",
			draftCertificateSpecLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.gt.dk.dao.nghiepvu.model.DraftCertificateSpec");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = draftCertificateSpecPersistence.getDataSource();
	...
	private DraftCertificateSpecLocalServiceClpInvoker _clpInvoker = new DraftCertificateSpecLocalServiceClpInvoker();
}