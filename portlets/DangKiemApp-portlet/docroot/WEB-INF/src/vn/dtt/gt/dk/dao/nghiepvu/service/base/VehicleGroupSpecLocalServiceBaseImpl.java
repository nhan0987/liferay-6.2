...
import vn.dtt.gt.dk.dao.nghiepvu.service.VehicleGroupSpecLocalService;
...
/**
 * Provides the base implementation for the vehicle group spec local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.VehicleGroupSpecLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.VehicleGroupSpecLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.VehicleGroupSpecLocalServiceUtil
 * @generated
 */
public abstract class VehicleGroupSpecLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VehicleGroupSpecLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.VehicleGroupSpecLocalServiceUtil} to access the vehicle group spec local service.
	 */
	...
	@Override
	public VehicleGroupSpec addVehicleGroupSpec(
		VehicleGroupSpec vehicleGroupSpec) throws SystemException {
		vehicleGroupSpec.setNew(true);

		return vehicleGroupSpecPersistence.update(vehicleGroupSpec);
	}
	 ...
	 */
	@Override
	public VehicleGroupSpec createVehicleGroupSpec(long id) {
		return vehicleGroupSpecPersistence.create(id);
	}
	...
	@Override
	public VehicleGroupSpec deleteVehicleGroupSpec(long id)
		throws PortalException, SystemException {
		return vehicleGroupSpecPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VehicleGroupSpec deleteVehicleGroupSpec(
		VehicleGroupSpec vehicleGroupSpec) throws SystemException {
		return vehicleGroupSpecPersistence.remove(vehicleGroupSpec);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VehicleGroupSpec.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vehicleGroupSpecPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vehicleGroupSpecPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VehicleGroupSpec fetchVehicleGroupSpec(long id)
		throws SystemException {
		return vehicleGroupSpecPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VehicleGroupSpec getVehicleGroupSpec(long id)
		throws PortalException, SystemException {
		return vehicleGroupSpecPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vehicleGroupSpecPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VehicleGroupSpec> getVehicleGroupSpecs(int start, int end)
		throws SystemException {
		return vehicleGroupSpecPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVehicleGroupSpecsCount() throws SystemException {
		return vehicleGroupSpecPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VehicleGroupSpec updateVehicleGroupSpec(
		VehicleGroupSpec vehicleGroupSpec) throws SystemException {
		return vehicleGroupSpecPersistence.update(vehicleGroupSpec);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroupSpec",
			vehicleGroupSpecLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroupSpec");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vehicleGroupSpecPersistence.getDataSource();
	...
	private VehicleGroupSpecLocalServiceClpInvoker _clpInvoker = new VehicleGroupSpecLocalServiceClpInvoker();
}