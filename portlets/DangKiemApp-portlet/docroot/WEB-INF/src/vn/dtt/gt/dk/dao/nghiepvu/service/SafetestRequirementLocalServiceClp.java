 ...
 * @generated
 */
public class SafetestRequirementLocalServiceClp
	implements SafetestRequirementLocalService {
	public SafetestRequirementLocalServiceClp(
	...
	public vn.dtt.gt.dk.dao.nghiepvu.model.SafetestRequirement addSafetestRequirement(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(safetestRequirement)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.gt.dk.dao.nghiepvu.model.SafetestRequirement)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.SafetestRequirement> getSafetestRequirements(
		...
		return (java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.SafetestRequirement>)ClpSerializer.translateOutput(returnObj);
	}
