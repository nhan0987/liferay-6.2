 ...
 * @generated
 */
public class ExchangeRateServiceClpInvoker {
	public ExchangeRateServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName470.equals(name) &&
			...
			return ExchangeRateServiceUtil.getBeanIdentifier();
		}

		if (_methodName471.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes471, parameterTypes)) {
			ExchangeRateServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
