...
public class CorporationInspectorLocalServiceClpInvoker {
	public CorporationInspectorLocalServiceClpInvoker() {
		...
		_methodName495 = "fetchByInspectorId";

		_methodParameterTypes495 = new String[] { "long" };

		_methodName496 = "findByTeamId";

		_methodParameterTypes496 = new String[] { "long" };

		_methodName497 = "findUserLiferayNotHaveCorporationInspector";

		_methodParameterTypes497 = new String[] { "java.lang.String" };

		_methodName498 = "findByInspectorId";

		_methodParameterTypes498 = new String[] { "long" };

		_methodName499 = "deleteDangKiemVien";

		_methodParameterTypes499 = new String[] { "long" };

		_methodName500 = "findDanhSachDangKiemVien";

		_methodParameterTypes500 = new String[] { "int", "int" };

		_methodName501 = "countDanhSachDangKiemVien";

		_methodParameterTypes501 = new String[] {  };

		_methodName502 = "findDanhSachDangKiemVienByTeam";
