...
import vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentofInspectorLocalService;
...
/**
 * Provides the base implementation for the assessmentof inspector local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.AssessmentofInspectorLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class AssessmentofInspectorLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssessmentofInspectorLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentofInspectorLocalServiceUtil} to access the assessmentof inspector local service.
	 */
	...
	@Override
	public AssessmentofInspector addAssessmentofInspector(
		AssessmentofInspector assessmentofInspector) throws SystemException {
		assessmentofInspector.setNew(true);

		return assessmentofInspectorPersistence.update(assessmentofInspector);
	}
	 ...
	 */
	@Override
	public AssessmentofInspector createAssessmentofInspector(long id) {
		return assessmentofInspectorPersistence.create(id);
	}
	...
	@Override
	public AssessmentofInspector deleteAssessmentofInspector(long id)
		throws PortalException, SystemException {
		return assessmentofInspectorPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AssessmentofInspector deleteAssessmentofInspector(
		AssessmentofInspector assessmentofInspector) throws SystemException {
		return assessmentofInspectorPersistence.remove(assessmentofInspector);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AssessmentofInspector.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return assessmentofInspectorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessmentofInspectorPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AssessmentofInspector fetchAssessmentofInspector(long id)
		throws SystemException {
		return assessmentofInspectorPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public AssessmentofInspector getAssessmentofInspector(long id)
		throws PortalException, SystemException {
		return assessmentofInspectorPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assessmentofInspectorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AssessmentofInspector> getAssessmentofInspectors(int start,
		int end) throws SystemException {
		return assessmentofInspectorPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAssessmentofInspectorsCount() throws SystemException {
		return assessmentofInspectorPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AssessmentofInspector updateAssessmentofInspector(
		AssessmentofInspector assessmentofInspector) throws SystemException {
		return assessmentofInspectorPersistence.update(assessmentofInspector);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.AssessmentofInspector",
			assessmentofInspectorLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assessmentofInspectorPersistence.getDataSource();
	...
	private AssessmentofInspectorLocalServiceClpInvoker _clpInvoker = new AssessmentofInspectorLocalServiceClpInvoker();
}