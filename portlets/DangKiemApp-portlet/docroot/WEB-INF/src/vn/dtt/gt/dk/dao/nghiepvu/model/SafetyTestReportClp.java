	...
	public void setInspectionrecordId(long inspectionrecordId) {
		...
		if (_safetyTestReportRemoteModel != null) {
			try {
				...
				method.invoke(_safetyTestReportRemoteModel, inspectionrecordId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setHosothutucId(long hosothutucId) {
		...
		if (_safetyTestReportRemoteModel != null) {
			try {
				...
				method.invoke(_safetyTestReportRemoteModel, hosothutucId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCorporationId(long corporationId) {
		...
		if (_safetyTestReportRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setCorporationId", long.class);

				method.invoke(_safetyTestReportRemoteModel, corporationId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setRequirementNumber(String requirementNumber) {
		...
		if (_safetyTestReportRemoteModel != null) {
			try {
				...
				method.invoke(_safetyTestReportRemoteModel, requirementNumber);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPhieuxulyphuId(long phieuxulyphuId) {
		...
		if (_safetyTestReportRemoteModel != null) {
			try {
				...
				method.invoke(_safetyTestReportRemoteModel, phieuxulyphuId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
