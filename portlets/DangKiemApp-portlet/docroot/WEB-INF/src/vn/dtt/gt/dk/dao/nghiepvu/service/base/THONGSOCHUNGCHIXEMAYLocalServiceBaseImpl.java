...
import vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIXEMAYLocalService;
...
/**
 * Provides the base implementation for the t h o n g s o c h u n g c h i x e m a y local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.THONGSOCHUNGCHIXEMAYLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.THONGSOCHUNGCHIXEMAYLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIXEMAYLocalServiceUtil
 * @generated
 */
public abstract class THONGSOCHUNGCHIXEMAYLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements THONGSOCHUNGCHIXEMAYLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIXEMAYLocalServiceUtil} to access the t h o n g s o c h u n g c h i x e m a y local service.
	 */
	...
	@Override
	public THONGSOCHUNGCHIXEMAY addTHONGSOCHUNGCHIXEMAY(
		THONGSOCHUNGCHIXEMAY thongsochungchixemay) throws SystemException {
		thongsochungchixemay.setNew(true);

		return thongsochungchixemayPersistence.update(thongsochungchixemay);
	}
	 ...
	 */
	@Override
	public THONGSOCHUNGCHIXEMAY createTHONGSOCHUNGCHIXEMAY(long id) {
		return thongsochungchixemayPersistence.create(id);
	}
	...
	@Override
	public THONGSOCHUNGCHIXEMAY deleteTHONGSOCHUNGCHIXEMAY(long id)
		throws PortalException, SystemException {
		return thongsochungchixemayPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public THONGSOCHUNGCHIXEMAY deleteTHONGSOCHUNGCHIXEMAY(
		THONGSOCHUNGCHIXEMAY thongsochungchixemay) throws SystemException {
		return thongsochungchixemayPersistence.remove(thongsochungchixemay);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(THONGSOCHUNGCHIXEMAY.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return thongsochungchixemayPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return thongsochungchixemayPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public THONGSOCHUNGCHIXEMAY fetchTHONGSOCHUNGCHIXEMAY(long id)
		throws SystemException {
		return thongsochungchixemayPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public THONGSOCHUNGCHIXEMAY getTHONGSOCHUNGCHIXEMAY(long id)
		throws PortalException, SystemException {
		return thongsochungchixemayPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return thongsochungchixemayPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<THONGSOCHUNGCHIXEMAY> getTHONGSOCHUNGCHIXEMAYs(int start,
		int end) throws SystemException {
		return thongsochungchixemayPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTHONGSOCHUNGCHIXEMAYsCount() throws SystemException {
		return thongsochungchixemayPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public THONGSOCHUNGCHIXEMAY updateTHONGSOCHUNGCHIXEMAY(
		THONGSOCHUNGCHIXEMAY thongsochungchixemay) throws SystemException {
		return thongsochungchixemayPersistence.update(thongsochungchixemay);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.THONGSOCHUNGCHIXEMAY",
			thongsochungchixemayLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = thongsochungchixemayPersistence.getDataSource();
	...
	private THONGSOCHUNGCHIXEMAYLocalServiceClpInvoker _clpInvoker = new THONGSOCHUNGCHIXEMAYLocalServiceClpInvoker();
}