...
import vn.dtt.gt.dk.dao.aswmsg.service.AswmsgSyndatahistoryLocalService;
...
/**
 * Provides the base implementation for the aswmsg syndatahistory local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.aswmsg.service.impl.AswmsgSyndatahistoryLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class AswmsgSyndatahistoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AswmsgSyndatahistoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.aswmsg.service.AswmsgSyndatahistoryLocalServiceUtil} to access the aswmsg syndatahistory local service.
	 */
	...
	@Override
	public AswmsgSyndatahistory addAswmsgSyndatahistory(
		AswmsgSyndatahistory aswmsgSyndatahistory) throws SystemException {
		aswmsgSyndatahistory.setNew(true);

		return aswmsgSyndatahistoryPersistence.update(aswmsgSyndatahistory);
	}
	 ...
	 */
	@Override
	public AswmsgSyndatahistory createAswmsgSyndatahistory(long id) {
		return aswmsgSyndatahistoryPersistence.create(id);
	}
	...
	@Override
	public AswmsgSyndatahistory deleteAswmsgSyndatahistory(long id)
		throws PortalException, SystemException {
		return aswmsgSyndatahistoryPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AswmsgSyndatahistory deleteAswmsgSyndatahistory(
		AswmsgSyndatahistory aswmsgSyndatahistory) throws SystemException {
		return aswmsgSyndatahistoryPersistence.remove(aswmsgSyndatahistory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AswmsgSyndatahistory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return aswmsgSyndatahistoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return aswmsgSyndatahistoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AswmsgSyndatahistory fetchAswmsgSyndatahistory(long id)
		throws SystemException {
		return aswmsgSyndatahistoryPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public AswmsgSyndatahistory getAswmsgSyndatahistory(long id)
		throws PortalException, SystemException {
		return aswmsgSyndatahistoryPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return aswmsgSyndatahistoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AswmsgSyndatahistory> getAswmsgSyndatahistories(int start,
		int end) throws SystemException {
		return aswmsgSyndatahistoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAswmsgSyndatahistoriesCount() throws SystemException {
		return aswmsgSyndatahistoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AswmsgSyndatahistory updateAswmsgSyndatahistory(
		AswmsgSyndatahistory aswmsgSyndatahistory) throws SystemException {
		return aswmsgSyndatahistoryPersistence.update(aswmsgSyndatahistory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.aswmsg.model.AswmsgSyndatahistory",
			aswmsgSyndatahistoryLocalService);
	}
	...
	private AswmsgSyndatahistoryLocalServiceClpInvoker _clpInvoker = new AswmsgSyndatahistoryLocalServiceClpInvoker();
}