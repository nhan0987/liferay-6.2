 ...
 * @generated
 */
public class THONGSOCHUNGCHIXECOGIOIPHAN2ServiceClpInvoker {
	public THONGSOCHUNGCHIXECOGIOIPHAN2ServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName470.equals(name) &&
			...
			return THONGSOCHUNGCHIXECOGIOIPHAN2ServiceUtil.getBeanIdentifier();
		}

		if (_methodName471.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes471, parameterTypes)) {
			THONGSOCHUNGCHIXECOGIOIPHAN2ServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
