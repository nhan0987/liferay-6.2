...
import vn.dtt.gt.dk.dao.nghiepvu.service.VehicleRecordLocalService;
...
/**
 * Provides the base implementation for the vehicle record local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.VehicleRecordLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class VehicleRecordLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VehicleRecordLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.VehicleRecordLocalServiceUtil} to access the vehicle record local service.
	 */
	...
	@Override
	public VehicleRecord addVehicleRecord(VehicleRecord vehicleRecord)
		throws SystemException {
		vehicleRecord.setNew(true);

		return vehicleRecordPersistence.update(vehicleRecord);
	}
	 ...
	 */
	@Override
	public VehicleRecord createVehicleRecord(long id) {
		return vehicleRecordPersistence.create(id);
	}
	...
	@Override
	public VehicleRecord deleteVehicleRecord(long id)
		throws PortalException, SystemException {
		return vehicleRecordPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VehicleRecord deleteVehicleRecord(VehicleRecord vehicleRecord)
		throws SystemException {
		return vehicleRecordPersistence.remove(vehicleRecord);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VehicleRecord.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return vehicleRecordPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vehicleRecordPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VehicleRecord fetchVehicleRecord(long id) throws SystemException {
		return vehicleRecordPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VehicleRecord getVehicleRecord(long id)
		throws PortalException, SystemException {
		return vehicleRecordPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vehicleRecordPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VehicleRecord> getVehicleRecords(int start, int end)
		throws SystemException {
		return vehicleRecordPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVehicleRecordsCount() throws SystemException {
		return vehicleRecordPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VehicleRecord updateVehicleRecord(VehicleRecord vehicleRecord)
		throws SystemException {
		return vehicleRecordPersistence.update(vehicleRecord);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.VehicleRecord",
			vehicleRecordLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vehicleRecordPersistence.getDataSource();
	...
	private VehicleRecordLocalServiceClpInvoker _clpInvoker = new VehicleRecordLocalServiceClpInvoker();
}