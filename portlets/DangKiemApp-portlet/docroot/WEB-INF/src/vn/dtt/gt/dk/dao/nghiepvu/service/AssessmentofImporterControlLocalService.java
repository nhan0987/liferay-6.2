...
/**
 * Provides the local service interface for AssessmentofImporterControl. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see AssessmentofImporterControlLocalServiceUtil
...
public interface AssessmentofImporterControlLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AssessmentofImporterControlLocalServiceUtil} to access the assessmentof importer control local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.AssessmentofImporterControlLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
