...
import vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentSpecificationConfigLocalService;
...
/**
 * Provides the base implementation for the assessment specification config local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.AssessmentSpecificationConfigLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.AssessmentSpecificationConfigLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentSpecificationConfigLocalServiceUtil
 * @generated
 */
public abstract class AssessmentSpecificationConfigLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AssessmentSpecificationConfigLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.AssessmentSpecificationConfigLocalServiceUtil} to access the assessment specification config local service.
	 */
	...
	@Override
	public AssessmentSpecificationConfig addAssessmentSpecificationConfig(
		AssessmentSpecificationConfig assessmentSpecificationConfig)
		throws SystemException {
		assessmentSpecificationConfig.setNew(true);

		return assessmentSpecificationConfigPersistence.update(assessmentSpecificationConfig);
	}
	 ...
	 */
	@Override
	public AssessmentSpecificationConfig createAssessmentSpecificationConfig(
		long id) {
		return assessmentSpecificationConfigPersistence.create(id);
	}
	...
	@Override
	public AssessmentSpecificationConfig deleteAssessmentSpecificationConfig(
		long id) throws PortalException, SystemException {
		return assessmentSpecificationConfigPersistence.remove(id);
	}
	...
	public AssessmentSpecificationConfig deleteAssessmentSpecificationConfig(
		AssessmentSpecificationConfig assessmentSpecificationConfig)
		throws SystemException {
		return assessmentSpecificationConfigPersistence.remove(assessmentSpecificationConfig);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AssessmentSpecificationConfig.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessmentSpecificationConfigPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assessmentSpecificationConfigPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AssessmentSpecificationConfig fetchAssessmentSpecificationConfig(
		long id) throws SystemException {
		return assessmentSpecificationConfigPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public AssessmentSpecificationConfig getAssessmentSpecificationConfig(
		long id) throws PortalException, SystemException {
		return assessmentSpecificationConfigPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assessmentSpecificationConfigPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AssessmentSpecificationConfig> getAssessmentSpecificationConfigs(
		int start, int end) throws SystemException {
		return assessmentSpecificationConfigPersistence.findAll(start, end);
	}
	...
	public int getAssessmentSpecificationConfigsCount()
		throws SystemException {
		return assessmentSpecificationConfigPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AssessmentSpecificationConfig updateAssessmentSpecificationConfig(
		AssessmentSpecificationConfig assessmentSpecificationConfig)
		throws SystemException {
		return assessmentSpecificationConfigPersistence.update(assessmentSpecificationConfig);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.AssessmentSpecificationConfig",
			assessmentSpecificationConfigLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assessmentSpecificationConfigPersistence.getDataSource();
	...
	private AssessmentSpecificationConfigLocalServiceClpInvoker _clpInvoker = new AssessmentSpecificationConfigLocalServiceClpInvoker();
}