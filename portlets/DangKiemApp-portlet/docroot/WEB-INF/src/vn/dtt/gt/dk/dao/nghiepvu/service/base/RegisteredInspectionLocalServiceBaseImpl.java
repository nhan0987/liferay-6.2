...
import vn.dtt.gt.dk.dao.nghiepvu.service.RegisteredInspectionLocalService;
...
/**
 * Provides the base implementation for the registered inspection local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.RegisteredInspectionLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class RegisteredInspectionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RegisteredInspectionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.RegisteredInspectionLocalServiceUtil} to access the registered inspection local service.
	 */
	...
	@Override
	public RegisteredInspection addRegisteredInspection(
		RegisteredInspection registeredInspection) throws SystemException {
		registeredInspection.setNew(true);

		return registeredInspectionPersistence.update(registeredInspection);
	}
	 ...
	 */
	@Override
	public RegisteredInspection createRegisteredInspection(long id) {
		return registeredInspectionPersistence.create(id);
	}
	...
	@Override
	public RegisteredInspection deleteRegisteredInspection(long id)
		throws PortalException, SystemException {
		return registeredInspectionPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public RegisteredInspection deleteRegisteredInspection(
		RegisteredInspection registeredInspection) throws SystemException {
		return registeredInspectionPersistence.remove(registeredInspection);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RegisteredInspection.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return registeredInspectionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return registeredInspectionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public RegisteredInspection fetchRegisteredInspection(long id)
		throws SystemException {
		return registeredInspectionPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public RegisteredInspection getRegisteredInspection(long id)
		throws PortalException, SystemException {
		return registeredInspectionPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return registeredInspectionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RegisteredInspection> getRegisteredInspections(int start,
		int end) throws SystemException {
		return registeredInspectionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getRegisteredInspectionsCount() throws SystemException {
		return registeredInspectionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RegisteredInspection updateRegisteredInspection(
		RegisteredInspection registeredInspection) throws SystemException {
		return registeredInspectionPersistence.update(registeredInspection);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.RegisteredInspection",
			registeredInspectionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = registeredInspectionPersistence.getDataSource();
	...
	private RegisteredInspectionLocalServiceClpInvoker _clpInvoker = new RegisteredInspectionLocalServiceClpInvoker();
}