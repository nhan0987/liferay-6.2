...
public class MotCuaTrangThaiHoSoLocalServiceWrapper
	...
	*/
	...
	public java.util.List<vn.dtt.gt.dk.dao.motcua.model.MotCuaTrangThaiHoSo> findByQuyTrinhThuTucId(
		...
		return _motCuaTrangThaiHoSoLocalService.findByQuyTrinhThuTucId(quyTrinhThuTucId);
	}

	@Override
	public java.util.List<vn.dtt.gt.dk.dao.motcua.model.MotCuaTrangThaiHoSo> getAllTrangThaiHoSoByKieuTrangThai(
		int kieuTrangThai) {
		return _motCuaTrangThaiHoSoLocalService.getAllTrangThaiHoSoByKieuTrangThai(kieuTrangThai);
	}
