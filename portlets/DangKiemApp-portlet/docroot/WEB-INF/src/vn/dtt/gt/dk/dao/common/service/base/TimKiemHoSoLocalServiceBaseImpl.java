...
import vn.dtt.gt.dk.dao.common.service.TimKiemHoSoLocalService;
...
/**
 * Provides the base implementation for the tim kiem ho so local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.common.service.impl.TimKiemHoSoLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TimKiemHoSoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TimKiemHoSoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.common.service.TimKiemHoSoLocalServiceUtil} to access the tim kiem ho so local service.
	 */
	...
	@Override
	public TimKiemHoSo addTimKiemHoSo(TimKiemHoSo timKiemHoSo)
		throws SystemException {
		timKiemHoSo.setNew(true);

		return timKiemHoSoPersistence.update(timKiemHoSo);
	}
	 ...
	 */
	@Override
	public TimKiemHoSo createTimKiemHoSo(long id) {
		return timKiemHoSoPersistence.create(id);
	}
	...
	@Override
	public TimKiemHoSo deleteTimKiemHoSo(long id)
		throws PortalException, SystemException {
		return timKiemHoSoPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TimKiemHoSo deleteTimKiemHoSo(TimKiemHoSo timKiemHoSo)
		throws SystemException {
		return timKiemHoSoPersistence.remove(timKiemHoSo);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TimKiemHoSo.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return timKiemHoSoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return timKiemHoSoPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return timKiemHoSoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TimKiemHoSo fetchTimKiemHoSo(long id) throws SystemException {
		return timKiemHoSoPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TimKiemHoSo getTimKiemHoSo(long id)
		throws PortalException, SystemException {
		return timKiemHoSoPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return timKiemHoSoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TimKiemHoSo> getTimKiemHoSos(int start, int end)
		throws SystemException {
		return timKiemHoSoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTimKiemHoSosCount() throws SystemException {
		return timKiemHoSoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TimKiemHoSo updateTimKiemHoSo(TimKiemHoSo timKiemHoSo)
		throws SystemException {
		return timKiemHoSoPersistence.update(timKiemHoSo);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.common.model.TimKiemHoSo",
			timKiemHoSoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = timKiemHoSoPersistence.getDataSource();
	...
	private TimKiemHoSoLocalServiceClpInvoker _clpInvoker = new TimKiemHoSoLocalServiceClpInvoker();
}