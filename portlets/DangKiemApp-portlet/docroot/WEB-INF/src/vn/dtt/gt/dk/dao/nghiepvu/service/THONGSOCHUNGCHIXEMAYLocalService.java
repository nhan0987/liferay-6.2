...
/**
 * Provides the local service interface for THONGSOCHUNGCHIXEMAY. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see THONGSOCHUNGCHIXEMAYLocalServiceUtil
...
public interface THONGSOCHUNGCHIXEMAYLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link THONGSOCHUNGCHIXEMAYLocalServiceUtil} to access the t h o n g s o c h u n g c h i x e m a y local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.THONGSOCHUNGCHIXEMAYLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
