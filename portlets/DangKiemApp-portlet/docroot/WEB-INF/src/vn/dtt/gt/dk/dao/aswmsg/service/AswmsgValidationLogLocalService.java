...
/**
 * Provides the local service interface for AswmsgValidationLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see AswmsgValidationLogLocalServiceUtil
...
public interface AswmsgValidationLogLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AswmsgValidationLogLocalServiceUtil} to access the aswmsg validation log local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.aswmsg.service.impl.AswmsgValidationLogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
