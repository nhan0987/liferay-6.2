...
/**
 * Provides the local service utility for IssueTracking. This utility wraps
 * {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.IssueTrackingLocalServiceImpl} and is the
 ...
 * @generated
 */
public class IssueTrackingLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.IssueTrackingLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.IssueTracking addIssueTracking(
		vn.dtt.gt.dk.dao.nghiepvu.model.IssueTracking issueTracking)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addIssueTracking(issueTracking);
	}
	...
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.IssueTracking createIssueTracking(
		long id) {
		return getService().createIssueTracking(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.IssueTracking deleteIssueTracking(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteIssueTracking(id);
	}
	...
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.IssueTracking deleteIssueTracking(
		vn.dtt.gt.dk.dao.nghiepvu.model.IssueTracking issueTracking)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteIssueTracking(issueTracking);
	}
	...
	*/
	...
	public static vn.dtt.gt.dk.dao.nghiepvu.model.IssueTracking fetchIssueTracking(
		long id) throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchIssueTracking(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.IssueTracking getIssueTracking(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getIssueTracking(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.IssueTracking> getIssueTrackings(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getIssueTrackings(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getIssueTrackingsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getIssueTrackingsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.IssueTracking updateIssueTracking(
		vn.dtt.gt.dk.dao.nghiepvu.model.IssueTracking issueTracking)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateIssueTracking(issueTracking);
	}
	...
	*/
	...
	public static java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.IssueTracking> findByImporterName(
		...
		return getService().findByImporterName(importername);
	}
	...
	public static java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.IssueTracking> findByImporterCode(
		...
		return getService().findByImporterCode(importercode);
	}
	...
	public static IssueTrackingLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					IssueTrackingLocalService.class.getName());

			if (invokableLocalService instanceof IssueTrackingLocalService) {
				_service = (IssueTrackingLocalService)invokableLocalService;
			}
			else {
				_service = new IssueTrackingLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(IssueTrackingLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(IssueTrackingLocalService service) {
	}

	private static IssueTrackingLocalService _service;
}