...
public class THONGSOCHUNGCHIXECHUYENDUNGFinderImpl extends BasePersistenceImpl<THONGSOCHUNGCHIXECHUYENDUNG> implements THONGSOCHUNGCHIXECHUYENDUNGFinder {
	
	private Log _log = LogFactoryUtil.getLog(THONGSOCHUNGCHIXECHUYENDUNGFinderImpl.class);
	public static final String FIND_THONGSOCHUNGCHIXECHUYENDUNG = THONGSOCHUNGCHIXECHUYENDUNGFinder.class.getName() + ".findByCertificateRecordAndHosothutucId";
	...
	public List<THONGSOCHUNGCHIXECHUYENDUNG> findByCertificateRecordAndHosothutucId(long hosothutucid) {
		...
		try {
			...
			String sql = CustomSQLUtil.get(FIND_THONGSOCHUNGCHIXECHUYENDUNG);
			...
			q.addEntity("THONGSOCHUNGCHIXECHUYENDUNG", THONGSOCHUNGCHIXECHUYENDUNGImpl.class);
			...
			return (List<THONGSOCHUNGCHIXECHUYENDUNG>) QueryUtil.list(q, getDialect(), QueryUtil.ALL_POS, QueryUtil.ALL_POS);
		...
		return new ArrayList<THONGSOCHUNGCHIXECHUYENDUNG>();
	}	
	...
	public boolean deleteXCDVehicleCertificateSpecWithHosothutucId(long hosothutucId) {
		Session session = null;
		...
		try {
			...
			query.append("Delete from dkvn_nghiepvu.thongsochungchi_xechuyendung where hosothutucid =  " + hosothutucId);
								
//			log.info("=========deleteXCDVehicleCertificateSpecWithHosothutucId===" + query.toString());
	...
	public boolean deleteXCDVehicleCertificateSpecWithXCD0009(String XCD0009) {
		Session session = null;
		...
		try {
			...
			query.append("Delete from dkvn_nghiepvu.thongsochungchi_xechuyendung where XCD0009 =  '" + XCD0009 + "'");
