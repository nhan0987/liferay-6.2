 ...
 * @generated
 */
public class EmissionTestReportServiceClpInvoker {
	public EmissionTestReportServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName470.equals(name) &&
			...
			return EmissionTestReportServiceUtil.getBeanIdentifier();
		}

		if (_methodName471.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes471, parameterTypes)) {
			EmissionTestReportServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
