...
import vn.dtt.gt.dk.dao.aswmsg.service.MonitorMessageQueueLocalService;
...
/**
 * Provides the base implementation for the monitor message queue local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.aswmsg.service.impl.MonitorMessageQueueLocalServiceImpl}.
 * </p>
 *
 * @author win_64
...
public abstract class MonitorMessageQueueLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MonitorMessageQueueLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.aswmsg.service.MonitorMessageQueueLocalServiceUtil} to access the monitor message queue local service.
	 */
	...
	public MonitorMessageQueue addMonitorMessageQueue(
		...
		return monitorMessageQueuePersistence.update(monitorMessageQueue);
	}
	...
	@Override
	public MonitorMessageQueue deleteMonitorMessageQueue(long id)
		throws PortalException, SystemException {
		return monitorMessageQueuePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MonitorMessageQueue deleteMonitorMessageQueue(
		MonitorMessageQueue monitorMessageQueue) throws SystemException {
		return monitorMessageQueuePersistence.remove(monitorMessageQueue);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MonitorMessageQueue.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.aswmsg.model.MonitorMessageQueue",
	...
	private MonitorMessageQueueLocalServiceClpInvoker _clpInvoker = new MonitorMessageQueueLocalServiceClpInvoker();
}