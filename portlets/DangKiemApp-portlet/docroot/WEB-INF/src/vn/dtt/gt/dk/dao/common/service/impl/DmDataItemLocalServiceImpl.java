...
public class DmDataItemLocalServiceImpl extends DmDataItemLocalServiceBaseImpl {
	...
	public List<DmDataItem> findByGroupName_AlterName(String groupName, String alterName) {
		return dmDataItemFinder.findByGroupName_AlterName(groupName, alterName);
	}
	...
	public List<DmDataItem> findDmDataItemByDataGroupIdAndLevelAndCode1(long groupId, int level, String code_1) {
		try {
			return dmDataItemFinder.findDmDataItemByDataGroupIdAndLevelAndCode1(groupId, level, code_1);
		} catch (Exception e) {
			_log.error(e);
		}
	...
	public List<DmDataItem> findDmDataItemByDataGroupIdAndLevelAndCode1OrderByDescription(long groupId, int level, String code_1) {
		try {
			return dmDataItemFinder.findDmDataItemByDataGroupIdAndLevelAndCode1OrderByDescription(groupId, level, code_1);
		} catch (Exception e) {
			_log.error(e);
		}
	...
	public List<DmDataItem> findByGC_C0_C1_C2_C3_L_AN(long dataGroupId, String code_0, 
		...
		try {
			return dmDataItemFinder.findByGC_C0_C1_C2_C3_L_AN(dataGroupId, code_0, 
					code_1, code_2, code_3, level, alterName);
		} catch (Exception e) {
			_log.error(e);
		}
