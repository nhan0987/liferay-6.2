...
/**
 * Provides the local service interface for AswmsgSyndatahistory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see AswmsgSyndatahistoryLocalServiceUtil
...
public interface AswmsgSyndatahistoryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AswmsgSyndatahistoryLocalServiceUtil} to access the aswmsg syndatahistory local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.aswmsg.service.impl.AswmsgSyndatahistoryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
