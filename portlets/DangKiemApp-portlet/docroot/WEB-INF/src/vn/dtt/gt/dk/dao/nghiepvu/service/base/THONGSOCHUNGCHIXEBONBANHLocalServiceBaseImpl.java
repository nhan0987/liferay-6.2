...
import vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIXEBONBANHLocalService;
...
/**
 * Provides the base implementation for the t h o n g s o c h u n g c h i x e b o n b a n h local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.THONGSOCHUNGCHIXEBONBANHLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class THONGSOCHUNGCHIXEBONBANHLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements THONGSOCHUNGCHIXEBONBANHLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.THONGSOCHUNGCHIXEBONBANHLocalServiceUtil} to access the t h o n g s o c h u n g c h i x e b o n b a n h local service.
	 */
	...
	@Override
	public THONGSOCHUNGCHIXEBONBANH addTHONGSOCHUNGCHIXEBONBANH(
		THONGSOCHUNGCHIXEBONBANH thongsochungchixebonbanh)
		throws SystemException {
		thongsochungchixebonbanh.setNew(true);

		return thongsochungchixebonbanhPersistence.update(thongsochungchixebonbanh);
	}
	 ...
	 */
	@Override
	public THONGSOCHUNGCHIXEBONBANH createTHONGSOCHUNGCHIXEBONBANH(long id) {
		return thongsochungchixebonbanhPersistence.create(id);
	}
	...
	@Override
	public THONGSOCHUNGCHIXEBONBANH deleteTHONGSOCHUNGCHIXEBONBANH(long id)
		throws PortalException, SystemException {
		return thongsochungchixebonbanhPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public THONGSOCHUNGCHIXEBONBANH deleteTHONGSOCHUNGCHIXEBONBANH(
		THONGSOCHUNGCHIXEBONBANH thongsochungchixebonbanh)
		throws SystemException {
		return thongsochungchixebonbanhPersistence.remove(thongsochungchixebonbanh);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(THONGSOCHUNGCHIXEBONBANH.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return thongsochungchixebonbanhPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return thongsochungchixebonbanhPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public THONGSOCHUNGCHIXEBONBANH fetchTHONGSOCHUNGCHIXEBONBANH(long id)
		throws SystemException {
		return thongsochungchixebonbanhPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public THONGSOCHUNGCHIXEBONBANH getTHONGSOCHUNGCHIXEBONBANH(long id)
		throws PortalException, SystemException {
		return thongsochungchixebonbanhPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return thongsochungchixebonbanhPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<THONGSOCHUNGCHIXEBONBANH> getTHONGSOCHUNGCHIXEBONBANHs(
		int start, int end) throws SystemException {
		return thongsochungchixebonbanhPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTHONGSOCHUNGCHIXEBONBANHsCount() throws SystemException {
		return thongsochungchixebonbanhPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public THONGSOCHUNGCHIXEBONBANH updateTHONGSOCHUNGCHIXEBONBANH(
		THONGSOCHUNGCHIXEBONBANH thongsochungchixebonbanh)
		throws SystemException {
		return thongsochungchixebonbanhPersistence.update(thongsochungchixebonbanh);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.THONGSOCHUNGCHIXEBONBANH",
			thongsochungchixebonbanhLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = thongsochungchixebonbanhPersistence.getDataSource();
	...
	private THONGSOCHUNGCHIXEBONBANHLocalServiceClpInvoker _clpInvoker = new THONGSOCHUNGCHIXEBONBANHLocalServiceClpInvoker();
}