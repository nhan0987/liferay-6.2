 ...
 * @generated
 */
public class AssessmentofImporterServiceClpInvoker {
	public AssessmentofImporterServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName470.equals(name) &&
			...
			return AssessmentofImporterServiceUtil.getBeanIdentifier();
		}

		if (_methodName471.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes471, parameterTypes)) {
			AssessmentofImporterServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
