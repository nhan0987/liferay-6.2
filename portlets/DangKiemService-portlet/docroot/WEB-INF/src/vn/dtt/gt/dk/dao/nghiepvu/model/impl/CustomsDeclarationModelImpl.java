...
public class CustomsDeclarationModelImpl extends BaseModelImpl<CustomsDeclaration>
	...
	public static final String TABLE_SQL_CREATE = "create table vr_customsdeclaration (id LONG not null primary key,importcustomdeclareno VARCHAR(75) null,importcustomdeclaredate DATE null,customsresult VARCHAR(75) null,productcheck VARCHAR(75) null,releasedate DATE null,hosothutucid LONG,synchdate DATE null)";
	...
	public Object clone() {
		...
		customsDeclarationImpl.setSynchdate(getSynchdate());
	...
	public CacheModel<CustomsDeclaration> toCacheModel() {
		...
		if (synchdate != null) {
			customsDeclarationCacheModel.synchdate = synchdate.getTime();
		}
		else {
			customsDeclarationCacheModel.synchdate = Long.MIN_VALUE;
		}
