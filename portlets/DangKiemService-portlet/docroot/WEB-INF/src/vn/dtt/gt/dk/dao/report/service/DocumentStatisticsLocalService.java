...
/**
 * Provides the local service interface for DocumentStatistics. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see DocumentStatisticsLocalServiceUtil
...
public interface DocumentStatisticsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DocumentStatisticsLocalServiceUtil} to access the document statistics local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.report.service.impl.DocumentStatisticsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
