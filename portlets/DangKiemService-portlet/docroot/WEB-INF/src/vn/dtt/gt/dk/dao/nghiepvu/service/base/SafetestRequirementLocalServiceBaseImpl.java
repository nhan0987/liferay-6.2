...
import vn.dtt.gt.dk.dao.nghiepvu.service.SafetestRequirementLocalService;
...
/**
 * Provides the base implementation for the safetest requirement local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.SafetestRequirementLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class SafetestRequirementLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SafetestRequirementLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.SafetestRequirementLocalServiceUtil} to access the safetest requirement local service.
	 */
	...
	@Override
	public SafetestRequirement addSafetestRequirement(
		SafetestRequirement safetestRequirement) throws SystemException {
		safetestRequirement.setNew(true);

		return safetestRequirementPersistence.update(safetestRequirement);
	}
	 ...
	 */
	@Override
	public SafetestRequirement createSafetestRequirement(long id) {
		return safetestRequirementPersistence.create(id);
	}
	...
	@Override
	public SafetestRequirement deleteSafetestRequirement(long id)
		throws PortalException, SystemException {
		return safetestRequirementPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SafetestRequirement deleteSafetestRequirement(
		SafetestRequirement safetestRequirement) throws SystemException {
		return safetestRequirementPersistence.remove(safetestRequirement);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SafetestRequirement.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return safetestRequirementPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return safetestRequirementPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SafetestRequirement fetchSafetestRequirement(long id)
		throws SystemException {
		return safetestRequirementPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public SafetestRequirement getSafetestRequirement(long id)
		throws PortalException, SystemException {
		return safetestRequirementPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return safetestRequirementPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SafetestRequirement> getSafetestRequirements(int start, int end)
		throws SystemException {
		return safetestRequirementPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSafetestRequirementsCount() throws SystemException {
		return safetestRequirementPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SafetestRequirement updateSafetestRequirement(
		SafetestRequirement safetestRequirement) throws SystemException {
		return safetestRequirementPersistence.update(safetestRequirement);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.SafetestRequirement",
			safetestRequirementLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = safetestRequirementPersistence.getDataSource();
	...
	private SafetestRequirementLocalServiceClpInvoker _clpInvoker = new SafetestRequirementLocalServiceClpInvoker();
}