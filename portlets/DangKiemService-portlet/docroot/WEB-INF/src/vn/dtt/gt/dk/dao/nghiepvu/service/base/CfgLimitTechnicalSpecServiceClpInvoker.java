 ...
 * @generated
 */
public class CfgLimitTechnicalSpecServiceClpInvoker {
	public CfgLimitTechnicalSpecServiceClpInvoker() {
		...
		_methodName302 = "countCfgLimitTechnicalSpec";
		...
		_methodName304 = "getCfgLimitTechnicalSpecs";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName296.equals(name) &&
			...
			return CfgLimitTechnicalSpecServiceUtil.getBeanIdentifier();
		}

		if (_methodName297.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes297, parameterTypes)) {
			CfgLimitTechnicalSpecServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
		...
		if (_methodName302.equals(name) &&
			...
			return CfgLimitTechnicalSpecServiceUtil.countCfgLimitTechnicalSpec();
		}

		if (_methodName303.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes303, parameterTypes)) {
			return CfgLimitTechnicalSpecServiceUtil.countBySyncDate((java.lang.String)arguments[0]);
		}

		if (_methodName304.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes304, parameterTypes)) {
			return CfgLimitTechnicalSpecServiceUtil.getCfgLimitTechnicalSpecs(((Integer)arguments[0]).intValue(),
				((Integer)arguments[1]).intValue());
		}

		if (_methodName305.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes305, parameterTypes)) {
			return CfgLimitTechnicalSpecServiceUtil.getBySpecificationCode((java.lang.String)arguments[0]);
		}

		if (_methodName306.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes306, parameterTypes)) {
			return CfgLimitTechnicalSpecServiceUtil.getBySynchDate((java.lang.String)arguments[0]);
		}
