...
public class VehicleRecordPersistenceImpl extends BasePersistenceImpl<VehicleRecord>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_CN_CHN_EN = new FinderPath(VehicleRecordModelImpl.ENTITY_CACHE_ENABLED,
			VehicleRecordModelImpl.FINDER_CACHE_ENABLED,
			VehicleRecordImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByCN_CHN_EN",
			new String[] {
			...
			VehicleRecordModelImpl.CODENUMBER_COLUMN_BITMASK |
			VehicleRecordModelImpl.CHASSISNUMBER_COLUMN_BITMASK |
			VehicleRecordModelImpl.ENGINENUMBER_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_CN_CHN_EN = new FinderPath(VehicleRecordModelImpl.ENTITY_CACHE_ENABLED,
			VehicleRecordModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public VehicleRecord findByCN_CHN_EN(long codeNumber, String chassisNumber,
		String engineNumber)
		throws NoSuchVehicleRecordException, SystemException {
		VehicleRecord vehicleRecord = fetchByCN_CHN_EN(codeNumber,
	 ...
	 */
	@Override
	public VehicleRecord fetchByCN_CHN_EN(long codeNumber,
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"VehicleRecordPersistenceImpl.fetchByCN_CHN_EN(long, String, String, boolean) with parameters (" +
							StringUtil.merge(finderArgs) +
							") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
					}
					...
					if ((vehicleRecord.getCodeNumber() != codeNumber) ||
							(vehicleRecord.getChassisNumber() == null) ||
							!vehicleRecord.getChassisNumber()
											  .equals(chassisNumber) ||
							(vehicleRecord.getEngineNumber() == null) ||
							!vehicleRecord.getEngineNumber().equals(engineNumber)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_CN_CHN_EN,
							finderArgs, vehicleRecord);
					}
				}
	 ...
	 */
	@Override
	public VehicleRecord removeByCN_CHN_EN(long codeNumber,
		String chassisNumber, String engineNumber)
		throws NoSuchVehicleRecordException, SystemException {
		VehicleRecord vehicleRecord = findByCN_CHN_EN(codeNumber,
				chassisNumber, engineNumber);
	...
	private static final String _FINDER_COLUMN_CN_CHN_EN_CODENUMBER_2 = "vehicleRecord.codeNumber = ? AND ";
	private static final String _FINDER_COLUMN_CN_CHN_EN_CHASSISNUMBER_1 = "vehicleRecord.chassisNumber IS NULL AND ";
	private static final String _FINDER_COLUMN_CN_CHN_EN_CHASSISNUMBER_2 = "vehicleRecord.chassisNumber = ? AND ";
	private static final String _FINDER_COLUMN_CN_CHN_EN_CHASSISNUMBER_3 = "(vehicleRecord.chassisNumber IS NULL OR vehicleRecord.chassisNumber = '') AND ";
	private static final String _FINDER_COLUMN_CN_CHN_EN_ENGINENUMBER_1 = "vehicleRecord.engineNumber IS NULL";
	private static final String _FINDER_COLUMN_CN_CHN_EN_ENGINENUMBER_2 = "vehicleRecord.engineNumber = ?";
	private static final String _FINDER_COLUMN_CN_CHN_EN_ENGINENUMBER_3 = "(vehicleRecord.engineNumber IS NULL OR vehicleRecord.engineNumber = '')";
	...
	public void cacheResult(VehicleRecord vehicleRecord) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_CN_CHN_EN,
			new Object[] {
				vehicleRecord.getCodeNumber(), vehicleRecord.getChassisNumber(),
				vehicleRecord.getEngineNumber()
			}, vehicleRecord);
	...
	protected void clearUniqueFindersCache(VehicleRecord vehicleRecord) {
		...
		if ((vehicleRecordModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_CN_CHN_EN.getColumnBitmask()) != 0) {
			args = new Object[] {
					vehicleRecordModelImpl.getOriginalCodeNumber(),
					vehicleRecordModelImpl.getOriginalChassisNumber(),
					vehicleRecordModelImpl.getOriginalEngineNumber()
				};
	...
	protected VehicleRecord toUnwrappedModel(VehicleRecord vehicleRecord) {
		...
		vehicleRecordImpl.setSynchdate(vehicleRecord.getSynchdate());
