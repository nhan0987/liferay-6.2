...
import vn.dtt.gt.dk.dao.common.model.TthcHoSoThuTucSoap;
...
public class TthcHoSoThuTucModelImpl extends BaseModelImpl<TthcHoSoThuTuc>
	 ...
	 */
	public static TthcHoSoThuTuc toModel(TthcHoSoThuTucSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		TthcHoSoThuTuc model = new TthcHoSoThuTucImpl();
		...
		model.setLoaiChuHoSo(soapModel.getLoaiChuHoSo());
		model.setMaSoChuHoSo(soapModel.getMaSoChuHoSo());
	 ...
	 */
	public static List<TthcHoSoThuTuc> toModels(TthcHoSoThuTucSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<TthcHoSoThuTuc> models = new ArrayList<TthcHoSoThuTuc>(soapModels.length);

		for (TthcHoSoThuTucSoap soapModel : soapModels) {
