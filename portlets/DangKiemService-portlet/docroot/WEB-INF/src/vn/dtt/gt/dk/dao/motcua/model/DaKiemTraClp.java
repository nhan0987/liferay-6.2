 ...
 * @author huymq
 */
public class DaKiemTraClp extends BaseModelImpl<DaKiemTra> implements DaKiemTra {
	public DaKiemTraClp() {
	}
	...
	public void setId(long id) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				Class<?> clazz = _daKiemTraRemoteModel.getClass();

				Method method = clazz.getMethod("setId", long.class);

				method.invoke(_daKiemTraRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setPhieuXuLyChinhId(long phieuXuLyChinhId) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				...
				method.invoke(_daKiemTraRemoteModel, phieuXuLyChinhId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTrichYeuNoiDung(String trichYeuNoiDung) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				...
				method.invoke(_daKiemTraRemoteModel, trichYeuNoiDung);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setGhiChu(String ghiChu) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				...
				method.invoke(_daKiemTraRemoteModel, ghiChu);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTrangThaiHienTaiId(long trangThaiHienTaiId) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				...
				method.invoke(_daKiemTraRemoteModel, trangThaiHienTaiId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNoiDungHoSoId(long noiDungHoSoId) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				...
				method.invoke(_daKiemTraRemoteModel, noiDungHoSoId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setChiemQuyenXuLy(long chiemQuyenXuLy) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				...
				method.invoke(_daKiemTraRemoteModel, chiemQuyenXuLy);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNgayTaoPhieu(Date ngayTaoPhieu) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				...
				method.invoke(_daKiemTraRemoteModel, ngayTaoPhieu);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNguoiTaoPhieu(long nguoiTaoPhieu) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				...
				method.invoke(_daKiemTraRemoteModel, nguoiTaoPhieu);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNhomPhieuXuLy(String nhomPhieuXuLy) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				...
				method.invoke(_daKiemTraRemoteModel, nhomPhieuXuLy);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPhanNhomHoSoId(long phanNhomHoSoId) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				...
				method.invoke(_daKiemTraRemoteModel, phanNhomHoSoId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMaSoHoSo(String maSoHoSo) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				...
				method.invoke(_daKiemTraRemoteModel, maSoHoSo);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMaBienNhan(String maBienNhan) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				...
				method.invoke(_daKiemTraRemoteModel, maBienNhan);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setThuTucHanhChinhId(long thuTucHanhChinhId) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				...
				method.invoke(_daKiemTraRemoteModel, thuTucHanhChinhId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTenChuHoSo(String tenChuHoSo) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				...
				method.invoke(_daKiemTraRemoteModel, tenChuHoSo);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNgayGuiHoSo(Date ngayGuiHoSo) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				...
				method.invoke(_daKiemTraRemoteModel, ngayGuiHoSo);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTenDonViTiepNhan(String tenDonViTiepNhan) {
		...
		if (_daKiemTraRemoteModel != null) {
			try {
				...
				method.invoke(_daKiemTraRemoteModel, tenDonViTiepNhan);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getDaKiemTraRemoteModel() {
		return _daKiemTraRemoteModel;
	}

	public void setDaKiemTraRemoteModel(BaseModel<?> daKiemTraRemoteModel) {
		_daKiemTraRemoteModel = daKiemTraRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _daKiemTraRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_daKiemTraRemoteModel,
	...
	public void persist() throws SystemException {
		if (this.isNew()) {
			DaKiemTraLocalServiceUtil.addDaKiemTra(this);
		}
		else {
			DaKiemTraLocalServiceUtil.updateDaKiemTra(this);
		}
	}

	@Override
	public DaKiemTra toEscapedModel() {
		return (DaKiemTra)ProxyUtil.newProxyInstance(DaKiemTra.class.getClassLoader(),
			new Class[] { DaKiemTra.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		DaKiemTraClp clone = new DaKiemTraClp();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DaKiemTraClp)) {
			return false;
		}

		DaKiemTraClp daKiemTra = (DaKiemTraClp)obj;
