...
import vn.dtt.gt.dk.dao.common.service.TthcHoSoThuTucService;
...
/**
 * Provides the base implementation for the tthc ho so thu tuc remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.common.service.impl.TthcHoSoThuTucServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class TthcHoSoThuTucServiceBaseImpl extends BaseServiceImpl
	implements TthcHoSoThuTucService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.common.service.TthcHoSoThuTucServiceUtil} to access the tthc ho so thu tuc remote service.
	 */
	...
	private TthcHoSoThuTucServiceClpInvoker _clpInvoker = new TthcHoSoThuTucServiceClpInvoker();
}