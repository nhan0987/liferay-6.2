...
import vn.dtt.gt.dk.dao.nghiepvu.service.CertificateCircularLocalService;
...
/**
 * Provides the base implementation for the certificate circular local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.CertificateCircularLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class CertificateCircularLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CertificateCircularLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.CertificateCircularLocalServiceUtil} to access the certificate circular local service.
	 */
	...
	@Override
	public CertificateCircular addCertificateCircular(
		CertificateCircular certificateCircular) throws SystemException {
		certificateCircular.setNew(true);

		return certificateCircularPersistence.update(certificateCircular);
	}
	 ...
	 */
	@Override
	public CertificateCircular createCertificateCircular(long id) {
		return certificateCircularPersistence.create(id);
	}
	...
	@Override
	public CertificateCircular deleteCertificateCircular(long id)
		throws PortalException, SystemException {
		return certificateCircularPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CertificateCircular deleteCertificateCircular(
		CertificateCircular certificateCircular) throws SystemException {
		return certificateCircularPersistence.remove(certificateCircular);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CertificateCircular.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return certificateCircularPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return certificateCircularPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CertificateCircular fetchCertificateCircular(long id)
		throws SystemException {
		return certificateCircularPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public CertificateCircular getCertificateCircular(long id)
		throws PortalException, SystemException {
		return certificateCircularPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return certificateCircularPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CertificateCircular> getCertificateCirculars(int start, int end)
		throws SystemException {
		return certificateCircularPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCertificateCircularsCount() throws SystemException {
		return certificateCircularPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CertificateCircular updateCertificateCircular(
		CertificateCircular certificateCircular) throws SystemException {
		return certificateCircularPersistence.update(certificateCircular);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.CertificateCircular",
			certificateCircularLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.gt.dk.dao.nghiepvu.model.CertificateCircular");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = certificateCircularPersistence.getDataSource();
	...
	private CertificateCircularLocalServiceClpInvoker _clpInvoker = new CertificateCircularLocalServiceClpInvoker();
}