...
public class InspectionRecordLocalServiceUtil {
	...
	*/
	...
	public static boolean deleteInspectionRecordSpec(long inspectionId) {
		return getService().deleteInspectionRecordSpec(inspectionId);
	}

	public static boolean deleteInspectionCommonstatus(long inspectionId) {
		return getService().deleteInspectionCommonstatus(inspectionId);
	}

	public static java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.InspectionRecord> findByBienBanLuuTam(
		long confirmedInspectionId) {
		return getService().findByBienBanLuuTam(confirmedInspectionId);
	}

	public static java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.InspectionRecord> findByAttachedFileID(
		long idAttachedFile) {
		return getService().findByAttachedFileID(idAttachedFile);
	}

	public static vn.dtt.gt.dk.dao.nghiepvu.model.InspectionRecord getByR_I(
		long registeredInspectionId, java.lang.String inspectionRecordNumber)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getByR_I(registeredInspectionId, inspectionRecordNumber);
	}
