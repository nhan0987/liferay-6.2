...
import vn.dtt.gt.dk.dao.nghiepvu.service.EmissionTestReportLocalService;
...
/**
 * Provides the base implementation for the emission test report local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.EmissionTestReportLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class EmissionTestReportLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmissionTestReportLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.EmissionTestReportLocalServiceUtil} to access the emission test report local service.
	 */
	...
	@Override
	public EmissionTestReport addEmissionTestReport(
		EmissionTestReport emissionTestReport) throws SystemException {
		emissionTestReport.setNew(true);

		return emissionTestReportPersistence.update(emissionTestReport);
	}
	 ...
	 */
	@Override
	public EmissionTestReport createEmissionTestReport(long id) {
		return emissionTestReportPersistence.create(id);
	}
	...
	@Override
	public EmissionTestReport deleteEmissionTestReport(long id)
		throws PortalException, SystemException {
		return emissionTestReportPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmissionTestReport deleteEmissionTestReport(
		EmissionTestReport emissionTestReport) throws SystemException {
		return emissionTestReportPersistence.remove(emissionTestReport);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmissionTestReport.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return emissionTestReportPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return emissionTestReportPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmissionTestReport fetchEmissionTestReport(long id)
		throws SystemException {
		return emissionTestReportPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public EmissionTestReport getEmissionTestReport(long id)
		throws PortalException, SystemException {
		return emissionTestReportPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return emissionTestReportPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmissionTestReport> getEmissionTestReports(int start, int end)
		throws SystemException {
		return emissionTestReportPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmissionTestReportsCount() throws SystemException {
		return emissionTestReportPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmissionTestReport updateEmissionTestReport(
		EmissionTestReport emissionTestReport) throws SystemException {
		return emissionTestReportPersistence.update(emissionTestReport);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.EmissionTestReport",
			emissionTestReportLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.gt.dk.dao.nghiepvu.model.EmissionTestReport");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = emissionTestReportPersistence.getDataSource();
	...
	private EmissionTestReportLocalServiceClpInvoker _clpInvoker = new EmissionTestReportLocalServiceClpInvoker();
}