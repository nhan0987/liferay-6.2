...
public class InspectionRecordModelImpl extends BaseModelImpl<InspectionRecord>
	...
	public Object clone() {
		...
		inspectionRecordImpl.setSynchdate(getSynchdate());
	...
	public CacheModel<InspectionRecord> toCacheModel() {
		...
		if (synchdate != null) {
			inspectionRecordCacheModel.synchdate = synchdate.getTime();
		}
		else {
			inspectionRecordCacheModel.synchdate = Long.MIN_VALUE;
		}
