...
/**
 * Provides the local service interface for LichKiemTraHienTruong. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author huymq
 * @see LichKiemTraHienTruongLocalServiceUtil
...
public interface LichKiemTraHienTruongLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LichKiemTraHienTruongLocalServiceUtil} to access the lich kiem tra hien truong local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.motcua.service.impl.LichKiemTraHienTruongLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
