...
/**
 * Provides the local service interface for CertificateCircular. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author huymq
 * @see CertificateCircularLocalServiceUtil
...
public interface CertificateCircularLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CertificateCircularLocalServiceUtil} to access the certificate circular local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.CertificateCircularLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
