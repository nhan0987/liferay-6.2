...
public class CfgTechnicalspecLocalServiceWrapper
	...
	*/
	...
	public vn.dtt.gt.dk.dao.nghiepvu.model.CfgTechnicalspec findBySpecificationCode(
		...
		return _cfgTechnicalspecLocalService.findBySpecificationCode(specificationCode);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.CfgTechnicalspec> findByLikeVehicleTypeCode(
		...
		return _cfgTechnicalspecLocalService.findByLikeVehicleTypeCode(likeVehicleTypeCode,
			start, end);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.CfgTechnicalspec> findByVehicleTypeCode(
		...
		return _cfgTechnicalspecLocalService.findByVehicleTypeCode(vehicleTypeCode);
	}

	@Override
	public java.util.List<java.lang.String> getSpecCategoryByVehicleTypeCode(
		java.lang.String vehicleTypeCode) {
		return _cfgTechnicalspecLocalService.getSpecCategoryByVehicleTypeCode(vehicleTypeCode);
	}

	@Override
	public java.util.List<java.lang.String> getSpecificationCodeBySpecCategory(
		java.lang.String[] specCategorys) {
		return _cfgTechnicalspecLocalService.getSpecificationCodeBySpecCategory(specCategorys);
	}
