...
public class ControlRequirementModelImpl extends BaseModelImpl<ControlRequirement>
	...
	public Object clone() {
		...
		controlRequirementImpl.setSynchdate(getSynchdate());
	...
	public CacheModel<ControlRequirement> toCacheModel() {
		...
		if (synchdate != null) {
			controlRequirementCacheModel.synchdate = synchdate.getTime();
		}
		else {
			controlRequirementCacheModel.synchdate = Long.MIN_VALUE;
		}
