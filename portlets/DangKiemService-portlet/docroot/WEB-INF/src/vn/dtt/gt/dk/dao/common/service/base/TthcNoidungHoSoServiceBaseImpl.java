...
import vn.dtt.gt.dk.dao.common.service.TthcNoidungHoSoService;
...
/**
 * Provides the base implementation for the tthc noidung ho so remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.common.service.impl.TthcNoidungHoSoServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class TthcNoidungHoSoServiceBaseImpl extends BaseServiceImpl
	implements TthcNoidungHoSoService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.common.service.TthcNoidungHoSoServiceUtil} to access the tthc noidung ho so remote service.
	 */
	...
	private TthcNoidungHoSoServiceClpInvoker _clpInvoker = new TthcNoidungHoSoServiceClpInvoker();
}