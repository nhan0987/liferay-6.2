...
import vn.dtt.gt.dk.dao.nghiepvu.service.ControlRequirementLocalService;
...
/**
 * Provides the base implementation for the control requirement local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.ControlRequirementLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class ControlRequirementLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ControlRequirementLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.ControlRequirementLocalServiceUtil} to access the control requirement local service.
	 */
	...
	@Override
	public ControlRequirement addControlRequirement(
		ControlRequirement controlRequirement) throws SystemException {
		controlRequirement.setNew(true);

		return controlRequirementPersistence.update(controlRequirement);
	}
	 ...
	 */
	@Override
	public ControlRequirement createControlRequirement(long id) {
		return controlRequirementPersistence.create(id);
	}
	...
	@Override
	public ControlRequirement deleteControlRequirement(long id)
		throws PortalException, SystemException {
		return controlRequirementPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ControlRequirement deleteControlRequirement(
		ControlRequirement controlRequirement) throws SystemException {
		return controlRequirementPersistence.remove(controlRequirement);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ControlRequirement.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return controlRequirementPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return controlRequirementPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ControlRequirement fetchControlRequirement(long id)
		throws SystemException {
		return controlRequirementPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public ControlRequirement getControlRequirement(long id)
		throws PortalException, SystemException {
		return controlRequirementPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return controlRequirementPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ControlRequirement> getControlRequirements(int start, int end)
		throws SystemException {
		return controlRequirementPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getControlRequirementsCount() throws SystemException {
		return controlRequirementPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ControlRequirement updateControlRequirement(
		ControlRequirement controlRequirement) throws SystemException {
		return controlRequirementPersistence.update(controlRequirement);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.ControlRequirement",
			controlRequirementLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = controlRequirementPersistence.getDataSource();
	...
	private ControlRequirementLocalServiceClpInvoker _clpInvoker = new ControlRequirementLocalServiceClpInvoker();
}