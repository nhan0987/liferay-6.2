...
import vn.dtt.gt.dk.dao.nghiepvu.service.InspectionRecordLocalService;
...
/**
 * Provides the base implementation for the inspection record local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.InspectionRecordLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class InspectionRecordLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements InspectionRecordLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.InspectionRecordLocalServiceUtil} to access the inspection record local service.
	 */
	...
	@Override
	public InspectionRecord addInspectionRecord(
		InspectionRecord inspectionRecord) throws SystemException {
		inspectionRecord.setNew(true);

		return inspectionRecordPersistence.update(inspectionRecord);
	}
	 ...
	 */
	@Override
	public InspectionRecord createInspectionRecord(long id) {
		return inspectionRecordPersistence.create(id);
	}
	...
	@Override
	public InspectionRecord deleteInspectionRecord(long id)
		throws PortalException, SystemException {
		return inspectionRecordPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public InspectionRecord deleteInspectionRecord(
		InspectionRecord inspectionRecord) throws SystemException {
		return inspectionRecordPersistence.remove(inspectionRecord);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(InspectionRecord.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return inspectionRecordPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return inspectionRecordPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public InspectionRecord fetchInspectionRecord(long id)
		throws SystemException {
		return inspectionRecordPersistence.fetchByPrimaryKey(id);
	}
	...
	public InspectionRecord getInspectionRecord(long id)
		throws PortalException, SystemException {
		return inspectionRecordPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return inspectionRecordPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<InspectionRecord> getInspectionRecords(int start, int end)
		throws SystemException {
		return inspectionRecordPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getInspectionRecordsCount() throws SystemException {
		return inspectionRecordPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public InspectionRecord updateInspectionRecord(
		InspectionRecord inspectionRecord) throws SystemException {
		return inspectionRecordPersistence.update(inspectionRecord);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.InspectionRecord",
			inspectionRecordLocalService);
	}
	...
	private InspectionRecordLocalServiceClpInvoker _clpInvoker = new InspectionRecordLocalServiceClpInvoker();
}