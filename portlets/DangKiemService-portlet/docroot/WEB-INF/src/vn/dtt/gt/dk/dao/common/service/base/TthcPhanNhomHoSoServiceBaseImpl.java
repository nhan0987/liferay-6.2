...
import vn.dtt.gt.dk.dao.common.service.TthcPhanNhomHoSoService;
...
/**
 * Provides the base implementation for the tthc phan nhom ho so remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.common.service.impl.TthcPhanNhomHoSoServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class TthcPhanNhomHoSoServiceBaseImpl extends BaseServiceImpl
	implements TthcPhanNhomHoSoService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.common.service.TthcPhanNhomHoSoServiceUtil} to access the tthc phan nhom ho so remote service.
	 */
	...
	private TthcPhanNhomHoSoServiceClpInvoker _clpInvoker = new TthcPhanNhomHoSoServiceClpInvoker();
}