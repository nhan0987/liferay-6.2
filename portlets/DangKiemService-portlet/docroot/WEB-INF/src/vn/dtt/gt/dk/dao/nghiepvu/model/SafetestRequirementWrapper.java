...
public class SafetestRequirementWrapper implements SafetestRequirement,
	...
	*/
	...
	/**
	* Returns the synchdate of this safetest requirement.
	*
	* @return the synchdate of this safetest requirement
	*/
	@Override
	public java.util.Date getSynchdate() {
		return _safetestRequirement.getSynchdate();
	}

	/**
	* Sets the synchdate of this safetest requirement.
	*
	* @param synchdate the synchdate of this safetest requirement
	*/
	@Override
	public void setSynchdate(java.util.Date synchdate) {
		_safetestRequirement.setSynchdate(synchdate);
	}
