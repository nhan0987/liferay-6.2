...
public class ClpSerializer {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"vn.dtt.gt.dk.dao.nghiepvu.DuplicateInspectionRecordNoException")) {
			return new vn.dtt.gt.dk.dao.nghiepvu.DuplicateInspectionRecordNoException();
		}

		if (className.equals(
					"vn.dtt.gt.dk.dao.nghiepvu.VehicleInspectionRecordInvalidException")) {
			return new vn.dtt.gt.dk.dao.nghiepvu.VehicleInspectionRecordInvalidException();
		}
