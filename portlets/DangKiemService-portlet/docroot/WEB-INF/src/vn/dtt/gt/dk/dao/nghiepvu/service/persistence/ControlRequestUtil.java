...
/**
 * The persistence utility for the control request service. This utility wraps {@link ControlRequestPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ControlRequestUtil {
	 ...
	 */
	public static void clearCache(ControlRequest controlRequest) {
		getPersistence().clearCache(controlRequest);
	}
	 ...
	 */
	public static List<ControlRequest> findWithDynamicQuery(
	 ...
	 */
	public static ControlRequest update(ControlRequest controlRequest)
		throws SystemException {
		return getPersistence().update(controlRequest);
	}
	...
	public static ControlRequest update(ControlRequest controlRequest,
		...
		return getPersistence().update(controlRequest, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(controlRequest);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(controlRequests);
	}
	...
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.ControlRequest create(long id) {
	...
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.ControlRequest remove(long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.gt.dk.dao.nghiepvu.NoSuchControlRequestException {
		return getPersistence().remove(id);
	}

	public static vn.dtt.gt.dk.dao.nghiepvu.model.ControlRequest updateImpl(
		vn.dtt.gt.dk.dao.nghiepvu.model.ControlRequest controlRequest)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(controlRequest);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.ControlRequest findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.gt.dk.dao.nghiepvu.NoSuchControlRequestException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.ControlRequest fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.ControlRequest> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ControlRequestPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ControlRequestPersistence)PortletBeanLocatorUtil.locate(vn.dtt.gt.dk.dao.nghiepvu.service.ClpSerializer.getServletContextName(),
					ControlRequestPersistence.class.getName());

			ReferenceRegistry.registerReference(ControlRequestUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(ControlRequestPersistence persistence) {
	}

	private static ControlRequestPersistence _persistence;
}