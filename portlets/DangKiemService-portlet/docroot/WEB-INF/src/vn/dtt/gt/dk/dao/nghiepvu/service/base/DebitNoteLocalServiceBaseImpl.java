...
import vn.dtt.gt.dk.dao.nghiepvu.service.DebitNoteLocalService;
...
/**
 * Provides the base implementation for the debit note local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.DebitNoteLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class DebitNoteLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements DebitNoteLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.DebitNoteLocalServiceUtil} to access the debit note local service.
	 */
	...
	public DebitNote addDebitNote(DebitNote debitNote)
		...
		return debitNotePersistence.update(debitNote);
	}
	 ...
	 */
	@Override
	public DebitNote createDebitNote(long id) {
		return debitNotePersistence.create(id);
	}
	...
	@Override
	public DebitNote deleteDebitNote(long id)
		throws PortalException, SystemException {
		return debitNotePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DebitNote deleteDebitNote(DebitNote debitNote)
		throws SystemException {
		return debitNotePersistence.remove(debitNote);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DebitNote.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return debitNotePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return debitNotePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return debitNotePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DebitNote fetchDebitNote(long id) throws SystemException {
		return debitNotePersistence.fetchByPrimaryKey(id);
	}
	...
	public DebitNote getDebitNote(long id)
		throws PortalException, SystemException {
		return debitNotePersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return debitNotePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DebitNote> getDebitNotes(int start, int end)
		throws SystemException {
		return debitNotePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDebitNotesCount() throws SystemException {
		return debitNotePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.DebitNote",
			debitNoteLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = debitNotePersistence.getDataSource();
	...
	private DebitNoteLocalServiceClpInvoker _clpInvoker = new DebitNoteLocalServiceClpInvoker();
}