...
/**
 * This class is used by SOAP remote services, specifically {@link vn.dtt.gt.dk.dao.motcua.service.http.LichKiemTraHienTruongServiceSoap}.
 *
 * @author huymq
 * @see vn.dtt.gt.dk.dao.motcua.service.http.LichKiemTraHienTruongServiceSoap
 * @generated
 */
public class LichKiemTraHienTruongSoap implements Serializable {
	public static LichKiemTraHienTruongSoap toSoapModel(
		LichKiemTraHienTruong model) {
		LichKiemTraHienTruongSoap soapModel = new LichKiemTraHienTruongSoap();
	...
	public static LichKiemTraHienTruongSoap[] toSoapModels(
		LichKiemTraHienTruong[] models) {
		LichKiemTraHienTruongSoap[] soapModels = new LichKiemTraHienTruongSoap[models.length];
	...
	public static LichKiemTraHienTruongSoap[][] toSoapModels(
		LichKiemTraHienTruong[][] models) {
		LichKiemTraHienTruongSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new LichKiemTraHienTruongSoap[models.length][models[0].length];
		}
		else {
			soapModels = new LichKiemTraHienTruongSoap[0][0];
		}
	...
	public static LichKiemTraHienTruongSoap[] toSoapModels(
		List<LichKiemTraHienTruong> models) {
		List<LichKiemTraHienTruongSoap> soapModels = new ArrayList<LichKiemTraHienTruongSoap>(models.size());

		for (LichKiemTraHienTruong model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new LichKiemTraHienTruongSoap[soapModels.size()]);
	}

	public LichKiemTraHienTruongSoap() {
	}
