...
import vn.dtt.gt.dk.dao.nghiepvu.service.DraftCertificateLocalService;
...
/**
 * Provides the base implementation for the draft certificate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.DraftCertificateLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.DraftCertificateLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.DraftCertificateLocalServiceUtil
 * @generated
 */
public abstract class DraftCertificateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DraftCertificateLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.DraftCertificateLocalServiceUtil} to access the draft certificate local service.
	 */
	...
	@Override
	public DraftCertificate addDraftCertificate(
		DraftCertificate draftCertificate) throws SystemException {
		draftCertificate.setNew(true);

		return draftCertificatePersistence.update(draftCertificate);
	}
	 ...
	 */
	@Override
	public DraftCertificate createDraftCertificate(long id) {
		return draftCertificatePersistence.create(id);
	}
	...
	@Override
	public DraftCertificate deleteDraftCertificate(long id)
		throws PortalException, SystemException {
		return draftCertificatePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DraftCertificate deleteDraftCertificate(
		DraftCertificate draftCertificate) throws SystemException {
		return draftCertificatePersistence.remove(draftCertificate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DraftCertificate.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return draftCertificatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return draftCertificatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DraftCertificate fetchDraftCertificate(long id)
		throws SystemException {
		return draftCertificatePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DraftCertificate getDraftCertificate(long id)
		throws PortalException, SystemException {
		return draftCertificatePersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return draftCertificatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DraftCertificate> getDraftCertificates(int start, int end)
		throws SystemException {
		return draftCertificatePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDraftCertificatesCount() throws SystemException {
		return draftCertificatePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DraftCertificate updateDraftCertificate(
		DraftCertificate draftCertificate) throws SystemException {
		return draftCertificatePersistence.update(draftCertificate);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.DraftCertificate",
			draftCertificateLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = draftCertificatePersistence.getDataSource();
	...
	private DraftCertificateLocalServiceClpInvoker _clpInvoker = new DraftCertificateLocalServiceClpInvoker();
}