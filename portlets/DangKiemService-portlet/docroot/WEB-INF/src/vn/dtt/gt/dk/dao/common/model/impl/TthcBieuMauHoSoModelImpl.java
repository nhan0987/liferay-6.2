...
import vn.dtt.gt.dk.dao.common.model.TthcBieuMauHoSoSoap;
...
public class TthcBieuMauHoSoModelImpl extends BaseModelImpl<TthcBieuMauHoSo>
	 ...
	 */
	public static TthcBieuMauHoSo toModel(TthcBieuMauHoSoSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		TthcBieuMauHoSo model = new TthcBieuMauHoSoImpl();

		model.setId(soapModel.getId());
		model.setMaBieuMau(soapModel.getMaBieuMau());
		model.setTenBieuMau(soapModel.getTenBieuMau());
		model.setTenTiengAnh(soapModel.getTenTiengAnh());
		model.setTaiLieuMau(soapModel.getTaiLieuMau());
	 ...
	 */
	public static List<TthcBieuMauHoSo> toModels(
		TthcBieuMauHoSoSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<TthcBieuMauHoSo> models = new ArrayList<TthcBieuMauHoSo>(soapModels.length);

		for (TthcBieuMauHoSoSoap soapModel : soapModels) {
