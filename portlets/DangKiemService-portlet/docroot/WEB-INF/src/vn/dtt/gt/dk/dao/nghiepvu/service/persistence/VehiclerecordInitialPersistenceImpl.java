...
public class VehiclerecordInitialPersistenceImpl extends BasePersistenceImpl<VehiclerecordInitial>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_CN_CHN_EN = new FinderPath(VehiclerecordInitialModelImpl.ENTITY_CACHE_ENABLED,
			VehiclerecordInitialModelImpl.FINDER_CACHE_ENABLED,
			VehiclerecordInitialImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByCN_CHN_EN",
			new String[] {
			...
			VehiclerecordInitialModelImpl.CODENUMBER_COLUMN_BITMASK |
			VehiclerecordInitialModelImpl.CHASSISNUMBER_COLUMN_BITMASK |
			VehiclerecordInitialModelImpl.ENGINENUMBER_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_CN_CHN_EN = new FinderPath(VehiclerecordInitialModelImpl.ENTITY_CACHE_ENABLED,
			VehiclerecordInitialModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCN_CHN_EN",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName()
			});
	 ...
	 */
	@Override
	public VehiclerecordInitial findByCN_CHN_EN(long codeNumber,
		String chassisNumber, String engineNumber)
		throws NoSuchVehiclerecordInitialException, SystemException {
		VehiclerecordInitial vehiclerecordInitial = fetchByCN_CHN_EN(codeNumber,
		...
		if (vehiclerecordInitial == null) {
			...
			msg.append(", chassisNumber=");
			msg.append(chassisNumber);

			msg.append(", engineNumber=");
			msg.append(engineNumber);
	 ...
	 */
	@Override
	public VehiclerecordInitial fetchByCN_CHN_EN(long codeNumber,
		String chassisNumber, String engineNumber) throws SystemException {
		return fetchByCN_CHN_EN(codeNumber, chassisNumber, engineNumber, true);
	}
	...
	@Override
	public VehiclerecordInitial fetchByCN_CHN_EN(long codeNumber,
		String chassisNumber, String engineNumber, boolean retrieveFromCache)
		throws SystemException {
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_CN_CHN_EN,
					finderArgs, this);
		}
		...
		if (result instanceof VehiclerecordInitial) {
			...
			if ((codeNumber != vehiclerecordInitial.getCodeNumber()) ||
					!Validator.equals(chassisNumber,
						vehiclerecordInitial.getChassisNumber()) ||
					!Validator.equals(engineNumber,
						vehiclerecordInitial.getEngineNumber())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_CN_CHN_EN_CODENUMBER_2);

			boolean bindChassisNumber = false;

			if (chassisNumber == null) {
				query.append(_FINDER_COLUMN_CN_CHN_EN_CHASSISNUMBER_1);
			}
			else if (chassisNumber.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_CN_CHN_EN_CHASSISNUMBER_3);
			}
			else {
				bindChassisNumber = true;

				query.append(_FINDER_COLUMN_CN_CHN_EN_CHASSISNUMBER_2);
			}

			boolean bindEngineNumber = false;

			if (engineNumber == null) {
				query.append(_FINDER_COLUMN_CN_CHN_EN_ENGINENUMBER_1);
			}
			else if (engineNumber.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_CN_CHN_EN_ENGINENUMBER_3);
			}
			else {
				bindEngineNumber = true;

				query.append(_FINDER_COLUMN_CN_CHN_EN_ENGINENUMBER_2);
			}
			...
			try {
				...
				if (bindChassisNumber) {
					qPos.add(chassisNumber);
				}

				if (bindEngineNumber) {
					qPos.add(engineNumber);
				}

				List<VehiclerecordInitial> list = q.list();

				if (list.isEmpty()) {
					FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_CN_CHN_EN,
						finderArgs, list);
				}
				else {
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"VehiclerecordInitialPersistenceImpl.fetchByCN_CHN_EN(long, String, String, boolean) with parameters (" +
							StringUtil.merge(finderArgs) +
							") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
					}
					...
					if ((vehiclerecordInitial.getCodeNumber() != codeNumber) ||
							(vehiclerecordInitial.getChassisNumber() == null) ||
							!vehiclerecordInitial.getChassisNumber()
													 .equals(chassisNumber) ||
							(vehiclerecordInitial.getEngineNumber() == null) ||
							!vehiclerecordInitial.getEngineNumber()
													 .equals(engineNumber)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_CN_CHN_EN,
							finderArgs, vehiclerecordInitial);
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_CN_CHN_EN,
					finderArgs);
	 ...
	 */
	@Override
	public VehiclerecordInitial removeByCN_CHN_EN(long codeNumber,
		String chassisNumber, String engineNumber)
		throws NoSuchVehiclerecordInitialException, SystemException {
		VehiclerecordInitial vehiclerecordInitial = findByCN_CHN_EN(codeNumber,
				chassisNumber, engineNumber);
	 ...
	 */
	@Override
	public int countByCN_CHN_EN(long codeNumber, String chassisNumber,
		String engineNumber) throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_CN_CHN_EN;
	...
	private static final String _FINDER_COLUMN_CN_CHN_EN_CODENUMBER_2 = "vehiclerecordInitial.codeNumber = ? AND ";
	private static final String _FINDER_COLUMN_CN_CHN_EN_CHASSISNUMBER_1 = "vehiclerecordInitial.chassisNumber IS NULL AND ";
	private static final String _FINDER_COLUMN_CN_CHN_EN_CHASSISNUMBER_2 = "vehiclerecordInitial.chassisNumber = ? AND ";
	private static final String _FINDER_COLUMN_CN_CHN_EN_CHASSISNUMBER_3 = "(vehiclerecordInitial.chassisNumber IS NULL OR vehiclerecordInitial.chassisNumber = '') AND ";
	private static final String _FINDER_COLUMN_CN_CHN_EN_ENGINENUMBER_1 = "vehiclerecordInitial.engineNumber IS NULL";
	private static final String _FINDER_COLUMN_CN_CHN_EN_ENGINENUMBER_2 = "vehiclerecordInitial.engineNumber = ?";
	private static final String _FINDER_COLUMN_CN_CHN_EN_ENGINENUMBER_3 = "(vehiclerecordInitial.engineNumber IS NULL OR vehiclerecordInitial.engineNumber = '')";
	...
	protected void cacheUniqueFindersCache(
		...
		if (vehiclerecordInitial.isNew()) {
			...
			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_CN_CHN_EN, args,
				Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_CN_CHN_EN, args,
				vehiclerecordInitial);
		}
		else {
			...
			if ((vehiclerecordInitialModelImpl.getColumnBitmask() &
					FINDER_PATH_FETCH_BY_CN_CHN_EN.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						vehiclerecordInitial.getCodeNumber(),
						vehiclerecordInitial.getChassisNumber(),
						vehiclerecordInitial.getEngineNumber()
	...
	protected void clearUniqueFindersCache(
		...
		FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_CN_CHN_EN, args);
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_CN_CHN_EN, args);

		if ((vehiclerecordInitialModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_CN_CHN_EN.getColumnBitmask()) != 0) {
			args = new Object[] {
					vehiclerecordInitialModelImpl.getOriginalCodeNumber(),
					vehiclerecordInitialModelImpl.getOriginalChassisNumber(),
					vehiclerecordInitialModelImpl.getOriginalEngineNumber()
				};
	...
	protected VehiclerecordInitial toUnwrappedModel(
		...
		vehiclerecordInitialImpl.setSynchdate(vehiclerecordInitial.getSynchdate());
