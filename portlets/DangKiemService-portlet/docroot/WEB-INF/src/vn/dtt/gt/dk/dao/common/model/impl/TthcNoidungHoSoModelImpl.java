...
import vn.dtt.gt.dk.dao.common.model.TthcNoidungHoSoSoap;
...
public class TthcNoidungHoSoModelImpl extends BaseModelImpl<TthcNoidungHoSo>
	 ...
	 */
	public static TthcNoidungHoSo toModel(TthcNoidungHoSoSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		TthcNoidungHoSo model = new TthcNoidungHoSoImpl();
		...
		model.setNoiDungXml(soapModel.getNoiDungXml());
	 ...
	 */
	public static List<TthcNoidungHoSo> toModels(
		TthcNoidungHoSoSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<TthcNoidungHoSo> models = new ArrayList<TthcNoidungHoSo>(soapModels.length);

		for (TthcNoidungHoSoSoap soapModel : soapModels) {
	...
	public Object clone() {
		...
		tthcNoidungHoSoImpl.setVehicleRecordId(getVehicleRecordId());
	...
	public void resetOriginalValues() {
		...
		tthcNoidungHoSoModelImpl._originalVehicleRecordId = tthcNoidungHoSoModelImpl._vehicleRecordId;

		tthcNoidungHoSoModelImpl._setOriginalVehicleRecordId = false;
	...
	public CacheModel<TthcNoidungHoSo> toCacheModel() {
		...
		tthcNoidungHoSoCacheModel.vehicleRecordId = getVehicleRecordId();
