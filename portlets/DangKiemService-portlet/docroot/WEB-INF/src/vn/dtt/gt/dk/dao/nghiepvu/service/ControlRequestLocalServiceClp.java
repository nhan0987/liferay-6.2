 ...
 * @generated
 */
public class ControlRequestLocalServiceClp implements ControlRequestLocalService {
	public ControlRequestLocalServiceClp(
	...
	public vn.dtt.gt.dk.dao.nghiepvu.model.ControlRequest addControlRequest(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(controlRequest) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.gt.dk.dao.nghiepvu.model.ControlRequest)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.ControlRequest> getControlRequests(
		...
		return (java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.ControlRequest>)ClpSerializer.translateOutput(returnObj);
	}
