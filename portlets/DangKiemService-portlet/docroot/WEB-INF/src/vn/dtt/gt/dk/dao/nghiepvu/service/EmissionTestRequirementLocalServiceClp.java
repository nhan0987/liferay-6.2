 ...
 * @generated
 */
public class EmissionTestRequirementLocalServiceClp
	implements EmissionTestRequirementLocalService {
	public EmissionTestRequirementLocalServiceClp(
	...
	public vn.dtt.gt.dk.dao.nghiepvu.model.EmissionTestRequirement addEmissionTestRequirement(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(emissionTestRequirement)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.gt.dk.dao.nghiepvu.model.EmissionTestRequirement)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.EmissionTestRequirement> getEmissionTestRequirements(
		...
		return (java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.EmissionTestRequirement>)ClpSerializer.translateOutput(returnObj);
	}
