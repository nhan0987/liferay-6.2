...
import vn.dtt.gt.dk.dao.nghiepvu.service.SafetyTestRequestLocalService;
...
/**
 * Provides the base implementation for the safety test request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.SafetyTestRequestLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.SafetyTestRequestLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.SafetyTestRequestLocalServiceUtil
 * @generated
 */
public abstract class SafetyTestRequestLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SafetyTestRequestLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.SafetyTestRequestLocalServiceUtil} to access the safety test request local service.
	 */

	/**
	 * Adds the safety test request to the database. Also notifies the appropriate model listeners.
	 *
	 * @param safetyTestRequest the safety test request
	 * @return the safety test request that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SafetyTestRequest addSafetyTestRequest(
		SafetyTestRequest safetyTestRequest) throws SystemException {
		safetyTestRequest.setNew(true);

		return safetyTestRequestPersistence.update(safetyTestRequest);
	}
	 ...
	 */
	@Override
	public SafetyTestRequest createSafetyTestRequest(long id) {
		return safetyTestRequestPersistence.create(id);
	}

	/**
	 * Deletes the safety test request with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param id the primary key of the safety test request
	 * @return the safety test request that was removed
	 * @throws PortalException if a safety test request with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SafetyTestRequest deleteSafetyTestRequest(long id)
		throws PortalException, SystemException {
		return safetyTestRequestPersistence.remove(id);
	}

	/**
	 * Deletes the safety test request from the database. Also notifies the appropriate model listeners.
	 *
	 * @param safetyTestRequest the safety test request
	 * @return the safety test request that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SafetyTestRequest deleteSafetyTestRequest(
		SafetyTestRequest safetyTestRequest) throws SystemException {
		return safetyTestRequestPersistence.remove(safetyTestRequest);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SafetyTestRequest.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return safetyTestRequestPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return safetyTestRequestPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SafetyTestRequest fetchSafetyTestRequest(long id)
		throws SystemException {
		return safetyTestRequestPersistence.fetchByPrimaryKey(id);
	}

	/**
	 * Returns the safety test request with the primary key.
	 *
	 * @param id the primary key of the safety test request
	 ...
	 */
	@Override
	public SafetyTestRequest getSafetyTestRequest(long id)
		throws PortalException, SystemException {
		return safetyTestRequestPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return safetyTestRequestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SafetyTestRequest> getSafetyTestRequests(int start, int end)
		throws SystemException {
		return safetyTestRequestPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSafetyTestRequestsCount() throws SystemException {
		return safetyTestRequestPersistence.countAll();
	}

	/**
	 * Updates the safety test request in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param safetyTestRequest the safety test request
	 * @return the safety test request that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SafetyTestRequest updateSafetyTestRequest(
		SafetyTestRequest safetyTestRequest) throws SystemException {
		return safetyTestRequestPersistence.update(safetyTestRequest);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.SafetyTestRequest",
			safetyTestRequestLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.gt.dk.dao.nghiepvu.model.SafetyTestRequest");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = safetyTestRequestPersistence.getDataSource();
	...
	private SafetyTestRequestLocalServiceClpInvoker _clpInvoker = new SafetyTestRequestLocalServiceClpInvoker();
}