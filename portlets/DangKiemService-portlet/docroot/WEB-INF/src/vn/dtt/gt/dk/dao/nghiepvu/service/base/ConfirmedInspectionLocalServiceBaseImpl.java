...
import vn.dtt.gt.dk.dao.nghiepvu.service.ConfirmedInspectionLocalService;
...
/**
 * Provides the base implementation for the confirmed inspection local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.ConfirmedInspectionLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class ConfirmedInspectionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ConfirmedInspectionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.ConfirmedInspectionLocalServiceUtil} to access the confirmed inspection local service.
	 */
	...
	@Override
	public ConfirmedInspection addConfirmedInspection(
		ConfirmedInspection confirmedInspection) throws SystemException {
		confirmedInspection.setNew(true);

		return confirmedInspectionPersistence.update(confirmedInspection);
	}
	 ...
	 */
	@Override
	public ConfirmedInspection createConfirmedInspection(long id) {
		return confirmedInspectionPersistence.create(id);
	}
	...
	@Override
	public ConfirmedInspection deleteConfirmedInspection(long id)
		throws PortalException, SystemException {
		return confirmedInspectionPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ConfirmedInspection deleteConfirmedInspection(
		ConfirmedInspection confirmedInspection) throws SystemException {
		return confirmedInspectionPersistence.remove(confirmedInspection);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ConfirmedInspection.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return confirmedInspectionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return confirmedInspectionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ConfirmedInspection fetchConfirmedInspection(long id)
		throws SystemException {
		return confirmedInspectionPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public ConfirmedInspection getConfirmedInspection(long id)
		throws PortalException, SystemException {
		return confirmedInspectionPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return confirmedInspectionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ConfirmedInspection> getConfirmedInspections(int start, int end)
		throws SystemException {
		return confirmedInspectionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getConfirmedInspectionsCount() throws SystemException {
		return confirmedInspectionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ConfirmedInspection updateConfirmedInspection(
		ConfirmedInspection confirmedInspection) throws SystemException {
		return confirmedInspectionPersistence.update(confirmedInspection);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.ConfirmedInspection",
			confirmedInspectionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = confirmedInspectionPersistence.getDataSource();
	...
	private ConfirmedInspectionLocalServiceClpInvoker _clpInvoker = new ConfirmedInspectionLocalServiceClpInvoker();
}