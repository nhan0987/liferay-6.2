...
import vn.dtt.gt.dk.dao.nghiepvu.service.CustomsDeclarationLocalService;
...
/**
 * Provides the base implementation for the customs declaration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.CustomsDeclarationLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class CustomsDeclarationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CustomsDeclarationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.CustomsDeclarationLocalServiceUtil} to access the customs declaration local service.
	 */
	...
	@Override
	public CustomsDeclaration addCustomsDeclaration(
		CustomsDeclaration customsDeclaration) throws SystemException {
		customsDeclaration.setNew(true);

		return customsDeclarationPersistence.update(customsDeclaration);
	}
	 ...
	 */
	@Override
	public CustomsDeclaration createCustomsDeclaration(long id) {
		return customsDeclarationPersistence.create(id);
	}
	...
	@Override
	public CustomsDeclaration deleteCustomsDeclaration(long id)
		throws PortalException, SystemException {
		return customsDeclarationPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CustomsDeclaration deleteCustomsDeclaration(
		CustomsDeclaration customsDeclaration) throws SystemException {
		return customsDeclarationPersistence.remove(customsDeclaration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CustomsDeclaration.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return customsDeclarationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return customsDeclarationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CustomsDeclaration fetchCustomsDeclaration(long id)
		throws SystemException {
		return customsDeclarationPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public CustomsDeclaration getCustomsDeclaration(long id)
		throws PortalException, SystemException {
		return customsDeclarationPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return customsDeclarationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CustomsDeclaration> getCustomsDeclarations(int start, int end)
		throws SystemException {
		return customsDeclarationPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCustomsDeclarationsCount() throws SystemException {
		return customsDeclarationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CustomsDeclaration updateCustomsDeclaration(
		CustomsDeclaration customsDeclaration) throws SystemException {
		return customsDeclarationPersistence.update(customsDeclaration);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.CustomsDeclaration",
			customsDeclarationLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = customsDeclarationPersistence.getDataSource();
	...
	private CustomsDeclarationLocalServiceClpInvoker _clpInvoker = new CustomsDeclarationLocalServiceClpInvoker();
}