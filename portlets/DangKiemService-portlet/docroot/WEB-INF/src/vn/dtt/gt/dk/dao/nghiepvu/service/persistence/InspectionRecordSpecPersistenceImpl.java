...
public class InspectionRecordSpecPersistenceImpl extends BasePersistenceImpl<InspectionRecordSpec>
	...
	private static final String _FINDER_COLUMN_INSPECTIONRECORDID_INSPECTIONRECORDID_2 =
		"inspectionRecordSpec.inspectionRecordid = ?";
	public static final FinderPath FINDER_PATH_FETCH_BY_INSPECTIONRECORDID_SPECIFICATIONCODE =
		new FinderPath(InspectionRecordSpecModelImpl.ENTITY_CACHE_ENABLED,
			InspectionRecordSpecModelImpl.FINDER_CACHE_ENABLED,
			InspectionRecordSpecImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByInspectionRecordId_SpecificationCode",
			new String[] { Long.class.getName(), String.class.getName() },
			InspectionRecordSpecModelImpl.INSPECTIONRECORDID_COLUMN_BITMASK |
			InspectionRecordSpecModelImpl.SPECIFICATIONCODE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_INSPECTIONRECORDID_SPECIFICATIONCODE =
		new FinderPath(InspectionRecordSpecModelImpl.ENTITY_CACHE_ENABLED,
			InspectionRecordSpecModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByInspectionRecordId_SpecificationCode",
			new String[] { Long.class.getName(), String.class.getName() });
	 ...
	 */
	@Override
	public InspectionRecordSpec findByInspectionRecordId_SpecificationCode(
		long inspectionRecordid, String specificationCode)
		throws NoSuchInspectionRecordSpecException, SystemException {
		InspectionRecordSpec inspectionRecordSpec = fetchByInspectionRecordId_SpecificationCode(inspectionRecordid,
				specificationCode);
	 ...
	 */
	@Override
	public InspectionRecordSpec fetchByInspectionRecordId_SpecificationCode(
		long inspectionRecordid, String specificationCode)
		throws SystemException {
		return fetchByInspectionRecordId_SpecificationCode(inspectionRecordid,
	...
	public InspectionRecordSpec fetchByInspectionRecordId_SpecificationCode(
		...
		Object[] finderArgs = new Object[] { inspectionRecordid, specificationCode };

		Object result = null;

		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_INSPECTIONRECORDID_SPECIFICATIONCODE,
					finderArgs, this);
		}

		if (result instanceof InspectionRecordSpec) {
			InspectionRecordSpec inspectionRecordSpec = (InspectionRecordSpec)result;
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_INSPECTIONRECORDID_SPECIFICATIONCODE_INSPECTIONRECORDID_2);

			boolean bindSpecificationCode = false;

			if (specificationCode == null) {
				query.append(_FINDER_COLUMN_INSPECTIONRECORDID_SPECIFICATIONCODE_SPECIFICATIONCODE_1);
			}
			else if (specificationCode.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_INSPECTIONRECORDID_SPECIFICATIONCODE_SPECIFICATIONCODE_3);
			}
			else {
				bindSpecificationCode = true;

				query.append(_FINDER_COLUMN_INSPECTIONRECORDID_SPECIFICATIONCODE_SPECIFICATIONCODE_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_INSPECTIONRECORDID_SPECIFICATIONCODE,
						finderArgs, list);
				}
				else {
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"InspectionRecordSpecPersistenceImpl.fetchByInspectionRecordId_SpecificationCode(long, String, boolean) with parameters (" +
							StringUtil.merge(finderArgs) +
							") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
					}

					InspectionRecordSpec inspectionRecordSpec = list.get(0);

					result = inspectionRecordSpec;

					cacheResult(inspectionRecordSpec);

					if ((inspectionRecordSpec.getInspectionRecordid() != inspectionRecordid) ||
							(inspectionRecordSpec.getSpecificationCode() == null) ||
							!inspectionRecordSpec.getSpecificationCode()
													 .equals(specificationCode)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_INSPECTIONRECORDID_SPECIFICATIONCODE,
							finderArgs, inspectionRecordSpec);
					}
				}
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_INSPECTIONRECORDID_SPECIFICATIONCODE,
					finderArgs);
		...
		if (result instanceof List<?>) {
			...
			return (InspectionRecordSpec)result;
		}
	}
	 ...
	 */
	@Override
	public InspectionRecordSpec removeByInspectionRecordId_SpecificationCode(
		long inspectionRecordid, String specificationCode)
		throws NoSuchInspectionRecordSpecException, SystemException {
		InspectionRecordSpec inspectionRecordSpec = findByInspectionRecordId_SpecificationCode(inspectionRecordid,
				specificationCode);
	 ...
	 */
	@Override
	public int countByInspectionRecordId_SpecificationCode(
		long inspectionRecordid, String specificationCode)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_INSPECTIONRECORDID_SPECIFICATIONCODE;
	...
	private static final String _FINDER_COLUMN_INSPECTIONRECORDID_SPECIFICATIONCODE_INSPECTIONRECORDID_2 =
		"inspectionRecordSpec.inspectionRecordid = ? AND ";
	private static final String _FINDER_COLUMN_INSPECTIONRECORDID_SPECIFICATIONCODE_SPECIFICATIONCODE_1 =
		"inspectionRecordSpec.specificationCode IS NULL";
	private static final String _FINDER_COLUMN_INSPECTIONRECORDID_SPECIFICATIONCODE_SPECIFICATIONCODE_2 =
		"inspectionRecordSpec.specificationCode = ?";
	private static final String _FINDER_COLUMN_INSPECTIONRECORDID_SPECIFICATIONCODE_SPECIFICATIONCODE_3 =
		"(inspectionRecordSpec.specificationCode IS NULL OR inspectionRecordSpec.specificationCode = '')";
	...
	public void cacheResult(InspectionRecordSpec inspectionRecordSpec) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_INSPECTIONRECORDID_SPECIFICATIONCODE,
			new Object[] {
				inspectionRecordSpec.getInspectionRecordid(),
				inspectionRecordSpec.getSpecificationCode()
	...
	public void clearCache(InspectionRecordSpec inspectionRecordSpec) {
		...
		clearUniqueFindersCache(inspectionRecordSpec);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		if (inspectionRecordSpec.isNew()) {
			...
			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_INSPECTIONRECORDID_SPECIFICATIONCODE,
				args, Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_INSPECTIONRECORDID_SPECIFICATIONCODE,
				args, inspectionRecordSpec);
		}
		else {
			...
			if ((inspectionRecordSpecModelImpl.getColumnBitmask() &
					FINDER_PATH_FETCH_BY_INSPECTIONRECORDID_SPECIFICATIONCODE.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						inspectionRecordSpec.getInspectionRecordid(),
						inspectionRecordSpec.getSpecificationCode()
					};
	...
	protected void clearUniqueFindersCache(
		...
		FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_INSPECTIONRECORDID_SPECIFICATIONCODE,
			args);
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_INSPECTIONRECORDID_SPECIFICATIONCODE,
			args);
		...
		if ((inspectionRecordSpecModelImpl.getColumnBitmask() &
			...
			args = new Object[] {
					...
					inspectionRecordSpecModelImpl.getOriginalSpecificationCode()
				};
	...
	public InspectionRecordSpec updateImpl(
		...
		clearUniqueFindersCache(inspectionRecordSpec);
		cacheUniqueFindersCache(inspectionRecordSpec);
	...
	protected InspectionRecordSpec toUnwrappedModel(
		...
		inspectionRecordSpecImpl.setSynchdate(inspectionRecordSpec.getSynchdate());
