...
import vn.dtt.gt.dk.dao.nghiepvu.service.InspectionRecordAttachLocalService;
...
/**
 * Provides the base implementation for the inspection record attach local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.InspectionRecordAttachLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.InspectionRecordAttachLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.InspectionRecordAttachLocalServiceUtil
 * @generated
 */
public abstract class InspectionRecordAttachLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements InspectionRecordAttachLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.InspectionRecordAttachLocalServiceUtil} to access the inspection record attach local service.
	 */
	...
	@Override
	public InspectionRecordAttach addInspectionRecordAttach(
		InspectionRecordAttach inspectionRecordAttach)
		throws SystemException {
		inspectionRecordAttach.setNew(true);

		return inspectionRecordAttachPersistence.update(inspectionRecordAttach);
	}
	 ...
	 */
	@Override
	public InspectionRecordAttach createInspectionRecordAttach(long id) {
		return inspectionRecordAttachPersistence.create(id);
	}
	...
	@Override
	public InspectionRecordAttach deleteInspectionRecordAttach(long id)
		throws PortalException, SystemException {
		return inspectionRecordAttachPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public InspectionRecordAttach deleteInspectionRecordAttach(
		InspectionRecordAttach inspectionRecordAttach)
		throws SystemException {
		return inspectionRecordAttachPersistence.remove(inspectionRecordAttach);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(InspectionRecordAttach.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return inspectionRecordAttachPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return inspectionRecordAttachPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public InspectionRecordAttach fetchInspectionRecordAttach(long id)
		throws SystemException {
		return inspectionRecordAttachPersistence.fetchByPrimaryKey(id);
	}
	...
	public InspectionRecordAttach getInspectionRecordAttach(long id)
		throws PortalException, SystemException {
		return inspectionRecordAttachPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return inspectionRecordAttachPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<InspectionRecordAttach> getInspectionRecordAttachs(int start,
		int end) throws SystemException {
		return inspectionRecordAttachPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getInspectionRecordAttachsCount() throws SystemException {
		return inspectionRecordAttachPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public InspectionRecordAttach updateInspectionRecordAttach(
		InspectionRecordAttach inspectionRecordAttach)
		throws SystemException {
		return inspectionRecordAttachPersistence.update(inspectionRecordAttach);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.InspectionRecordAttach",
			inspectionRecordAttachLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = inspectionRecordAttachPersistence.getDataSource();
	...
	private InspectionRecordAttachLocalServiceClpInvoker _clpInvoker = new InspectionRecordAttachLocalServiceClpInvoker();
}