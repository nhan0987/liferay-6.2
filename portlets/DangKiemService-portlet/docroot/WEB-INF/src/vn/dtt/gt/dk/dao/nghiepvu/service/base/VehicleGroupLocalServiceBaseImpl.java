...
import vn.dtt.gt.dk.dao.nghiepvu.service.VehicleGroupLocalService;
...
/**
 * Provides the base implementation for the vehicle group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.VehicleGroupLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.VehicleGroupLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.VehicleGroupLocalServiceUtil
 * @generated
 */
public abstract class VehicleGroupLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VehicleGroupLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.VehicleGroupLocalServiceUtil} to access the vehicle group local service.
	 */
	...
	public VehicleGroup addVehicleGroup(VehicleGroup vehicleGroup)
		...
		return vehicleGroupPersistence.update(vehicleGroup);
	}
	 ...
	 */
	@Override
	public VehicleGroup createVehicleGroup(long id) {
		return vehicleGroupPersistence.create(id);
	}
	...
	@Override
	public VehicleGroup deleteVehicleGroup(long id)
		throws PortalException, SystemException {
		return vehicleGroupPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VehicleGroup deleteVehicleGroup(VehicleGroup vehicleGroup)
		throws SystemException {
		return vehicleGroupPersistence.remove(vehicleGroup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VehicleGroup.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return vehicleGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vehicleGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VehicleGroup fetchVehicleGroup(long id) throws SystemException {
		return vehicleGroupPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VehicleGroup getVehicleGroup(long id)
		throws PortalException, SystemException {
		return vehicleGroupPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vehicleGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VehicleGroup> getVehicleGroups(int start, int end)
		throws SystemException {
		return vehicleGroupPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVehicleGroupsCount() throws SystemException {
		return vehicleGroupPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VehicleGroup updateVehicleGroup(VehicleGroup vehicleGroup)
		throws SystemException {
		return vehicleGroupPersistence.update(vehicleGroup);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroup",
			vehicleGroupLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vehicleGroupPersistence.getDataSource();
	...
	private VehicleGroupLocalServiceClpInvoker _clpInvoker = new VehicleGroupLocalServiceClpInvoker();
}