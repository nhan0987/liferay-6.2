...
import vn.dtt.gt.dk.dao.nghiepvu.service.PaymentStatusLocalService;
...
/**
 * Provides the base implementation for the payment status local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.PaymentStatusLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class PaymentStatusLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PaymentStatusLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.PaymentStatusLocalServiceUtil} to access the payment status local service.
	 */
	...
	public PaymentStatus addPaymentStatus(PaymentStatus paymentStatus)
		...
		return paymentStatusPersistence.update(paymentStatus);
	}
	 ...
	 */
	@Override
	public PaymentStatus createPaymentStatus(long id) {
		return paymentStatusPersistence.create(id);
	}
	...
	@Override
	public PaymentStatus deletePaymentStatus(long id)
		throws PortalException, SystemException {
		return paymentStatusPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PaymentStatus deletePaymentStatus(PaymentStatus paymentStatus)
		throws SystemException {
		return paymentStatusPersistence.remove(paymentStatus);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PaymentStatus.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return paymentStatusPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return paymentStatusPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PaymentStatus fetchPaymentStatus(long id) throws SystemException {
		return paymentStatusPersistence.fetchByPrimaryKey(id);
	}
	...
	public PaymentStatus getPaymentStatus(long id)
		throws PortalException, SystemException {
		return paymentStatusPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return paymentStatusPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PaymentStatus> getPaymentStatuses(int start, int end)
		throws SystemException {
		return paymentStatusPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPaymentStatusesCount() throws SystemException {
		return paymentStatusPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.PaymentStatus",
			paymentStatusLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.gt.dk.dao.nghiepvu.model.PaymentStatus");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = paymentStatusPersistence.getDataSource();
	...
	private PaymentStatusLocalServiceClpInvoker _clpInvoker = new PaymentStatusLocalServiceClpInvoker();
}