...
public class ConfirmedInspectionPersistenceImpl extends BasePersistenceImpl<ConfirmedInspection>
	...
	private static final String _FINDER_COLUMN_REGISTEREDINSPECTIONID_REGISTEREDINSPECTIONID_2 =
		"confirmedInspection.registeredInspectionId = ?";
	public static final FinderPath FINDER_PATH_FETCH_BY_R_C = new FinderPath(ConfirmedInspectionModelImpl.ENTITY_CACHE_ENABLED,
			ConfirmedInspectionModelImpl.FINDER_CACHE_ENABLED,
			ConfirmedInspectionImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByR_C",
			new String[] { Long.class.getName(), Long.class.getName() },
			ConfirmedInspectionModelImpl.REGISTEREDINSPECTIONID_COLUMN_BITMASK |
			ConfirmedInspectionModelImpl.CONFIRMATIONCODE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_R_C = new FinderPath(ConfirmedInspectionModelImpl.ENTITY_CACHE_ENABLED,
			ConfirmedInspectionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByR_C",
			new String[] { Long.class.getName(), Long.class.getName() });
	 ...
	 */
	@Override
	public ConfirmedInspection findByR_C(long registeredInspectionId,
		long confirmationCode)
		throws NoSuchConfirmedInspectionException, SystemException {
		ConfirmedInspection confirmedInspection = fetchByR_C(registeredInspectionId,
				confirmationCode);
	 ...
	 */
	@Override
	public ConfirmedInspection fetchByR_C(long registeredInspectionId,
		long confirmationCode) throws SystemException {
		return fetchByR_C(registeredInspectionId, confirmationCode, true);
	}
	...
	@Override
	public ConfirmedInspection fetchByR_C(long registeredInspectionId,
		long confirmationCode, boolean retrieveFromCache)
		throws SystemException {
		Object[] finderArgs = new Object[] {
				registeredInspectionId, confirmationCode
			};

		Object result = null;

		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_R_C,
					finderArgs, this);
		}
		...
		if (result instanceof ConfirmedInspection) {
			...
			if ((registeredInspectionId != confirmedInspection.getRegisteredInspectionId()) ||
					(confirmationCode != confirmedInspection.getConfirmationCode())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_R_C_REGISTEREDINSPECTIONID_2);

			query.append(_FINDER_COLUMN_R_C_CONFIRMATIONCODE_2);
			...
			try {
				...
				qPos.add(confirmationCode);

				List<ConfirmedInspection> list = q.list();

				if (list.isEmpty()) {
					FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_R_C,
						finderArgs, list);
				}
				else {
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"ConfirmedInspectionPersistenceImpl.fetchByR_C(long, long, boolean) with parameters (" +
							StringUtil.merge(finderArgs) +
							") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
					}
					...
					if ((confirmedInspection.getRegisteredInspectionId() != registeredInspectionId) ||
							(confirmedInspection.getConfirmationCode() != confirmationCode)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_R_C,
							finderArgs, confirmedInspection);
					}
				}
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_R_C,
					finderArgs);
	 ...
	 */
	@Override
	public ConfirmedInspection removeByR_C(long registeredInspectionId,
		long confirmationCode)
		throws NoSuchConfirmedInspectionException, SystemException {
		ConfirmedInspection confirmedInspection = findByR_C(registeredInspectionId,
				confirmationCode);
	...
	public int countByR_C(long registeredInspectionId, long confirmationCode)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_R_C;
	...
	private static final String _FINDER_COLUMN_R_C_REGISTEREDINSPECTIONID_2 = "confirmedInspection.registeredInspectionId = ? AND ";
	private static final String _FINDER_COLUMN_R_C_CONFIRMATIONCODE_2 = "confirmedInspection.confirmationCode = ?";
	...
	public void cacheResult(ConfirmedInspection confirmedInspection) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_R_C,
			new Object[] {
				confirmedInspection.getRegisteredInspectionId(),
				confirmedInspection.getConfirmationCode()
			}, confirmedInspection);
	...
	protected void cacheUniqueFindersCache(
		...
		if (confirmedInspection.isNew()) {
			...
			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_R_C, args,
				Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_R_C, args,
				confirmedInspection);
		}
		else {
			...
			if ((confirmedInspectionModelImpl.getColumnBitmask() &
					FINDER_PATH_FETCH_BY_R_C.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						confirmedInspection.getRegisteredInspectionId(),
						confirmedInspection.getConfirmationCode()
					};
	...
	protected void clearUniqueFindersCache(
		...
		FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_R_C, args);
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_R_C, args);

		if ((confirmedInspectionModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_R_C.getColumnBitmask()) != 0) {
			args = new Object[] {
					confirmedInspectionModelImpl.getOriginalRegisteredInspectionId(),
					confirmedInspectionModelImpl.getOriginalConfirmationCode()
				};
	...
	protected ConfirmedInspection toUnwrappedModel(
		...
		confirmedInspectionImpl.setSynchdate(confirmedInspection.getSynchdate());
