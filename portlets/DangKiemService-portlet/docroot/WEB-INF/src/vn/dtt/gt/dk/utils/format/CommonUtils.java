...
public class CommonUtils {
	...
	public static String checkRole(User user) {
		...
		if(user != null) {
			try {
				List<Role> liRoles = user.getRoles();
	...
	public static String getNhomPhieuXuLyByUser(User user, long phanNhomHoSoId) {
		String liRoleSelected = CommonUtils.checkRole(user);
		
		List<TthcPhanNhomHoSoVaiTro> liTthcPhanNhomHoSoVaiTros = TthcPhanNhomHoSoVaiTroLocalServiceUtil
				.findTthcPhanNhomHoSoVaiTroByPhanNhomHoSoAndVaiTroXuLy(phanNhomHoSoId, liRoleSelected);
		
		return getNhomPhieuXuLy(liTthcPhanNhomHoSoVaiTros);
	}
