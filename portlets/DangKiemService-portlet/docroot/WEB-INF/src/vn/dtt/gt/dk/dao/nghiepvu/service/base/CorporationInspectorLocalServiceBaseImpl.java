...
import vn.dtt.gt.dk.dao.nghiepvu.service.CorporationInspectorLocalService;
...
/**
 * Provides the base implementation for the corporation inspector local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.CorporationInspectorLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class CorporationInspectorLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CorporationInspectorLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.CorporationInspectorLocalServiceUtil} to access the corporation inspector local service.
	 */
	...
	@Override
	public CorporationInspector addCorporationInspector(
		CorporationInspector corporationInspector) throws SystemException {
		corporationInspector.setNew(true);

		return corporationInspectorPersistence.update(corporationInspector);
	}
	 ...
	 */
	@Override
	public CorporationInspector createCorporationInspector(long id) {
		return corporationInspectorPersistence.create(id);
	}
	...
	@Override
	public CorporationInspector deleteCorporationInspector(long id)
		throws PortalException, SystemException {
		return corporationInspectorPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CorporationInspector deleteCorporationInspector(
		CorporationInspector corporationInspector) throws SystemException {
		return corporationInspectorPersistence.remove(corporationInspector);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CorporationInspector.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return corporationInspectorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return corporationInspectorPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CorporationInspector fetchCorporationInspector(long id)
		throws SystemException {
		return corporationInspectorPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public CorporationInspector getCorporationInspector(long id)
		throws PortalException, SystemException {
		return corporationInspectorPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return corporationInspectorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CorporationInspector> getCorporationInspectors(int start,
		int end) throws SystemException {
		return corporationInspectorPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCorporationInspectorsCount() throws SystemException {
		return corporationInspectorPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CorporationInspector updateCorporationInspector(
		CorporationInspector corporationInspector) throws SystemException {
		return corporationInspectorPersistence.update(corporationInspector);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector",
			corporationInspectorLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = corporationInspectorPersistence.getDataSource();
	...
	private CorporationInspectorLocalServiceClpInvoker _clpInvoker = new CorporationInspectorLocalServiceClpInvoker();
}