...
/**
 * Provides the local service utility for CorporationInspector. This utility wraps
 * {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.CorporationInspectorLocalServiceImpl} and is the
 ...
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.CorporationInspectorLocalServiceImpl
 * @generated
 */
public class CorporationInspectorLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.CorporationInspectorLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector addCorporationInspector(
		vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector corporationInspector)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addCorporationInspector(corporationInspector);
	}
	...
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector createCorporationInspector(
		long id) {
		return getService().createCorporationInspector(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector deleteCorporationInspector(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteCorporationInspector(id);
	}
	...
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector deleteCorporationInspector(
		vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector corporationInspector)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteCorporationInspector(corporationInspector);
	}
	...
	*/
	...
	public static vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector fetchCorporationInspector(
		long id) throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchCorporationInspector(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector getCorporationInspector(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getCorporationInspector(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector> getCorporationInspectors(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getCorporationInspectors(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getCorporationInspectorsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getCorporationInspectorsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector updateCorporationInspector(
		vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector corporationInspector)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateCorporationInspector(corporationInspector);
	}
	...
	*/
	...
	public static vn.dtt.gt.dk.dao.nghiepvu.model.CorporationInspector fetchByInspectorId(
		long inspectorid) {
		return getService().fetchByInspectorId(inspectorid);
	}
	...
	public static CorporationInspectorLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					CorporationInspectorLocalService.class.getName());

			if (invokableLocalService instanceof CorporationInspectorLocalService) {
				_service = (CorporationInspectorLocalService)invokableLocalService;
			}
			else {
				_service = new CorporationInspectorLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(CorporationInspectorLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(CorporationInspectorLocalService service) {
	}

	private static CorporationInspectorLocalService _service;
}