...
import vn.dtt.gt.dk.dao.nghiepvu.service.CorporationTeamLocalService;
...
/**
 * Provides the base implementation for the corporation team local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.CorporationTeamLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class CorporationTeamLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CorporationTeamLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.CorporationTeamLocalServiceUtil} to access the corporation team local service.
	 */
	...
	@Override
	public CorporationTeam addCorporationTeam(CorporationTeam corporationTeam)
		throws SystemException {
		corporationTeam.setNew(true);

		return corporationTeamPersistence.update(corporationTeam);
	}
	 ...
	 */
	@Override
	public CorporationTeam createCorporationTeam(long id) {
		return corporationTeamPersistence.create(id);
	}
	...
	@Override
	public CorporationTeam deleteCorporationTeam(long id)
		throws PortalException, SystemException {
		return corporationTeamPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CorporationTeam deleteCorporationTeam(
		CorporationTeam corporationTeam) throws SystemException {
		return corporationTeamPersistence.remove(corporationTeam);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CorporationTeam.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return corporationTeamPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return corporationTeamPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CorporationTeam fetchCorporationTeam(long id)
		throws SystemException {
		return corporationTeamPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public CorporationTeam getCorporationTeam(long id)
		throws PortalException, SystemException {
		return corporationTeamPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return corporationTeamPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CorporationTeam> getCorporationTeams(int start, int end)
		throws SystemException {
		return corporationTeamPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCorporationTeamsCount() throws SystemException {
		return corporationTeamPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CorporationTeam updateCorporationTeam(
		CorporationTeam corporationTeam) throws SystemException {
		return corporationTeamPersistence.update(corporationTeam);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.CorporationTeam",
			corporationTeamLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = corporationTeamPersistence.getDataSource();
	...
	private CorporationTeamLocalServiceClpInvoker _clpInvoker = new CorporationTeamLocalServiceClpInvoker();
}