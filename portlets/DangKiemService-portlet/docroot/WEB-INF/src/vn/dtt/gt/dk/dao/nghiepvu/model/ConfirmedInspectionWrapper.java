...
public class ConfirmedInspectionWrapper implements ConfirmedInspection,
	...
	*/
	...
	/**
	* Returns the synchdate of this confirmed inspection.
	*
	* @return the synchdate of this confirmed inspection
	*/
	@Override
	public java.util.Date getSynchdate() {
		return _confirmedInspection.getSynchdate();
	}

	/**
	* Sets the synchdate of this confirmed inspection.
	*
	* @param synchdate the synchdate of this confirmed inspection
	*/
	@Override
	public void setSynchdate(java.util.Date synchdate) {
		_confirmedInspection.setSynchdate(synchdate);
	}
