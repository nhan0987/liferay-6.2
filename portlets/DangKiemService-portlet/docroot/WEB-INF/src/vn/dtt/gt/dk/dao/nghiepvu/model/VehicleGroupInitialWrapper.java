...
public class VehicleGroupInitialWrapper implements VehicleGroupInitial,
	...
	*/
	...
	/**
	* Returns the synchdate of this vehicle group initial.
	*
	* @return the synchdate of this vehicle group initial
	*/
	@Override
	public java.util.Date getSynchdate() {
		return _vehicleGroupInitial.getSynchdate();
	}

	/**
	* Sets the synchdate of this vehicle group initial.
	*
	* @param synchdate the synchdate of this vehicle group initial
	*/
	@Override
	public void setSynchdate(java.util.Date synchdate) {
		_vehicleGroupInitial.setSynchdate(synchdate);
	}
