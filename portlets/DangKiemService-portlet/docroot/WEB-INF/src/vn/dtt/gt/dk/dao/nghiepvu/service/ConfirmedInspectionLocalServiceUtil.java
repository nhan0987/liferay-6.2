...
public class ConfirmedInspectionLocalServiceUtil {
	...
	*/
	...
	public static vn.dtt.gt.dk.dao.nghiepvu.model.ConfirmedInspection fetchByCorporationId(
		java.lang.String corporationId) {
		return getService().fetchByCorporationId(corporationId);
	}
	...
	public static java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.ConfirmedInspection> findByProvinceCode(
		...
		return getService().findByProvinceCode(quanHuyen, tinhThanh, quocGia);
	}
	...
	public static vn.dtt.gt.dk.dao.nghiepvu.model.ConfirmedInspection getByR_G(
		long registeredInspectionId, long confirmationCode)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getByR_G(registeredInspectionId, confirmationCode);
	}
