 ...
 * @author huymq
 */
public class TthcNoidungHoSoReadClp extends BaseModelImpl<TthcNoidungHoSoRead>
	implements TthcNoidungHoSoRead {
	public TthcNoidungHoSoReadClp() {
	}
	...
	public void setId(long Id) {
		...
		if (_tthcNoidungHoSoReadRemoteModel != null) {
			try {
				Class<?> clazz = _tthcNoidungHoSoReadRemoteModel.getClass();

				Method method = clazz.getMethod("setId", long.class);

				method.invoke(_tthcNoidungHoSoReadRemoteModel, Id);
			}
			catch (Exception e) {
	...
	public void setMaTuSinh(String MaTuSinh) {
		...
		if (_tthcNoidungHoSoReadRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoReadRemoteModel, MaTuSinh);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setHoSoThuTucId(long HoSoThuTucId) {
		...
		if (_tthcNoidungHoSoReadRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoReadRemoteModel, HoSoThuTucId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTenTaiLieu(String TenTaiLieu) {
		...
		if (_tthcNoidungHoSoReadRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoReadRemoteModel, TenTaiLieu);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTaiLieuDinhKem(long TaiLieuDinhKem) {
		...
		if (_tthcNoidungHoSoReadRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoReadRemoteModel, TaiLieuDinhKem);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNoiDungFile(String noiDungFile) {
		...
		if (_tthcNoidungHoSoReadRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoReadRemoteModel, noiDungFile);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setBieuMauHoSoId(long BieuMauHoSoId) {
		...
		if (_tthcNoidungHoSoReadRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoReadRemoteModel, BieuMauHoSoId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNgayGuiNhan(Date NgayGuiNhan) {
		...
		if (_tthcNoidungHoSoReadRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoReadRemoteModel, NgayGuiNhan);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setLoaiTaiLieu(long LoaiTaiLieu) {
		...
		if (_tthcNoidungHoSoReadRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoReadRemoteModel, LoaiTaiLieu);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNgayTao(Date NgayTao) {
		...
		if (_tthcNoidungHoSoReadRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoReadRemoteModel, NgayTao);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNguoiTao(long NguoiTao) {
		...
		if (_tthcNoidungHoSoReadRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoReadRemoteModel, NguoiTao);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setDaCapNhat(long daCapNhat) {
		...
		if (_tthcNoidungHoSoReadRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoReadRemoteModel, daCapNhat);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setLanGuiCuoi(long lanGuiCuoi) {
		...
		if (_tthcNoidungHoSoReadRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoReadRemoteModel, lanGuiCuoi);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setVehicleRecordId(long vehicleRecordId) {
		...
		if (_tthcNoidungHoSoReadRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoReadRemoteModel, vehicleRecordId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getTthcNoidungHoSoReadRemoteModel() {
		return _tthcNoidungHoSoReadRemoteModel;
	}

	public void setTthcNoidungHoSoReadRemoteModel(
		BaseModel<?> tthcNoidungHoSoReadRemoteModel) {
		_tthcNoidungHoSoReadRemoteModel = tthcNoidungHoSoReadRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _tthcNoidungHoSoReadRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_tthcNoidungHoSoReadRemoteModel,
	...
	public TthcNoidungHoSoRead toEscapedModel() {
		return (TthcNoidungHoSoRead)ProxyUtil.newProxyInstance(TthcNoidungHoSoRead.class.getClassLoader(),
			new Class[] { TthcNoidungHoSoRead.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		TthcNoidungHoSoReadClp clone = new TthcNoidungHoSoReadClp();
	...
	public int compareTo(TthcNoidungHoSoRead tthcNoidungHoSoRead) {
		...
		if (getId() < tthcNoidungHoSoRead.getId()) {
			value = -1;
		}
		else if (getId() > tthcNoidungHoSoRead.getId()) {
			value = 1;
		}
		else {
			value = 0;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof TthcNoidungHoSoReadClp)) {
			return false;
		}

		TthcNoidungHoSoReadClp tthcNoidungHoSoRead = (TthcNoidungHoSoReadClp)obj;

		long primaryKey = tthcNoidungHoSoRead.getPrimaryKey();
	...
	public String toXmlString() {
		...
		sb.append("vn.dtt.gt.dk.dao.common.model.TthcNoidungHoSoRead");
	...
	private BaseModel<?> _tthcNoidungHoSoReadRemoteModel;
}