...
public class CorporationAttendeeWrapper implements CorporationAttendee,
	...
	*/
	...
	/**
	* Returns the synchdate of this corporation attendee.
	*
	* @return the synchdate of this corporation attendee
	*/
	@Override
	public java.util.Date getSynchdate() {
		return _corporationAttendee.getSynchdate();
	}

	/**
	* Sets the synchdate of this corporation attendee.
	*
	* @param synchdate the synchdate of this corporation attendee
	*/
	@Override
	public void setSynchdate(java.util.Date synchdate) {
		_corporationAttendee.setSynchdate(synchdate);
	}
