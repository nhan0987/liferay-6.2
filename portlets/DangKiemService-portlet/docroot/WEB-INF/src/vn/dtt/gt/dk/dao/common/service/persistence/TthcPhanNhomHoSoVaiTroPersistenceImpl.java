...
import vn.dtt.gt.dk.dao.common.NoSuchTthcPhanNhomHoSoVaiTroException;
...
import vn.dtt.gt.dk.dao.common.model.impl.TthcPhanNhomHoSoVaiTroModelImpl;
...
public class TthcPhanNhomHoSoVaiTroPersistenceImpl extends BasePersistenceImpl<TthcPhanNhomHoSoVaiTro>
	...
	protected TthcPhanNhomHoSoVaiTro toUnwrappedModel(
		...
		tthcPhanNhomHoSoVaiTroImpl.setNhomPhieuXuLy(tthcPhanNhomHoSoVaiTro.getNhomPhieuXuLy());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.vn.dtt.gt.dk.dao.common.model.TthcPhanNhomHoSoVaiTro")));
	...
	private static Set<String> _badColumnNames = SetUtil.fromArray(new String[] {
				"Id", "PhanNhomHoSoId", "VaiTroXuLy", "nhomPhieuXuLy"
			});
