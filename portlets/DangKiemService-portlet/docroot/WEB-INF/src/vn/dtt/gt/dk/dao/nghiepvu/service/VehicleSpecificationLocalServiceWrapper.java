...
public class VehicleSpecificationLocalServiceWrapper
	...
	*/
	...
	public vn.dtt.gt.dk.dao.nghiepvu.model.VehicleSpecification findBySpecificationCode(
		...
		return _vehicleSpecificationLocalService.findBySpecificationCode(specificationCode);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.VehicleSpecification> findByInspectionRecordId(
		...
		return _vehicleSpecificationLocalService.findByInspectionRecordId(inspectionRecordId);
	}

	@Override
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.VehicleSpecification> findByVehicleGroupId(
		long vehicleGroupId) {
		return _vehicleSpecificationLocalService.findByVehicleGroupId(vehicleGroupId);
	}

	@Override
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.VehicleSpecification> finderVehicleSpecificationWithVehicleGroupId(
		long vehicleGroupId) {
		return _vehicleSpecificationLocalService.finderVehicleSpecificationWithVehicleGroupId(vehicleGroupId);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.VehicleSpecification> findByVehicleSpecificationWithVehicleGroupIdAndVehicleTypeCode(
		...
		return _vehicleSpecificationLocalService.findByVehicleSpecificationWithVehicleGroupIdAndVehicleTypeCode(vehiclegroupid,
	...
	public vn.dtt.gt.dk.dao.nghiepvu.model.VehicleSpecification findByVehicleGroupIdSpecificationCode(
		...
		return _vehicleSpecificationLocalService.findByVehicleGroupIdSpecificationCode(vehicleGroupId,
			specificationCode);
	}
	...
	public boolean deleteVehicleSpecificationInitialWithVehicleGroupId(
		long vehicleGroupId) {
		return _vehicleSpecificationLocalService.deleteVehicleSpecificationInitialWithVehicleGroupId(vehicleGroupId);
	}
