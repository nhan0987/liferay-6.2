...
import vn.dtt.gt.dk.dao.common.service.TthcNoidungHoSoReadService;
...
/**
 * Provides the base implementation for the tthc noidung ho so read remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.common.service.impl.TthcNoidungHoSoReadServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class TthcNoidungHoSoReadServiceBaseImpl extends BaseServiceImpl
	implements TthcNoidungHoSoReadService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.common.service.TthcNoidungHoSoReadServiceUtil} to access the tthc noidung ho so read remote service.
	 */
	...
	private TthcNoidungHoSoReadServiceClpInvoker _clpInvoker = new TthcNoidungHoSoReadServiceClpInvoker();
}