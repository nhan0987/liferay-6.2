	...
	public void setDebitnoteNumber(String debitnoteNumber) {
		...
		if (_tthcKeHoachChuyenDichRemoteModel != null) {
			try {
				...
				method.invoke(_tthcKeHoachChuyenDichRemoteModel, debitnoteNumber);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMessageFunction(String messageFunction) {
		...
		if (_tthcKeHoachChuyenDichRemoteModel != null) {
			try {
				...
				method.invoke(_tthcKeHoachChuyenDichRemoteModel, messageFunction);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMessageType(String messageType) {
		...
		if (_tthcKeHoachChuyenDichRemoteModel != null) {
			try {
				...
				method.invoke(_tthcKeHoachChuyenDichRemoteModel, messageType);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
