...
import vn.dtt.gt.dk.dao.nghiepvu.service.CertificateRecordSpecLocalService;
...
/**
 * Provides the base implementation for the certificate record spec local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.CertificateRecordSpecLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class CertificateRecordSpecLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CertificateRecordSpecLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.CertificateRecordSpecLocalServiceUtil} to access the certificate record spec local service.
	 */
	...
	@Override
	public CertificateRecordSpec addCertificateRecordSpec(
		CertificateRecordSpec certificateRecordSpec) throws SystemException {
		certificateRecordSpec.setNew(true);

		return certificateRecordSpecPersistence.update(certificateRecordSpec);
	}
	 ...
	 */
	@Override
	public CertificateRecordSpec createCertificateRecordSpec(long id) {
		return certificateRecordSpecPersistence.create(id);
	}
	...
	@Override
	public CertificateRecordSpec deleteCertificateRecordSpec(long id)
		throws PortalException, SystemException {
		return certificateRecordSpecPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CertificateRecordSpec deleteCertificateRecordSpec(
		CertificateRecordSpec certificateRecordSpec) throws SystemException {
		return certificateRecordSpecPersistence.remove(certificateRecordSpec);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CertificateRecordSpec.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return certificateRecordSpecPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return certificateRecordSpecPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CertificateRecordSpec fetchCertificateRecordSpec(long id)
		throws SystemException {
		return certificateRecordSpecPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public CertificateRecordSpec getCertificateRecordSpec(long id)
		throws PortalException, SystemException {
		return certificateRecordSpecPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return certificateRecordSpecPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CertificateRecordSpec> getCertificateRecordSpecs(int start,
		int end) throws SystemException {
		return certificateRecordSpecPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCertificateRecordSpecsCount() throws SystemException {
		return certificateRecordSpecPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CertificateRecordSpec updateCertificateRecordSpec(
		CertificateRecordSpec certificateRecordSpec) throws SystemException {
		return certificateRecordSpecPersistence.update(certificateRecordSpec);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.CertificateRecordSpec",
			certificateRecordSpecLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = certificateRecordSpecPersistence.getDataSource();
	...
	private CertificateRecordSpecLocalServiceClpInvoker _clpInvoker = new CertificateRecordSpecLocalServiceClpInvoker();
}