...
/**
 * Provides the local service interface for TthcKeHoachChuyenDich. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author huymq
 * @see TthcKeHoachChuyenDichLocalServiceUtil
...
public interface TthcKeHoachChuyenDichLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TthcKeHoachChuyenDichLocalServiceUtil} to access the tthc ke hoach chuyen dich local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.common.service.impl.TthcKeHoachChuyenDichLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
