...
public class CorporationViewLocalServiceClpInvoker {
	public CorporationViewLocalServiceClpInvoker() {
		...
		_methodName318 = "findByInspectorId";

		_methodParameterTypes318 = new String[] { "long" };

		_methodName319 = "findCorporationView";

		_methodParameterTypes319 = new String[] { "long", "int" };

		_methodName320 = "findCorporationView";

		_methodParameterTypes320 = new String[] { "long" };

		_methodName321 = "findByCorporationIdAndIsLeader";

		_methodParameterTypes321 = new String[] { "java.lang.String", "int" };

		_methodName322 = "findByCorporationId";

		_methodParameterTypes322 = new String[] { "java.lang.String" };

		_methodName323 = "findByDanhSachDangKiemVienTheoDoi";
