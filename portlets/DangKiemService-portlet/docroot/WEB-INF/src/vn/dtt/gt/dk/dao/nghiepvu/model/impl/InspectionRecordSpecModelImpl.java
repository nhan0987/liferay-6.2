...
public class InspectionRecordSpecModelImpl extends BaseModelImpl<InspectionRecordSpec>
	...
	public static final String TABLE_SQL_CREATE = "create table vr_inspectionrecordspec (id LONG not null primary key,inspectionrecordid LONG,specificationcode VARCHAR(75) null,specificationname VARCHAR(75) null,specificationvalue VARCHAR(75) null,evaluationresult LONG,synchdate DATE null)";
	...
	public Object clone() {
		...
		inspectionRecordSpecImpl.setSynchdate(getSynchdate());
	...
	public CacheModel<InspectionRecordSpec> toCacheModel() {
		...
		if (synchdate != null) {
			inspectionRecordSpecCacheModel.synchdate = synchdate.getTime();
		}
		else {
			inspectionRecordSpecCacheModel.synchdate = Long.MIN_VALUE;
		}
