...
public class CertificateRecordWrapper implements CertificateRecord,
	...
	*/
	...
	/**
	* Returns the synchdate of this certificate record.
	*
	* @return the synchdate of this certificate record
	*/
	@Override
	public java.util.Date getSynchdate() {
		return _certificateRecord.getSynchdate();
	}

	/**
	* Sets the synchdate of this certificate record.
	*
	* @param synchdate the synchdate of this certificate record
	*/
	@Override
	public void setSynchdate(java.util.Date synchdate) {
		_certificateRecord.setSynchdate(synchdate);
	}
