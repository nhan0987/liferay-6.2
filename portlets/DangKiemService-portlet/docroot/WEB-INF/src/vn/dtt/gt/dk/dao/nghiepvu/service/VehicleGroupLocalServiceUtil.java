...
/**
 * Provides the local service utility for VehicleGroup. This utility wraps
 * {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.VehicleGroupLocalServiceImpl} and is the
 ...
 * @generated
 */
public class VehicleGroupLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.VehicleGroupLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroup addVehicleGroup(
		vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroup vehicleGroup)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addVehicleGroup(vehicleGroup);
	}
	...
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroup createVehicleGroup(
		long id) {
		return getService().createVehicleGroup(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroup deleteVehicleGroup(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteVehicleGroup(id);
	}
	...
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroup deleteVehicleGroup(
		vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroup vehicleGroup)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteVehicleGroup(vehicleGroup);
	}
	...
	*/
	...
	public static vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroup fetchVehicleGroup(
		long id) throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchVehicleGroup(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroup getVehicleGroup(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getVehicleGroup(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroup> getVehicleGroups(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getVehicleGroups(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getVehicleGroupsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getVehicleGroupsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroup updateVehicleGroup(
		vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroup vehicleGroup)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateVehicleGroup(vehicleGroup);
	}
	...
	*/
	...
	public static vn.dtt.gt.dk.dao.common.model.TthcNoidungHoSo getThtcNoiDungHoSoByVehicleGroupId(
		long vehicleGroupId) {
		return getService().getThtcNoiDungHoSoByVehicleGroupId(vehicleGroupId);
	}
	...
	public static java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroup> findByTechnicalSpecCode(
		...
		return getService().findByTechnicalSpecCode(technicalSpecCode);
	}
	...
	public static java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroup> findByIdHoSoThuTuc(
		long idHoSoThuTuc) {
		return getService().findByIdHoSoThuTuc(idHoSoThuTuc);
	}
	...
	public static VehicleGroupLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					VehicleGroupLocalService.class.getName());

			if (invokableLocalService instanceof VehicleGroupLocalService) {
				_service = (VehicleGroupLocalService)invokableLocalService;
			}
			else {
				_service = new VehicleGroupLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(VehicleGroupLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(VehicleGroupLocalService service) {
	}

	private static VehicleGroupLocalService _service;
}