 ...
 * @generated
 */
public class CfgTechnicalspecServiceClp implements CfgTechnicalspecService {
	public CfgTechnicalspecServiceClp(InvokableService invokableService) {
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.CfgTechnicalspec> getBySynchDate(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName8,
					...
					new Object[] {
						ClpSerializer.translateInput(validatefrom),
