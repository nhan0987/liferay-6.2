...
/**
 * Provides the local service utility for DebitNote. This utility wraps
 * {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.DebitNoteLocalServiceImpl} and is the
 ...
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.DebitNoteLocalServiceImpl
 * @generated
 */
public class DebitNoteLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.DebitNoteLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.DebitNote addDebitNote(
		vn.dtt.gt.dk.dao.nghiepvu.model.DebitNote debitNote)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addDebitNote(debitNote);
	}
	...
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.DebitNote createDebitNote(
		long id) {
		return getService().createDebitNote(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.DebitNote deleteDebitNote(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteDebitNote(id);
	}
	...
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.DebitNote deleteDebitNote(
		vn.dtt.gt.dk.dao.nghiepvu.model.DebitNote debitNote)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteDebitNote(debitNote);
	}
	...
	*/
	...
	public static vn.dtt.gt.dk.dao.nghiepvu.model.DebitNote fetchDebitNote(
		long id) throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchDebitNote(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.DebitNote getDebitNote(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getDebitNote(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.DebitNote> getDebitNotes(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getDebitNotes(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getDebitNotesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getDebitNotesCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.nghiepvu.model.DebitNote updateDebitNote(
		vn.dtt.gt.dk.dao.nghiepvu.model.DebitNote debitNote)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateDebitNote(debitNote);
	}
	...
	*/
	...
	public static java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.DebitNote> findByMarkAsDeleted(
		int markAsDeleted) {
		return getService().findByMarkAsDeleted(markAsDeleted);
	}

	public static java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.DebitNote> findByMarkAsDeleted(
		int markAsDeleted, int start, int end) {
		return getService().findByMarkAsDeleted(markAsDeleted, start, end);
	}

	public static int countByMarkAsDeleted(int markAsDeleted) {
		return getService().countByMarkAsDeleted(markAsDeleted);
	}
	...
	public static java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.DebitNote> findDebitNote(
		...
		return getService().findDebitNote(data, start, end);
	}

	public static int countDebitNote(java.lang.String data) {
		return getService().countDebitNote(data);
	}
	...
	public static int countThongKeDebitNotePAID(java.lang.String data,
		...
		return getService().countThongKeDebitNotePAID(data, ngayXacNhanThanhToan);
	}

	public static java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.DebitNote> findDebitNotePAID(
		java.lang.String data, int start, int end) {
		return getService().findDebitNotePAID(data, start, end);
	}

	public static int countDebitNotePAID(java.lang.String data) {
		return getService().countDebitNotePAID(data);
	}
	...
	public static DebitNoteLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					DebitNoteLocalService.class.getName());

			if (invokableLocalService instanceof DebitNoteLocalService) {
				_service = (DebitNoteLocalService)invokableLocalService;
			}
			else {
				_service = new DebitNoteLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(DebitNoteLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(DebitNoteLocalService service) {
	}

	private static DebitNoteLocalService _service;
}