...
public class InspectionCommonStatusModelImpl extends BaseModelImpl<InspectionCommonStatus>
	...
	public Object clone() {
		...
		inspectionCommonStatusImpl.setSynchdate(getSynchdate());
	...
	public CacheModel<InspectionCommonStatus> toCacheModel() {
		...
		if (synchdate != null) {
			inspectionCommonStatusCacheModel.synchdate = synchdate.getTime();
		}
		else {
			inspectionCommonStatusCacheModel.synchdate = Long.MIN_VALUE;
		}
