...
public class DebitNotePersistenceImpl extends BasePersistenceImpl<DebitNote>
	...
	protected DebitNote toUnwrappedModel(DebitNote debitNote) {
		...
		debitNoteImpl.setCorporationId(debitNote.getCorporationId());
		debitNoteImpl.setFinancialAccountant(debitNote.getFinancialAccountant());
	...
	private static Set<String> _badColumnNames = SetUtil.fromArray(new String[] {
				"debitNoteNumber", "transactionId", "corporationId",
				"financialAccountant", "reportBy", "reportDate", "fromDate",
				"toDate", "attachedFile", "totalPayment", "paymentType",
				"markAsDeleted"
			});
