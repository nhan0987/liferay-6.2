...
/**
 * Provides the local service interface for PhanCongDonViKiemTra. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author huymq
 * @see PhanCongDonViKiemTraLocalServiceUtil
...
public interface PhanCongDonViKiemTraLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PhanCongDonViKiemTraLocalServiceUtil} to access the phan cong don vi kiem tra local service. Add custom service methods to {@link vn.dtt.gt.dk.dao.motcua.service.impl.PhanCongDonViKiemTraLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
