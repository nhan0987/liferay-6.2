...
public class CertificateRecordSpecPersistenceImpl extends BasePersistenceImpl<CertificateRecordSpec>
	...
	private static final String _FINDER_COLUMN_CERTIFICATERECORDID_CERTIFICATERECORDID_2 =
		"certificateRecordSpec.certificateRecordId = ?";
	public static final FinderPath FINDER_PATH_FETCH_BY_CERTIFICATERECORDIDANDSPECIFICATIONCODE =
		new FinderPath(CertificateRecordSpecModelImpl.ENTITY_CACHE_ENABLED,
			CertificateRecordSpecModelImpl.FINDER_CACHE_ENABLED,
			CertificateRecordSpecImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByCertificateRecordIdAndSpecificationCode",
			new String[] { Long.class.getName(), String.class.getName() },
			CertificateRecordSpecModelImpl.CERTIFICATERECORDID_COLUMN_BITMASK |
			CertificateRecordSpecModelImpl.SPECIFICATIONCODE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_CERTIFICATERECORDIDANDSPECIFICATIONCODE =
		new FinderPath(CertificateRecordSpecModelImpl.ENTITY_CACHE_ENABLED,
			CertificateRecordSpecModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByCertificateRecordIdAndSpecificationCode",
			new String[] { Long.class.getName(), String.class.getName() });
	 ...
	 */
	@Override
	public CertificateRecordSpec findByCertificateRecordIdAndSpecificationCode(
		long certificateRecordId, String specificationCode)
		throws NoSuchCertificateRecordSpecException, SystemException {
		CertificateRecordSpec certificateRecordSpec = fetchByCertificateRecordIdAndSpecificationCode(certificateRecordId,
				specificationCode);
	 ...
	 */
	@Override
	public CertificateRecordSpec fetchByCertificateRecordIdAndSpecificationCode(
		long certificateRecordId, String specificationCode)
		throws SystemException {
		return fetchByCertificateRecordIdAndSpecificationCode(certificateRecordId,
	...
	public CertificateRecordSpec fetchByCertificateRecordIdAndSpecificationCode(
		...
		Object[] finderArgs = new Object[] {
				certificateRecordId, specificationCode
			};

		Object result = null;

		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_CERTIFICATERECORDIDANDSPECIFICATIONCODE,
					finderArgs, this);
		}

		if (result instanceof CertificateRecordSpec) {
			CertificateRecordSpec certificateRecordSpec = (CertificateRecordSpec)result;
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_CERTIFICATERECORDIDANDSPECIFICATIONCODE_CERTIFICATERECORDID_2);

			boolean bindSpecificationCode = false;

			if (specificationCode == null) {
				query.append(_FINDER_COLUMN_CERTIFICATERECORDIDANDSPECIFICATIONCODE_SPECIFICATIONCODE_1);
			}
			else if (specificationCode.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_CERTIFICATERECORDIDANDSPECIFICATIONCODE_SPECIFICATIONCODE_3);
			}
			else {
				bindSpecificationCode = true;

				query.append(_FINDER_COLUMN_CERTIFICATERECORDIDANDSPECIFICATIONCODE_SPECIFICATIONCODE_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_CERTIFICATERECORDIDANDSPECIFICATIONCODE,
						finderArgs, list);
				}
				else {
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"CertificateRecordSpecPersistenceImpl.fetchByCertificateRecordIdAndSpecificationCode(long, String, boolean) with parameters (" +
							StringUtil.merge(finderArgs) +
							") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
					}

					CertificateRecordSpec certificateRecordSpec = list.get(0);

					result = certificateRecordSpec;

					cacheResult(certificateRecordSpec);

					if ((certificateRecordSpec.getCertificateRecordId() != certificateRecordId) ||
							(certificateRecordSpec.getSpecificationCode() == null) ||
							!certificateRecordSpec.getSpecificationCode()
													  .equals(specificationCode)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_CERTIFICATERECORDIDANDSPECIFICATIONCODE,
							finderArgs, certificateRecordSpec);
					}
				}
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_CERTIFICATERECORDIDANDSPECIFICATIONCODE,
					finderArgs);
		...
		if (result instanceof List<?>) {
			...
			return (CertificateRecordSpec)result;
		}
	}
	 ...
	 */
	@Override
	public CertificateRecordSpec removeByCertificateRecordIdAndSpecificationCode(
		long certificateRecordId, String specificationCode)
		throws NoSuchCertificateRecordSpecException, SystemException {
		CertificateRecordSpec certificateRecordSpec = findByCertificateRecordIdAndSpecificationCode(certificateRecordId,
				specificationCode);
	 ...
	 */
	@Override
	public int countByCertificateRecordIdAndSpecificationCode(
		long certificateRecordId, String specificationCode)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_CERTIFICATERECORDIDANDSPECIFICATIONCODE;
	...
	private static final String _FINDER_COLUMN_CERTIFICATERECORDIDANDSPECIFICATIONCODE_CERTIFICATERECORDID_2 =
		"certificateRecordSpec.certificateRecordId = ? AND ";
	private static final String _FINDER_COLUMN_CERTIFICATERECORDIDANDSPECIFICATIONCODE_SPECIFICATIONCODE_1 =
		"certificateRecordSpec.specificationCode IS NULL";
	private static final String _FINDER_COLUMN_CERTIFICATERECORDIDANDSPECIFICATIONCODE_SPECIFICATIONCODE_2 =
		"certificateRecordSpec.specificationCode = ?";
	private static final String _FINDER_COLUMN_CERTIFICATERECORDIDANDSPECIFICATIONCODE_SPECIFICATIONCODE_3 =
		"(certificateRecordSpec.specificationCode IS NULL OR certificateRecordSpec.specificationCode = '')";
	...
	public void cacheResult(CertificateRecordSpec certificateRecordSpec) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_CERTIFICATERECORDIDANDSPECIFICATIONCODE,
			new Object[] {
				certificateRecordSpec.getCertificateRecordId(),
				certificateRecordSpec.getSpecificationCode()
	...
	public void clearCache(CertificateRecordSpec certificateRecordSpec) {
		...
		clearUniqueFindersCache(certificateRecordSpec);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		if (certificateRecordSpec.isNew()) {
			...
			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_CERTIFICATERECORDIDANDSPECIFICATIONCODE,
				args, Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_CERTIFICATERECORDIDANDSPECIFICATIONCODE,
				args, certificateRecordSpec);
		}
		else {
			...
			if ((certificateRecordSpecModelImpl.getColumnBitmask() &
					FINDER_PATH_FETCH_BY_CERTIFICATERECORDIDANDSPECIFICATIONCODE.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						certificateRecordSpec.getCertificateRecordId(),
						certificateRecordSpec.getSpecificationCode()
					};
	...
	protected void clearUniqueFindersCache(
		...
		FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_CERTIFICATERECORDIDANDSPECIFICATIONCODE,
			args);
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_CERTIFICATERECORDIDANDSPECIFICATIONCODE,
			args);
		...
		if ((certificateRecordSpecModelImpl.getColumnBitmask() &
			...
			args = new Object[] {
					...
					certificateRecordSpecModelImpl.getOriginalSpecificationCode()
				};
	...
	public CertificateRecordSpec updateImpl(
		...
		clearUniqueFindersCache(certificateRecordSpec);
		cacheUniqueFindersCache(certificateRecordSpec);
	...
	protected CertificateRecordSpec toUnwrappedModel(
		...
		certificateRecordSpecImpl.setSynchdate(certificateRecordSpec.getSynchdate());
