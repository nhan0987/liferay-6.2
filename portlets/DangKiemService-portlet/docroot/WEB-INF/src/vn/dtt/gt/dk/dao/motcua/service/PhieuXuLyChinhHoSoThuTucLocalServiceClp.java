 ...
 * @generated
 */
public class PhieuXuLyChinhHoSoThuTucLocalServiceClp
	implements PhieuXuLyChinhHoSoThuTucLocalService {
	public PhieuXuLyChinhHoSoThuTucLocalServiceClp(
	...
	public vn.dtt.gt.dk.dao.motcua.model.PhieuXuLyChinhHoSoThuTuc addPhieuXuLyChinhHoSoThuTuc(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(phieuXuLyChinhHoSoThuTuc)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.gt.dk.dao.motcua.model.PhieuXuLyChinhHoSoThuTuc)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.motcua.model.PhieuXuLyChinhHoSoThuTuc> getPhieuXuLyChinhHoSoThuTucs(
		...
		return (java.util.List<vn.dtt.gt.dk.dao.motcua.model.PhieuXuLyChinhHoSoThuTuc>)ClpSerializer.translateOutput(returnObj);
	}
