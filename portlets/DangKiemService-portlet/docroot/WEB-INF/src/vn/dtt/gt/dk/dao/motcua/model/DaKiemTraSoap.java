...
/**
 * This class is used by SOAP remote services, specifically {@link vn.dtt.gt.dk.dao.motcua.service.http.DaKiemTraServiceSoap}.
 *
 * @author huymq
 * @see vn.dtt.gt.dk.dao.motcua.service.http.DaKiemTraServiceSoap
 * @generated
 */
public class DaKiemTraSoap implements Serializable {
	public static DaKiemTraSoap toSoapModel(DaKiemTra model) {
		DaKiemTraSoap soapModel = new DaKiemTraSoap();
	...
	public static DaKiemTraSoap[] toSoapModels(DaKiemTra[] models) {
		DaKiemTraSoap[] soapModels = new DaKiemTraSoap[models.length];
	...
	public static DaKiemTraSoap[][] toSoapModels(DaKiemTra[][] models) {
		DaKiemTraSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new DaKiemTraSoap[models.length][models[0].length];
		}
		else {
			soapModels = new DaKiemTraSoap[0][0];
		}
	...
	public static DaKiemTraSoap[] toSoapModels(List<DaKiemTra> models) {
		List<DaKiemTraSoap> soapModels = new ArrayList<DaKiemTraSoap>(models.size());

		for (DaKiemTra model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new DaKiemTraSoap[soapModels.size()]);
	}

	public DaKiemTraSoap() {
	}
