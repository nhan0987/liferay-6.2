...
public class VehicleStatisticsWrapper implements VehicleStatistics,
	...
	*/
	...
	/**
	* Returns the synchdate of this vehicle statistics.
	*
	* @return the synchdate of this vehicle statistics
	*/
	@Override
	public java.util.Date getSynchdate() {
		return _vehicleStatistics.getSynchdate();
	}

	/**
	* Sets the synchdate of this vehicle statistics.
	*
	* @param synchdate the synchdate of this vehicle statistics
	*/
	@Override
	public void setSynchdate(java.util.Date synchdate) {
		_vehicleStatistics.setSynchdate(synchdate);
	}
