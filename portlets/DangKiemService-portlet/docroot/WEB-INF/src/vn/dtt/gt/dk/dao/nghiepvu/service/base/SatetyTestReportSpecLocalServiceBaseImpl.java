...
import vn.dtt.gt.dk.dao.nghiepvu.service.SatetyTestReportSpecLocalService;
...
/**
 * Provides the base implementation for the satety test report spec local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.SatetyTestReportSpecLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.SatetyTestReportSpecLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.SatetyTestReportSpecLocalServiceUtil
 * @generated
 */
public abstract class SatetyTestReportSpecLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SatetyTestReportSpecLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.SatetyTestReportSpecLocalServiceUtil} to access the satety test report spec local service.
	 */
	...
	@Override
	public SatetyTestReportSpec addSatetyTestReportSpec(
		SatetyTestReportSpec satetyTestReportSpec) throws SystemException {
		satetyTestReportSpec.setNew(true);

		return satetyTestReportSpecPersistence.update(satetyTestReportSpec);
	}
	 ...
	 */
	@Override
	public SatetyTestReportSpec createSatetyTestReportSpec(long id) {
		return satetyTestReportSpecPersistence.create(id);
	}
	...
	@Override
	public SatetyTestReportSpec deleteSatetyTestReportSpec(long id)
		throws PortalException, SystemException {
		return satetyTestReportSpecPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SatetyTestReportSpec deleteSatetyTestReportSpec(
		SatetyTestReportSpec satetyTestReportSpec) throws SystemException {
		return satetyTestReportSpecPersistence.remove(satetyTestReportSpec);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SatetyTestReportSpec.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return satetyTestReportSpecPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return satetyTestReportSpecPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SatetyTestReportSpec fetchSatetyTestReportSpec(long id)
		throws SystemException {
		return satetyTestReportSpecPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public SatetyTestReportSpec getSatetyTestReportSpec(long id)
		throws PortalException, SystemException {
		return satetyTestReportSpecPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return satetyTestReportSpecPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SatetyTestReportSpec> getSatetyTestReportSpecs(int start,
		int end) throws SystemException {
		return satetyTestReportSpecPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSatetyTestReportSpecsCount() throws SystemException {
		return satetyTestReportSpecPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SatetyTestReportSpec updateSatetyTestReportSpec(
		SatetyTestReportSpec satetyTestReportSpec) throws SystemException {
		return satetyTestReportSpecPersistence.update(satetyTestReportSpec);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.SatetyTestReportSpec",
			satetyTestReportSpecLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = satetyTestReportSpecPersistence.getDataSource();
	...
	private SatetyTestReportSpecLocalServiceClpInvoker _clpInvoker = new SatetyTestReportSpecLocalServiceClpInvoker();
}