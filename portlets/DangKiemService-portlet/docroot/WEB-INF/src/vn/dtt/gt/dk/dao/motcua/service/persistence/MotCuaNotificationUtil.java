 ...
 * @generated
 */
public class MotCuaNotificationUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(MotCuaNotification motCuaNotification) {
		getPersistence().clearCache(motCuaNotification);
	}
	 ...
	 */
	public static List<MotCuaNotification> findWithDynamicQuery(
	 ...
	 */
	public static MotCuaNotification update(
		MotCuaNotification motCuaNotification) throws SystemException {
		return getPersistence().update(motCuaNotification);
	}
	 ...
	 */
	public static MotCuaNotification update(
		MotCuaNotification motCuaNotification, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(motCuaNotification, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(motCuaNotification);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(motCuaNotifications);
	}
	...
	*/
	public static vn.dtt.gt.dk.dao.motcua.model.MotCuaNotification create(
		long id) {
	...
	*/
	public static vn.dtt.gt.dk.dao.motcua.model.MotCuaNotification remove(
		long id)
	...
	public static vn.dtt.gt.dk.dao.motcua.model.MotCuaNotification updateImpl(
		vn.dtt.gt.dk.dao.motcua.model.MotCuaNotification motCuaNotification)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(motCuaNotification);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.motcua.model.MotCuaNotification findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.gt.dk.dao.motcua.NoSuchMotCuaNotificationException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.gt.dk.dao.motcua.model.MotCuaNotification fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.gt.dk.dao.motcua.model.MotCuaNotification> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static MotCuaNotificationPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (MotCuaNotificationPersistence)PortletBeanLocatorUtil.locate(vn.dtt.gt.dk.dao.motcua.service.ClpSerializer.getServletContextName(),
					MotCuaNotificationPersistence.class.getName());

			ReferenceRegistry.registerReference(MotCuaNotificationUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(MotCuaNotificationPersistence persistence) {
	}

	private static MotCuaNotificationPersistence _persistence;
}