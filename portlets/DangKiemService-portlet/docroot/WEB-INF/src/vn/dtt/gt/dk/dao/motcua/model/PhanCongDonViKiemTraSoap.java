...
/**
 * This class is used by SOAP remote services, specifically {@link vn.dtt.gt.dk.dao.motcua.service.http.PhanCongDonViKiemTraServiceSoap}.
 *
 * @author huymq
 * @see vn.dtt.gt.dk.dao.motcua.service.http.PhanCongDonViKiemTraServiceSoap
 * @generated
 */
public class PhanCongDonViKiemTraSoap implements Serializable {
	public static PhanCongDonViKiemTraSoap toSoapModel(
		PhanCongDonViKiemTra model) {
		PhanCongDonViKiemTraSoap soapModel = new PhanCongDonViKiemTraSoap();
	...
	public static PhanCongDonViKiemTraSoap[] toSoapModels(
		PhanCongDonViKiemTra[] models) {
		PhanCongDonViKiemTraSoap[] soapModels = new PhanCongDonViKiemTraSoap[models.length];
	...
	public static PhanCongDonViKiemTraSoap[][] toSoapModels(
		PhanCongDonViKiemTra[][] models) {
		PhanCongDonViKiemTraSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new PhanCongDonViKiemTraSoap[models.length][models[0].length];
		}
		else {
			soapModels = new PhanCongDonViKiemTraSoap[0][0];
		}
	...
	public static PhanCongDonViKiemTraSoap[] toSoapModels(
		List<PhanCongDonViKiemTra> models) {
		List<PhanCongDonViKiemTraSoap> soapModels = new ArrayList<PhanCongDonViKiemTraSoap>(models.size());

		for (PhanCongDonViKiemTra model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new PhanCongDonViKiemTraSoap[soapModels.size()]);
	}

	public PhanCongDonViKiemTraSoap() {
	}
