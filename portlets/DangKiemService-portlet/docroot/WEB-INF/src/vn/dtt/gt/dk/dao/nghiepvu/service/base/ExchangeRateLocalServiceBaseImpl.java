...
import vn.dtt.gt.dk.dao.nghiepvu.service.ExchangeRateLocalService;
...
/**
 * Provides the base implementation for the exchange rate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.ExchangeRateLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class ExchangeRateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ExchangeRateLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.ExchangeRateLocalServiceUtil} to access the exchange rate local service.
	 */
	...
	public ExchangeRate addExchangeRate(ExchangeRate exchangeRate)
		...
		return exchangeRatePersistence.update(exchangeRate);
	}
	 ...
	 */
	@Override
	public ExchangeRate createExchangeRate(long id) {
		return exchangeRatePersistence.create(id);
	}
	...
	@Override
	public ExchangeRate deleteExchangeRate(long id)
		throws PortalException, SystemException {
		return exchangeRatePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ExchangeRate deleteExchangeRate(ExchangeRate exchangeRate)
		throws SystemException {
		return exchangeRatePersistence.remove(exchangeRate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ExchangeRate.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return exchangeRatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return exchangeRatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ExchangeRate fetchExchangeRate(long id) throws SystemException {
		return exchangeRatePersistence.fetchByPrimaryKey(id);
	}
	...
	public ExchangeRate getExchangeRate(long id)
		throws PortalException, SystemException {
		return exchangeRatePersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return exchangeRatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ExchangeRate> getExchangeRates(int start, int end)
		throws SystemException {
		return exchangeRatePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getExchangeRatesCount() throws SystemException {
		return exchangeRatePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.ExchangeRate",
			exchangeRateLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = exchangeRatePersistence.getDataSource();
	...
	private ExchangeRateLocalServiceClpInvoker _clpInvoker = new ExchangeRateLocalServiceClpInvoker();
}