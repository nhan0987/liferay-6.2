...
import vn.dtt.gt.dk.dao.common.service.TthcBieuMauHoSoService;
...
/**
 * Provides the base implementation for the tthc bieu mau ho so remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.common.service.impl.TthcBieuMauHoSoServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 * @generated
 */
public abstract class TthcBieuMauHoSoServiceBaseImpl extends BaseServiceImpl
	implements TthcBieuMauHoSoService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.common.service.TthcBieuMauHoSoServiceUtil} to access the tthc bieu mau ho so remote service.
	 */
	...
	private TthcBieuMauHoSoServiceClpInvoker _clpInvoker = new TthcBieuMauHoSoServiceClpInvoker();
}