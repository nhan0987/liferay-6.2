...
/**
 * This class is used by SOAP remote services, specifically {@link vn.dtt.gt.dk.dao.nghiepvu.service.http.EmissionTestRequirementServiceSoap}.
 *
 * @author huymq
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.http.EmissionTestRequirementServiceSoap
 * @generated
 */
public class EmissionTestRequirementSoap implements Serializable {
	public static EmissionTestRequirementSoap toSoapModel(
		EmissionTestRequirement model) {
		EmissionTestRequirementSoap soapModel = new EmissionTestRequirementSoap();
	...
	public static EmissionTestRequirementSoap[] toSoapModels(
		EmissionTestRequirement[] models) {
		EmissionTestRequirementSoap[] soapModels = new EmissionTestRequirementSoap[models.length];
	...
	public static EmissionTestRequirementSoap[][] toSoapModels(
		EmissionTestRequirement[][] models) {
		EmissionTestRequirementSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new EmissionTestRequirementSoap[models.length][models[0].length];
		}
		else {
			soapModels = new EmissionTestRequirementSoap[0][0];
		}
	...
	public static EmissionTestRequirementSoap[] toSoapModels(
		List<EmissionTestRequirement> models) {
		List<EmissionTestRequirementSoap> soapModels = new ArrayList<EmissionTestRequirementSoap>(models.size());

		for (EmissionTestRequirement model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new EmissionTestRequirementSoap[soapModels.size()]);
	}

	public EmissionTestRequirementSoap() {
	}
