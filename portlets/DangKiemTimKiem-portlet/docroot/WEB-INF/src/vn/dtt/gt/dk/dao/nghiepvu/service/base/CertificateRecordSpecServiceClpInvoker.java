 ...
 * @generated
 */
public class CertificateRecordSpecServiceClpInvoker {
	public CertificateRecordSpecServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName266.equals(name) &&
			...
			return CertificateRecordSpecServiceUtil.getBeanIdentifier();
		}

		if (_methodName267.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes267, parameterTypes)) {
			CertificateRecordSpecServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
