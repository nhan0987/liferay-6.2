...
import vn.dtt.gt.dk.dao.nghiepvu.service.VehicleStatisticsLocalService;
...
/**
 * Provides the base implementation for the vehicle statistics local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.VehicleStatisticsLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.VehicleStatisticsLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.VehicleStatisticsLocalServiceUtil
 * @generated
 */
public abstract class VehicleStatisticsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VehicleStatisticsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.VehicleStatisticsLocalServiceUtil} to access the vehicle statistics local service.
	 */
	...
	@Override
	public VehicleStatistics addVehicleStatistics(
		VehicleStatistics vehicleStatistics) throws SystemException {
		vehicleStatistics.setNew(true);

		return vehicleStatisticsPersistence.update(vehicleStatistics);
	}
	 ...
	 */
	@Override
	public VehicleStatistics createVehicleStatistics(long id) {
		return vehicleStatisticsPersistence.create(id);
	}
	...
	@Override
	public VehicleStatistics deleteVehicleStatistics(long id)
		throws PortalException, SystemException {
		return vehicleStatisticsPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VehicleStatistics deleteVehicleStatistics(
		VehicleStatistics vehicleStatistics) throws SystemException {
		return vehicleStatisticsPersistence.remove(vehicleStatistics);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VehicleStatistics.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vehicleStatisticsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vehicleStatisticsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VehicleStatistics fetchVehicleStatistics(long id)
		throws SystemException {
		return vehicleStatisticsPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VehicleStatistics getVehicleStatistics(long id)
		throws PortalException, SystemException {
		return vehicleStatisticsPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vehicleStatisticsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VehicleStatistics> getVehicleStatisticses(int start, int end)
		throws SystemException {
		return vehicleStatisticsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVehicleStatisticsesCount() throws SystemException {
		return vehicleStatisticsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VehicleStatistics updateVehicleStatistics(
		VehicleStatistics vehicleStatistics) throws SystemException {
		return vehicleStatisticsPersistence.update(vehicleStatistics);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.VehicleStatistics",
			vehicleStatisticsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.gt.dk.dao.nghiepvu.model.VehicleStatistics");
	}
	...
	private VehicleStatisticsLocalServiceClpInvoker _clpInvoker = new VehicleStatisticsLocalServiceClpInvoker();
}