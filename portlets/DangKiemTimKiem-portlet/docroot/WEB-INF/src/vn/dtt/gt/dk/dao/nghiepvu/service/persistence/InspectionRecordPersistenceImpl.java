...
public class InspectionRecordPersistenceImpl extends BasePersistenceImpl<InspectionRecord>
	...
	private static Set<String> _badColumnNames = SetUtil.fromArray(new String[] {
				...
				"inspectorId", "confirmedInspectionId", "inspectionSite",
				"inspectionDateFrom", "inspectionDateTo", "inspectionMode",
				"attachedFile", "confirmedResult", "signName", "signTitle",
				"signPlace", "signDate", "phieuXuLyPhuId", "markupSafeTest",
				"markupEmissionTest", "markupControl", "registeredInspectionId",
				"hoSoThuTucId", "otherCosts", "markupPaid"
			});
