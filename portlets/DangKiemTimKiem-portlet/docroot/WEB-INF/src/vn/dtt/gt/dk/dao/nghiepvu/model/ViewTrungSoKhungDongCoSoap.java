...
/**
 * This class is used by SOAP remote services, specifically {@link vn.dtt.gt.dk.dao.nghiepvu.service.http.ViewTrungSoKhungDongCoServiceSoap}.
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.http.ViewTrungSoKhungDongCoServiceSoap
 * @generated
 */
public class ViewTrungSoKhungDongCoSoap implements Serializable {
	public static ViewTrungSoKhungDongCoSoap toSoapModel(
		ViewTrungSoKhungDongCo model) {
		ViewTrungSoKhungDongCoSoap soapModel = new ViewTrungSoKhungDongCoSoap();
	...
	public static ViewTrungSoKhungDongCoSoap[] toSoapModels(
		ViewTrungSoKhungDongCo[] models) {
		ViewTrungSoKhungDongCoSoap[] soapModels = new ViewTrungSoKhungDongCoSoap[models.length];
	...
	public static ViewTrungSoKhungDongCoSoap[][] toSoapModels(
		ViewTrungSoKhungDongCo[][] models) {
		ViewTrungSoKhungDongCoSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new ViewTrungSoKhungDongCoSoap[models.length][models[0].length];
		}
		else {
			soapModels = new ViewTrungSoKhungDongCoSoap[0][0];
		}
	...
	public static ViewTrungSoKhungDongCoSoap[] toSoapModels(
		List<ViewTrungSoKhungDongCo> models) {
		List<ViewTrungSoKhungDongCoSoap> soapModels = new ArrayList<ViewTrungSoKhungDongCoSoap>(models.size());

		for (ViewTrungSoKhungDongCo model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new ViewTrungSoKhungDongCoSoap[soapModels.size()]);
	}

	public ViewTrungSoKhungDongCoSoap() {
	}
