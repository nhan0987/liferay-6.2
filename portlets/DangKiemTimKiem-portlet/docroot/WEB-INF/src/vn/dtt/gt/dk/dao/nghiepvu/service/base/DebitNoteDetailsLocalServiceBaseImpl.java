...
import vn.dtt.gt.dk.dao.nghiepvu.service.DebitNoteDetailsLocalService;
...
/**
 * Provides the base implementation for the debit note details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.DebitNoteDetailsLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.DebitNoteDetailsLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.DebitNoteDetailsLocalServiceUtil
 * @generated
 */
public abstract class DebitNoteDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DebitNoteDetailsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.DebitNoteDetailsLocalServiceUtil} to access the debit note details local service.
	 */
	...
	@Override
	public DebitNoteDetails addDebitNoteDetails(
		DebitNoteDetails debitNoteDetails) throws SystemException {
		debitNoteDetails.setNew(true);

		return debitNoteDetailsPersistence.update(debitNoteDetails);
	}
	 ...
	 */
	@Override
	public DebitNoteDetails createDebitNoteDetails(long id) {
		return debitNoteDetailsPersistence.create(id);
	}
	...
	@Override
	public DebitNoteDetails deleteDebitNoteDetails(long id)
		throws PortalException, SystemException {
		return debitNoteDetailsPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DebitNoteDetails deleteDebitNoteDetails(
		DebitNoteDetails debitNoteDetails) throws SystemException {
		return debitNoteDetailsPersistence.remove(debitNoteDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DebitNoteDetails.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return debitNoteDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return debitNoteDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DebitNoteDetails fetchDebitNoteDetails(long id)
		throws SystemException {
		return debitNoteDetailsPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DebitNoteDetails getDebitNoteDetails(long id)
		throws PortalException, SystemException {
		return debitNoteDetailsPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return debitNoteDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DebitNoteDetails> getDebitNoteDetailses(int start, int end)
		throws SystemException {
		return debitNoteDetailsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDebitNoteDetailsesCount() throws SystemException {
		return debitNoteDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DebitNoteDetails updateDebitNoteDetails(
		DebitNoteDetails debitNoteDetails) throws SystemException {
		return debitNoteDetailsPersistence.update(debitNoteDetails);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.DebitNoteDetails",
			debitNoteDetailsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.gt.dk.dao.nghiepvu.model.DebitNoteDetails");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = debitNoteDetailsPersistence.getDataSource();
	...
	private DebitNoteDetailsLocalServiceClpInvoker _clpInvoker = new DebitNoteDetailsLocalServiceClpInvoker();
}