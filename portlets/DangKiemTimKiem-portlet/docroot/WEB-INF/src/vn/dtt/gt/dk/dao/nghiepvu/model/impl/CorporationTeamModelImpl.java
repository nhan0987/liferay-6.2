...
import vn.dtt.gt.dk.dao.nghiepvu.model.CorporationTeamSoap;
...
public class CorporationTeamModelImpl extends BaseModelImpl<CorporationTeam>
	 ...
	 */
	public static CorporationTeam toModel(CorporationTeamSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		CorporationTeam model = new CorporationTeamImpl();

		model.setId(soapModel.getId());
		model.setCorporationId(soapModel.getCorporationId());
		model.setTeamName(soapModel.getTeamName());
		model.setMarkUpDelete(soapModel.getMarkUpDelete());
	 ...
	 */
	public static List<CorporationTeam> toModels(
		CorporationTeamSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<CorporationTeam> models = new ArrayList<CorporationTeam>(soapModels.length);

		for (CorporationTeamSoap soapModel : soapModels) {
