...
import vn.dtt.gt.dk.dao.nghiepvu.model.ExchangeRateSoap;
...
public class ExchangeRateModelImpl extends BaseModelImpl<ExchangeRate>
	 ...
	 */
	public static ExchangeRate toModel(ExchangeRateSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		ExchangeRate model = new ExchangeRateImpl();
	 ...
	 */
	public static List<ExchangeRate> toModels(ExchangeRateSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<ExchangeRate> models = new ArrayList<ExchangeRate>(soapModels.length);

		for (ExchangeRateSoap soapModel : soapModels) {
