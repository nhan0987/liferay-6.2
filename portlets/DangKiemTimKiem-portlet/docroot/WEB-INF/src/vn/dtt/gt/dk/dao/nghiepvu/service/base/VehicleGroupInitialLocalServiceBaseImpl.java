...
import vn.dtt.gt.dk.dao.nghiepvu.service.VehicleGroupInitialLocalService;
...
/**
 * Provides the base implementation for the vehicle group initial local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.VehicleGroupInitialLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.VehicleGroupInitialLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.VehicleGroupInitialLocalServiceUtil
 * @generated
 */
public abstract class VehicleGroupInitialLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VehicleGroupInitialLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.VehicleGroupInitialLocalServiceUtil} to access the vehicle group initial local service.
	 */
	...
	@Override
	public VehicleGroupInitial addVehicleGroupInitial(
		VehicleGroupInitial vehicleGroupInitial) throws SystemException {
		vehicleGroupInitial.setNew(true);

		return vehicleGroupInitialPersistence.update(vehicleGroupInitial);
	}
	 ...
	 */
	@Override
	public VehicleGroupInitial createVehicleGroupInitial(long id) {
		return vehicleGroupInitialPersistence.create(id);
	}
	...
	@Override
	public VehicleGroupInitial deleteVehicleGroupInitial(long id)
		throws PortalException, SystemException {
		return vehicleGroupInitialPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VehicleGroupInitial deleteVehicleGroupInitial(
		VehicleGroupInitial vehicleGroupInitial) throws SystemException {
		return vehicleGroupInitialPersistence.remove(vehicleGroupInitial);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VehicleGroupInitial.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vehicleGroupInitialPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vehicleGroupInitialPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VehicleGroupInitial fetchVehicleGroupInitial(long id)
		throws SystemException {
		return vehicleGroupInitialPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VehicleGroupInitial getVehicleGroupInitial(long id)
		throws PortalException, SystemException {
		return vehicleGroupInitialPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vehicleGroupInitialPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VehicleGroupInitial> getVehicleGroupInitials(int start, int end)
		throws SystemException {
		return vehicleGroupInitialPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVehicleGroupInitialsCount() throws SystemException {
		return vehicleGroupInitialPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VehicleGroupInitial updateVehicleGroupInitial(
		VehicleGroupInitial vehicleGroupInitial) throws SystemException {
		return vehicleGroupInitialPersistence.update(vehicleGroupInitial);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroupInitial",
			vehicleGroupInitialLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.gt.dk.dao.nghiepvu.model.VehicleGroupInitial");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vehicleGroupInitialPersistence.getDataSource();
	...
	private VehicleGroupInitialLocalServiceClpInvoker _clpInvoker = new VehicleGroupInitialLocalServiceClpInvoker();
}