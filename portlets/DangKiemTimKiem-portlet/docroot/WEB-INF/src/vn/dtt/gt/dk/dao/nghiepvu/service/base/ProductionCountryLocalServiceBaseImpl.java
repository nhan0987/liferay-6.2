...
import vn.dtt.gt.dk.dao.nghiepvu.service.ProductionCountryLocalService;
...
/**
 * Provides the base implementation for the production country local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.ProductionCountryLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class ProductionCountryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProductionCountryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.ProductionCountryLocalServiceUtil} to access the production country local service.
	 */
	...
	@Override
	public ProductionCountry addProductionCountry(
		ProductionCountry productionCountry) throws SystemException {
		productionCountry.setNew(true);

		return productionCountryPersistence.update(productionCountry);
	}
	 ...
	 */
	@Override
	public ProductionCountry createProductionCountry(long id) {
		return productionCountryPersistence.create(id);
	}
	...
	@Override
	public ProductionCountry deleteProductionCountry(long id)
		throws PortalException, SystemException {
		return productionCountryPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ProductionCountry deleteProductionCountry(
		ProductionCountry productionCountry) throws SystemException {
		return productionCountryPersistence.remove(productionCountry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProductionCountry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return productionCountryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return productionCountryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ProductionCountry fetchProductionCountry(long id)
		throws SystemException {
		return productionCountryPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public ProductionCountry getProductionCountry(long id)
		throws PortalException, SystemException {
		return productionCountryPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return productionCountryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ProductionCountry> getProductionCountries(int start, int end)
		throws SystemException {
		return productionCountryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getProductionCountriesCount() throws SystemException {
		return productionCountryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ProductionCountry updateProductionCountry(
		ProductionCountry productionCountry) throws SystemException {
		return productionCountryPersistence.update(productionCountry);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.ProductionCountry",
			productionCountryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = productionCountryPersistence.getDataSource();
	...
	private ProductionCountryLocalServiceClpInvoker _clpInvoker = new ProductionCountryLocalServiceClpInvoker();
}