...
import vn.dtt.gt.dk.dao.nghiepvu.service.CfgTechnicalspecLocalService;
...
/**
 * Provides the base implementation for the cfg technicalspec local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.CfgTechnicalspecLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class CfgTechnicalspecLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CfgTechnicalspecLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.CfgTechnicalspecLocalServiceUtil} to access the cfg technicalspec local service.
	 */
	...
	@Override
	public CfgTechnicalspec addCfgTechnicalspec(
		CfgTechnicalspec cfgTechnicalspec) throws SystemException {
		cfgTechnicalspec.setNew(true);

		return cfgTechnicalspecPersistence.update(cfgTechnicalspec);
	}
	 ...
	 */
	@Override
	public CfgTechnicalspec createCfgTechnicalspec(long id) {
		return cfgTechnicalspecPersistence.create(id);
	}
	...
	@Override
	public CfgTechnicalspec deleteCfgTechnicalspec(long id)
		throws PortalException, SystemException {
		return cfgTechnicalspecPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CfgTechnicalspec deleteCfgTechnicalspec(
		CfgTechnicalspec cfgTechnicalspec) throws SystemException {
		return cfgTechnicalspecPersistence.remove(cfgTechnicalspec);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CfgTechnicalspec.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return cfgTechnicalspecPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return cfgTechnicalspecPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CfgTechnicalspec fetchCfgTechnicalspec(long id)
		throws SystemException {
		return cfgTechnicalspecPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public CfgTechnicalspec getCfgTechnicalspec(long id)
		throws PortalException, SystemException {
		return cfgTechnicalspecPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return cfgTechnicalspecPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public int getCfgTechnicalspecsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CfgTechnicalspec updateCfgTechnicalspec(
		CfgTechnicalspec cfgTechnicalspec) throws SystemException {
		return cfgTechnicalspecPersistence.update(cfgTechnicalspec);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.CfgTechnicalspec",
			cfgTechnicalspecLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = cfgTechnicalspecPersistence.getDataSource();
	...
	private CfgTechnicalspecLocalServiceClpInvoker _clpInvoker = new CfgTechnicalspecLocalServiceClpInvoker();
}