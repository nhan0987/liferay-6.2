...
import vn.dtt.gt.dk.dao.nghiepvu.service.InspectionRecordSpecLocalService;
...
/**
 * Provides the base implementation for the inspection record spec local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.InspectionRecordSpecLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class InspectionRecordSpecLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements InspectionRecordSpecLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.InspectionRecordSpecLocalServiceUtil} to access the inspection record spec local service.
	 */
	...
	@Override
	public InspectionRecordSpec addInspectionRecordSpec(
		InspectionRecordSpec inspectionRecordSpec) throws SystemException {
		inspectionRecordSpec.setNew(true);

		return inspectionRecordSpecPersistence.update(inspectionRecordSpec);
	}
	 ...
	 */
	@Override
	public InspectionRecordSpec createInspectionRecordSpec(long id) {
		return inspectionRecordSpecPersistence.create(id);
	}
	...
	@Override
	public InspectionRecordSpec deleteInspectionRecordSpec(long id)
		throws PortalException, SystemException {
		return inspectionRecordSpecPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public InspectionRecordSpec deleteInspectionRecordSpec(
		InspectionRecordSpec inspectionRecordSpec) throws SystemException {
		return inspectionRecordSpecPersistence.remove(inspectionRecordSpec);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(InspectionRecordSpec.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return inspectionRecordSpecPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return inspectionRecordSpecPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public InspectionRecordSpec fetchInspectionRecordSpec(long id)
		throws SystemException {
		return inspectionRecordSpecPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public InspectionRecordSpec getInspectionRecordSpec(long id)
		throws PortalException, SystemException {
		return inspectionRecordSpecPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return inspectionRecordSpecPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<InspectionRecordSpec> getInspectionRecordSpecs(int start,
		int end) throws SystemException {
		return inspectionRecordSpecPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getInspectionRecordSpecsCount() throws SystemException {
		return inspectionRecordSpecPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public InspectionRecordSpec updateInspectionRecordSpec(
		InspectionRecordSpec inspectionRecordSpec) throws SystemException {
		return inspectionRecordSpecPersistence.update(inspectionRecordSpec);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.InspectionRecordSpec",
			inspectionRecordSpecLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = inspectionRecordSpecPersistence.getDataSource();
	...
	private InspectionRecordSpecLocalServiceClpInvoker _clpInvoker = new InspectionRecordSpecLocalServiceClpInvoker();
}