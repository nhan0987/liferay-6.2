...
import vn.dtt.gt.dk.dao.nghiepvu.service.ViewDangKiemTimKiemLocalService;
...
/**
 * Provides the base implementation for the view dang kiem tim kiem local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.ViewDangKiemTimKiemLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class ViewDangKiemTimKiemLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ViewDangKiemTimKiemLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.ViewDangKiemTimKiemLocalServiceUtil} to access the view dang kiem tim kiem local service.
	 */
	...
	@Override
	public ViewDangKiemTimKiem addViewDangKiemTimKiem(
		ViewDangKiemTimKiem viewDangKiemTimKiem) throws SystemException {
		viewDangKiemTimKiem.setNew(true);

		return viewDangKiemTimKiemPersistence.update(viewDangKiemTimKiem);
	}
	 ...
	 */
	@Override
	public ViewDangKiemTimKiem createViewDangKiemTimKiem(long id) {
		return viewDangKiemTimKiemPersistence.create(id);
	}
	...
	@Override
	public ViewDangKiemTimKiem deleteViewDangKiemTimKiem(long id)
		throws PortalException, SystemException {
		return viewDangKiemTimKiemPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ViewDangKiemTimKiem deleteViewDangKiemTimKiem(
		ViewDangKiemTimKiem viewDangKiemTimKiem) throws SystemException {
		return viewDangKiemTimKiemPersistence.remove(viewDangKiemTimKiem);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ViewDangKiemTimKiem.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return viewDangKiemTimKiemPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return viewDangKiemTimKiemPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ViewDangKiemTimKiem fetchViewDangKiemTimKiem(long id)
		throws SystemException {
		return viewDangKiemTimKiemPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public ViewDangKiemTimKiem getViewDangKiemTimKiem(long id)
		throws PortalException, SystemException {
		return viewDangKiemTimKiemPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return viewDangKiemTimKiemPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ViewDangKiemTimKiem> getViewDangKiemTimKiems(int start, int end)
		throws SystemException {
		return viewDangKiemTimKiemPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getViewDangKiemTimKiemsCount() throws SystemException {
		return viewDangKiemTimKiemPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ViewDangKiemTimKiem updateViewDangKiemTimKiem(
		ViewDangKiemTimKiem viewDangKiemTimKiem) throws SystemException {
		return viewDangKiemTimKiemPersistence.update(viewDangKiemTimKiem);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.ViewDangKiemTimKiem",
			viewDangKiemTimKiemLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = viewDangKiemTimKiemPersistence.getDataSource();
	...
	private ViewDangKiemTimKiemLocalServiceClpInvoker _clpInvoker = new ViewDangKiemTimKiemLocalServiceClpInvoker();
}