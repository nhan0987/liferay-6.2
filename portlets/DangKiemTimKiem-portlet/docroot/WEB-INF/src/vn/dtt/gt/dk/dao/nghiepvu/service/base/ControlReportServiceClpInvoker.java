 ...
 * @generated
 */
public class ControlReportServiceClpInvoker {
	public ControlReportServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName266.equals(name) &&
			...
			return ControlReportServiceUtil.getBeanIdentifier();
		}

		if (_methodName267.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes267, parameterTypes)) {
			ControlReportServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
