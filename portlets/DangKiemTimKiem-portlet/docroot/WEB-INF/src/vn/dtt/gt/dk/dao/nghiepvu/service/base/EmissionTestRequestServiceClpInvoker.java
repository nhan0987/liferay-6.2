 ...
 * @generated
 */
public class EmissionTestRequestServiceClpInvoker {
	public EmissionTestRequestServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName266.equals(name) &&
			...
			return EmissionTestRequestServiceUtil.getBeanIdentifier();
		}

		if (_methodName267.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes267, parameterTypes)) {
			EmissionTestRequestServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
