...
import vn.dtt.gt.dk.dao.nghiepvu.service.ViewDangKiemTimKiemServiceUtil;
 ...
 * @generated
 */
public class ViewDangKiemTimKiemServiceClpInvoker {
	public ViewDangKiemTimKiemServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName266.equals(name) &&
			...
			return ViewDangKiemTimKiemServiceUtil.getBeanIdentifier();
		}

		if (_methodName267.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes267, parameterTypes)) {
			ViewDangKiemTimKiemServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
