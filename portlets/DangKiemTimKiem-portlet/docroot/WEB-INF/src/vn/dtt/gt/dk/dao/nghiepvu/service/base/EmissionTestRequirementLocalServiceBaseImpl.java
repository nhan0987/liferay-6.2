...
import vn.dtt.gt.dk.dao.nghiepvu.service.EmissionTestRequirementLocalService;
...
/**
 * Provides the base implementation for the emission test requirement local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.EmissionTestRequirementLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class EmissionTestRequirementLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmissionTestRequirementLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.EmissionTestRequirementLocalServiceUtil} to access the emission test requirement local service.
	 */
	...
	@Override
	public EmissionTestRequirement addEmissionTestRequirement(
		EmissionTestRequirement emissionTestRequirement)
		throws SystemException {
		emissionTestRequirement.setNew(true);

		return emissionTestRequirementPersistence.update(emissionTestRequirement);
	}
	 ...
	 */
	@Override
	public EmissionTestRequirement createEmissionTestRequirement(long id) {
		return emissionTestRequirementPersistence.create(id);
	}
	...
	@Override
	public EmissionTestRequirement deleteEmissionTestRequirement(long id)
		throws PortalException, SystemException {
		return emissionTestRequirementPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmissionTestRequirement deleteEmissionTestRequirement(
		EmissionTestRequirement emissionTestRequirement)
		throws SystemException {
		return emissionTestRequirementPersistence.remove(emissionTestRequirement);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmissionTestRequirement.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return emissionTestRequirementPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return emissionTestRequirementPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmissionTestRequirement fetchEmissionTestRequirement(long id)
		throws SystemException {
		return emissionTestRequirementPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public EmissionTestRequirement getEmissionTestRequirement(long id)
		throws PortalException, SystemException {
		return emissionTestRequirementPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return emissionTestRequirementPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmissionTestRequirement> getEmissionTestRequirements(
		int start, int end) throws SystemException {
		return emissionTestRequirementPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmissionTestRequirementsCount() throws SystemException {
		return emissionTestRequirementPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmissionTestRequirement updateEmissionTestRequirement(
		EmissionTestRequirement emissionTestRequirement)
		throws SystemException {
		return emissionTestRequirementPersistence.update(emissionTestRequirement);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.EmissionTestRequirement",
			emissionTestRequirementLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = emissionTestRequirementPersistence.getDataSource();
	...
	private EmissionTestRequirementLocalServiceClpInvoker _clpInvoker = new EmissionTestRequirementLocalServiceClpInvoker();
}