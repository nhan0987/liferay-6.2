 ...
 */
public class TthcHoSoThuTucLocalServiceImpl
	extends TthcHoSoThuTucLocalServiceBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this interface directly. Always use {@link vn.dtt.gt.dk.dao.common.service.TthcHoSoThuTucLocalServiceUtil} to access the tthc ho so thu tuc local service.
	 */
}