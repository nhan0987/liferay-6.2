...
import vn.dtt.gt.dk.dao.nghiepvu.service.CorporationAttendeeLocalService;
...
/**
 * Provides the base implementation for the corporation attendee local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.CorporationAttendeeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class CorporationAttendeeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CorporationAttendeeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.CorporationAttendeeLocalServiceUtil} to access the corporation attendee local service.
	 */
	...
	@Override
	public CorporationAttendee addCorporationAttendee(
		CorporationAttendee corporationAttendee) throws SystemException {
		corporationAttendee.setNew(true);

		return corporationAttendeePersistence.update(corporationAttendee);
	}
	 ...
	 */
	@Override
	public CorporationAttendee createCorporationAttendee(long id) {
		return corporationAttendeePersistence.create(id);
	}
	...
	@Override
	public CorporationAttendee deleteCorporationAttendee(long id)
		throws PortalException, SystemException {
		return corporationAttendeePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CorporationAttendee deleteCorporationAttendee(
		CorporationAttendee corporationAttendee) throws SystemException {
		return corporationAttendeePersistence.remove(corporationAttendee);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CorporationAttendee.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return corporationAttendeePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return corporationAttendeePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CorporationAttendee fetchCorporationAttendee(long id)
		throws SystemException {
		return corporationAttendeePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public CorporationAttendee getCorporationAttendee(long id)
		throws PortalException, SystemException {
		return corporationAttendeePersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return corporationAttendeePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CorporationAttendee> getCorporationAttendees(int start, int end)
		throws SystemException {
		return corporationAttendeePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCorporationAttendeesCount() throws SystemException {
		return corporationAttendeePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CorporationAttendee updateCorporationAttendee(
		CorporationAttendee corporationAttendee) throws SystemException {
		return corporationAttendeePersistence.update(corporationAttendee);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.CorporationAttendee",
			corporationAttendeeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = corporationAttendeePersistence.getDataSource();
	...
	private CorporationAttendeeLocalServiceClpInvoker _clpInvoker = new CorporationAttendeeLocalServiceClpInvoker();
}