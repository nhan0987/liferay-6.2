...
public class TthcKeHoachChuyenDichPersistenceImpl extends BasePersistenceImpl<TthcKeHoachChuyenDich>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_MESSAGEID = new FinderPath(TthcKeHoachChuyenDichModelImpl.ENTITY_CACHE_ENABLED,
			TthcKeHoachChuyenDichModelImpl.FINDER_CACHE_ENABLED,
			TthcKeHoachChuyenDichImpl.class, FINDER_CLASS_NAME_ENTITY,
	 ...
	 */
	@Override
	public TthcKeHoachChuyenDich findByMessageId(String messageId)
		throws NoSuchTthcKeHoachChuyenDichException, SystemException {
		TthcKeHoachChuyenDich tthcKeHoachChuyenDich = fetchByMessageId(messageId);
	 ...
	 */
	@Override
	public TthcKeHoachChuyenDich fetchByMessageId(String messageId)
		throws SystemException {
	...
	public TthcKeHoachChuyenDich fetchByMessageId(String messageId,
		...
		if (result instanceof TthcKeHoachChuyenDich) {
			TthcKeHoachChuyenDich tthcKeHoachChuyenDich = (TthcKeHoachChuyenDich)result;
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"TthcKeHoachChuyenDichPersistenceImpl.fetchByMessageId(String, boolean) with parameters (" +
							StringUtil.merge(finderArgs) +
							") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
					}

					TthcKeHoachChuyenDich tthcKeHoachChuyenDich = list.get(0);

					result = tthcKeHoachChuyenDich;

					cacheResult(tthcKeHoachChuyenDich);

					if ((tthcKeHoachChuyenDich.getMessageId() == null) ||
							!tthcKeHoachChuyenDich.getMessageId()
													  .equals(messageId)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_MESSAGEID,
							finderArgs, tthcKeHoachChuyenDich);
					}
				}
			}
			catch (Exception e) {
		...
		if (result instanceof List<?>) {
			...
			return (TthcKeHoachChuyenDich)result;
		}
	}
	 ...
	 */
	@Override
	public TthcKeHoachChuyenDich removeByMessageId(String messageId)
		throws NoSuchTthcKeHoachChuyenDichException, SystemException {
		TthcKeHoachChuyenDich tthcKeHoachChuyenDich = findByMessageId(messageId);
	...
	public void cacheResult(TthcKeHoachChuyenDich tthcKeHoachChuyenDich) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_MESSAGEID,
			new Object[] { tthcKeHoachChuyenDich.getMessageId() },
			tthcKeHoachChuyenDich);
	...
	public void clearCache(TthcKeHoachChuyenDich tthcKeHoachChuyenDich) {
		...
		clearUniqueFindersCache(tthcKeHoachChuyenDich);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		if (tthcKeHoachChuyenDich.isNew()) {
			Object[] args = new Object[] { tthcKeHoachChuyenDich.getMessageId() };
	...
	public TthcKeHoachChuyenDich updateImpl(
		...
		clearUniqueFindersCache(tthcKeHoachChuyenDich);
		cacheUniqueFindersCache(tthcKeHoachChuyenDich);
