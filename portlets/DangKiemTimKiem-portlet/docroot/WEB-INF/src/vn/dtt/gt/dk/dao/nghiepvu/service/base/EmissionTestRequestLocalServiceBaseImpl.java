...
import vn.dtt.gt.dk.dao.nghiepvu.service.EmissionTestRequestLocalService;
...
/**
 * Provides the base implementation for the emission test request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.EmissionTestRequestLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.EmissionTestRequestLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.EmissionTestRequestLocalServiceUtil
 * @generated
 */
public abstract class EmissionTestRequestLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmissionTestRequestLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.EmissionTestRequestLocalServiceUtil} to access the emission test request local service.
	 */

	/**
	 * Adds the emission test request to the database. Also notifies the appropriate model listeners.
	 *
	 * @param emissionTestRequest the emission test request
	 * @return the emission test request that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmissionTestRequest addEmissionTestRequest(
		EmissionTestRequest emissionTestRequest) throws SystemException {
		emissionTestRequest.setNew(true);

		return emissionTestRequestPersistence.update(emissionTestRequest);
	}
	 ...
	 */
	@Override
	public EmissionTestRequest createEmissionTestRequest(long id) {
		return emissionTestRequestPersistence.create(id);
	}

	/**
	 * Deletes the emission test request with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param id the primary key of the emission test request
	 * @return the emission test request that was removed
	 * @throws PortalException if a emission test request with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmissionTestRequest deleteEmissionTestRequest(long id)
		throws PortalException, SystemException {
		return emissionTestRequestPersistence.remove(id);
	}

	/**
	 * Deletes the emission test request from the database. Also notifies the appropriate model listeners.
	 *
	 * @param emissionTestRequest the emission test request
	 * @return the emission test request that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmissionTestRequest deleteEmissionTestRequest(
		EmissionTestRequest emissionTestRequest) throws SystemException {
		return emissionTestRequestPersistence.remove(emissionTestRequest);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmissionTestRequest.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return emissionTestRequestPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return emissionTestRequestPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmissionTestRequest fetchEmissionTestRequest(long id)
		throws SystemException {
		return emissionTestRequestPersistence.fetchByPrimaryKey(id);
	}

	/**
	 * Returns the emission test request with the primary key.
	 *
	 * @param id the primary key of the emission test request
	 ...
	 */
	@Override
	public EmissionTestRequest getEmissionTestRequest(long id)
		throws PortalException, SystemException {
		return emissionTestRequestPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return emissionTestRequestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmissionTestRequest> getEmissionTestRequests(int start, int end)
		throws SystemException {
		return emissionTestRequestPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmissionTestRequestsCount() throws SystemException {
		return emissionTestRequestPersistence.countAll();
	}

	/**
	 * Updates the emission test request in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param emissionTestRequest the emission test request
	 * @return the emission test request that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmissionTestRequest updateEmissionTestRequest(
		EmissionTestRequest emissionTestRequest) throws SystemException {
		return emissionTestRequestPersistence.update(emissionTestRequest);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.EmissionTestRequest",
			emissionTestRequestLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.gt.dk.dao.nghiepvu.model.EmissionTestRequest");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = emissionTestRequestPersistence.getDataSource();
	...
	private EmissionTestRequestLocalServiceClpInvoker _clpInvoker = new EmissionTestRequestLocalServiceClpInvoker();
}