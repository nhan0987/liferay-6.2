 ...
 * @generated
 */
public class CopReportLocalServiceClp implements CopReportLocalService {
	public CopReportLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public vn.dtt.gt.dk.dao.nghiepvu.model.CopReport addCopReport(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(copReport) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.gt.dk.dao.nghiepvu.model.CopReport)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.CopReport> getCopReports(
		...
		return (java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.CopReport>)ClpSerializer.translateOutput(returnObj);
	}
