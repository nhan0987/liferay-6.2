 ...
 * @generated
 */
public class EmissionTestRequirementServiceClpInvoker {
	public EmissionTestRequirementServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName266.equals(name) &&
			...
			return EmissionTestRequirementServiceUtil.getBeanIdentifier();
		}

		if (_methodName267.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes267, parameterTypes)) {
			EmissionTestRequirementServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
