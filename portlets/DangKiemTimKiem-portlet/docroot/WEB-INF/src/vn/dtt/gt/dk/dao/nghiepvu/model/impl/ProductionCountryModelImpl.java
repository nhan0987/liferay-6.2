...
public class ProductionCountryModelImpl extends BaseModelImpl<ProductionCountry>
	...
	public static final String TABLE_SQL_CREATE = "create table vr_productioncountry (id LONG not null primary key,vehiclegroupid LONG,countrycode VARCHAR(75) null)";
