...
import vn.dtt.gt.dk.dao.nghiepvu.model.DebitNoteDetailsSoap;
...
public class DebitNoteDetailsModelImpl extends BaseModelImpl<DebitNoteDetails>
	 ...
	 */
	public static DebitNoteDetails toModel(DebitNoteDetailsSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		DebitNoteDetails model = new DebitNoteDetailsImpl();
	 ...
	 */
	public static List<DebitNoteDetails> toModels(
		DebitNoteDetailsSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<DebitNoteDetails> models = new ArrayList<DebitNoteDetails>(soapModels.length);

		for (DebitNoteDetailsSoap soapModel : soapModels) {
