 ...
 * @generated
 */
public class SafetyTestRequestServiceClpInvoker {
	public SafetyTestRequestServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName266.equals(name) &&
			...
			return SafetyTestRequestServiceUtil.getBeanIdentifier();
		}

		if (_methodName267.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes267, parameterTypes)) {
			SafetyTestRequestServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
