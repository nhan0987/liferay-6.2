...
import vn.dtt.gt.dk.dao.nghiepvu.service.SafetyTestReportLocalService;
...
/**
 * Provides the base implementation for the safety test report local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.SafetyTestReportLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.SafetyTestReportLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.SafetyTestReportLocalServiceUtil
 * @generated
 */
public abstract class SafetyTestReportLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SafetyTestReportLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.SafetyTestReportLocalServiceUtil} to access the safety test report local service.
	 */
	...
	@Override
	public SafetyTestReport addSafetyTestReport(
		SafetyTestReport safetyTestReport) throws SystemException {
		safetyTestReport.setNew(true);

		return safetyTestReportPersistence.update(safetyTestReport);
	}
	 ...
	 */
	@Override
	public SafetyTestReport createSafetyTestReport(long id) {
		return safetyTestReportPersistence.create(id);
	}
	...
	@Override
	public SafetyTestReport deleteSafetyTestReport(long id)
		throws PortalException, SystemException {
		return safetyTestReportPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SafetyTestReport deleteSafetyTestReport(
		SafetyTestReport safetyTestReport) throws SystemException {
		return safetyTestReportPersistence.remove(safetyTestReport);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SafetyTestReport.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return safetyTestReportPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return safetyTestReportPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SafetyTestReport fetchSafetyTestReport(long id)
		throws SystemException {
		return safetyTestReportPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public SafetyTestReport getSafetyTestReport(long id)
		throws PortalException, SystemException {
		return safetyTestReportPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return safetyTestReportPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SafetyTestReport> getSafetyTestReports(int start, int end)
		throws SystemException {
		return safetyTestReportPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSafetyTestReportsCount() throws SystemException {
		return safetyTestReportPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SafetyTestReport updateSafetyTestReport(
		SafetyTestReport safetyTestReport) throws SystemException {
		return safetyTestReportPersistence.update(safetyTestReport);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.SafetyTestReport",
			safetyTestReportLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.gt.dk.dao.nghiepvu.model.SafetyTestReport");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = safetyTestReportPersistence.getDataSource();
	...
	private SafetyTestReportLocalServiceClpInvoker _clpInvoker = new SafetyTestReportLocalServiceClpInvoker();
}