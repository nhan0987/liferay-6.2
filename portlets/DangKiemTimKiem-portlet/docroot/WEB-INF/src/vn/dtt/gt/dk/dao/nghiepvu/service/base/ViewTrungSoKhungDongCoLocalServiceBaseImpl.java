...
import vn.dtt.gt.dk.dao.nghiepvu.service.ViewTrungSoKhungDongCoLocalService;
...
/**
 * Provides the base implementation for the view trung so khung dong co local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.gt.dk.dao.nghiepvu.service.impl.ViewTrungSoKhungDongCoLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.impl.ViewTrungSoKhungDongCoLocalServiceImpl
 * @see vn.dtt.gt.dk.dao.nghiepvu.service.ViewTrungSoKhungDongCoLocalServiceUtil
 * @generated
 */
public abstract class ViewTrungSoKhungDongCoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ViewTrungSoKhungDongCoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.gt.dk.dao.nghiepvu.service.ViewTrungSoKhungDongCoLocalServiceUtil} to access the view trung so khung dong co local service.
	 */
	...
	@Override
	public ViewTrungSoKhungDongCo addViewTrungSoKhungDongCo(
		ViewTrungSoKhungDongCo viewTrungSoKhungDongCo)
		throws SystemException {
		viewTrungSoKhungDongCo.setNew(true);

		return viewTrungSoKhungDongCoPersistence.update(viewTrungSoKhungDongCo);
	}
	 ...
	 */
	@Override
	public ViewTrungSoKhungDongCo createViewTrungSoKhungDongCo(long id) {
		return viewTrungSoKhungDongCoPersistence.create(id);
	}
	...
	@Override
	public ViewTrungSoKhungDongCo deleteViewTrungSoKhungDongCo(long id)
		throws PortalException, SystemException {
		return viewTrungSoKhungDongCoPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ViewTrungSoKhungDongCo deleteViewTrungSoKhungDongCo(
		ViewTrungSoKhungDongCo viewTrungSoKhungDongCo)
		throws SystemException {
		return viewTrungSoKhungDongCoPersistence.remove(viewTrungSoKhungDongCo);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ViewTrungSoKhungDongCo.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return viewTrungSoKhungDongCoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return viewTrungSoKhungDongCoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ViewTrungSoKhungDongCo fetchViewTrungSoKhungDongCo(long id)
		throws SystemException {
		return viewTrungSoKhungDongCoPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public ViewTrungSoKhungDongCo getViewTrungSoKhungDongCo(long id)
		throws PortalException, SystemException {
		return viewTrungSoKhungDongCoPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return viewTrungSoKhungDongCoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ViewTrungSoKhungDongCo> getViewTrungSoKhungDongCos(int start,
		int end) throws SystemException {
		return viewTrungSoKhungDongCoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getViewTrungSoKhungDongCosCount() throws SystemException {
		return viewTrungSoKhungDongCoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ViewTrungSoKhungDongCo updateViewTrungSoKhungDongCo(
		ViewTrungSoKhungDongCo viewTrungSoKhungDongCo)
		throws SystemException {
		return viewTrungSoKhungDongCoPersistence.update(viewTrungSoKhungDongCo);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.gt.dk.dao.nghiepvu.model.ViewTrungSoKhungDongCo",
			viewTrungSoKhungDongCoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = viewTrungSoKhungDongCoPersistence.getDataSource();
	...
	private ViewTrungSoKhungDongCoLocalServiceClpInvoker _clpInvoker = new ViewTrungSoKhungDongCoLocalServiceClpInvoker();
}