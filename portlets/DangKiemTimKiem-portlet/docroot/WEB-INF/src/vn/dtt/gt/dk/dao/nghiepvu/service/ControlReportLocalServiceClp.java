 ...
 * @generated
 */
public class ControlReportLocalServiceClp implements ControlReportLocalService {
	public ControlReportLocalServiceClp(
	...
	public vn.dtt.gt.dk.dao.nghiepvu.model.ControlReport addControlReport(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(controlReport) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.gt.dk.dao.nghiepvu.model.ControlReport)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.ControlReport> getControlReports(
		...
		return (java.util.List<vn.dtt.gt.dk.dao.nghiepvu.model.ControlReport>)ClpSerializer.translateOutput(returnObj);
	}
