...
public class TthcPhanNhomHoSoModelImpl extends BaseModelImpl<TthcPhanNhomHoSo>
	...
	public static final String TABLE_SQL_CREATE = "create table tthc_phannhomhoso (id LONG not null primary key,maphannhom VARCHAR(75) null,tenphannhom VARCHAR(75) null,tentienganh VARCHAR(75) null,LOAIPHIEUXULY INTEGER,sothutu INTEGER)";
