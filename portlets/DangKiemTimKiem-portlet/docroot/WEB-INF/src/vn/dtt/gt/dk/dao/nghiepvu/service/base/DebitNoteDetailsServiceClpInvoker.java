 ...
 * @generated
 */
public class DebitNoteDetailsServiceClpInvoker {
	public DebitNoteDetailsServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName266.equals(name) &&
			...
			return DebitNoteDetailsServiceUtil.getBeanIdentifier();
		}

		if (_methodName267.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes267, parameterTypes)) {
			DebitNoteDetailsServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
