...
//		System.out.println("ReadXMLMessagesHeader  ");
...
/*	
	 public static void main(String[] args) throws Exception{
	        ...
	        //Document doc =vn.gt.tichhop.message.xml.XmlUtils.parseXmlFile("C://ShipSecurity.xml", false);
	        //Document doc =vn.gt.tichhop.message.xml.XmlUtils.parseXmlFile("C://ShipSecurity.xml", false);
	    	...
	    	object=MessageFactory.convertXmltoShipSecurityNotification(xmlString);
	        System.out.println(sw.toString());
...
//	        //System.out.println(MessageFactory.getStringFromDocument(doc));
...
//	        Header header = ReadXMLMessagesHeader(xmlString);
//	        businessUtils.insertTempTable(header, xmlString);
